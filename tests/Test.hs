...
main =
  hspec $ modifyMaxSize (const 10) $ do
    describe "JSON instances" $ do
      ...
      propMimeEq MimeJSON (Proxy :: Proxy InlineResponse20019JoinTokens)
      ...
      propMimeEq MimeJSON (Proxy :: Proxy InlineResponse20021Descriptor)
      propMimeEq MimeJSON (Proxy :: Proxy InlineResponse20021Platforms)
