{-
   ...
   Docker Engine API API version: 1.51
...
data BuildInfo = BuildInfo
  ...
  , buildInfoError :: !(Maybe Text) -- ^ "error" - errors encountered during the operation.   &gt; **Deprecated**: This field is deprecated since API v1.4, and will be omitted in a future API version. Use the information in errorDetail instead.
  , buildInfoErrorDetail :: !(Maybe ErrorDetail) -- ^ "errorDetail"
  , buildInfoStatus :: !(Maybe Text) -- ^ "status"
  , buildInfoProgress :: !(Maybe Text) -- ^ "progress" - Progress is a pre-formatted presentation of progressDetail.   &gt; **Deprecated**: This field is deprecated since API v1.8, and will be omitted in a future API version. Use the information in progressDetail instead.
...
data ContainerConfig = ContainerConfig
  ...
  , containerConfigMacAddress :: !(Maybe Text) -- ^ "MacAddress" - MAC address of the container.  Deprecated: this field is deprecated in API v1.44 and up. Use EndpointSettings.MacAddress instead. 
...
data ContainerCreateRequest = ContainerCreateRequest
  ...
  , containerCreateRequestMacAddress :: !(Maybe Text) -- ^ "MacAddress" - MAC address of the container.  Deprecated: this field is deprecated in API v1.44 and up. Use EndpointSettings.MacAddress instead. 
...
data ContainerStatsResponse = ContainerStatsResponse
  { containerStatsResponseName :: !(Maybe Text) -- ^ "name" - Name of the container
  , containerStatsResponseId :: !(Maybe Text) -- ^ "id" - ID of the container
...
data ContainerSummary = ContainerSummary
  ...
  , containerSummaryPorts :: !(Maybe [Port]) -- ^ "Ports" - Port-mappings for the container.
...
data ContainerUpdateRequest = ContainerUpdateRequest
  ...
  , containerUpdateRequestKernelMemoryTcp :: !(Maybe Integer) -- ^ "KernelMemoryTCP" - Hard limit for kernel TCP buffer memory (in bytes). Depending on the OCI runtime in use, this option may be ignored. It is no longer supported by the default (runc) runtime.  This field is omitted when empty.  **Deprecated**: This field is deprecated as kernel 6.12 has deprecated &#x60;memory.kmem.tcp.limit_in_bytes&#x60; field for cgroups v1. This field will be removed in a future release. 
...
instance A.ToJSON ContainerUpdateRequest where
  toJSON ContainerUpdateRequest {..} =
   _omitNulls
      ...
      , "KernelMemoryTCP" .= containerUpdateRequestKernelMemoryTcp
...
mkContainerUpdateRequest =
  ...
  , containerUpdateRequestKernelMemoryTcp = Nothing
...
data CreateImageInfo = CreateImageInfo
  ...
  , createImageInfoError :: !(Maybe Text) -- ^ "error" - errors encountered during the operation.   &gt; **Deprecated**: This field is deprecated since API v1.4, and will be omitted in a future API version. Use the information in errorDetail instead.
  , createImageInfoErrorDetail :: !(Maybe ErrorDetail) -- ^ "errorDetail"
  , createImageInfoStatus :: !(Maybe Text) -- ^ "status"
  , createImageInfoProgress :: !(Maybe Text) -- ^ "progress" - Progress is a pre-formatted presentation of progressDetail.   &gt; **Deprecated**: This field is deprecated since API v1.8, and will be omitted in a future API version. Use the information in progressDetail instead.
...
data HostConfig = HostConfig
  ...
  , hostConfigKernelMemoryTcp :: !(Maybe Integer) -- ^ "KernelMemoryTCP" - Hard limit for kernel TCP buffer memory (in bytes). Depending on the OCI runtime in use, this option may be ignored. It is no longer supported by the default (runc) runtime.  This field is omitted when empty.  **Deprecated**: This field is deprecated as kernel 6.12 has deprecated &#x60;memory.kmem.tcp.limit_in_bytes&#x60; field for cgroups v1. This field will be removed in a future release. 
...
data ImageInspect = ImageInspect
  ...
  , imageInspectDockerVersion :: !(Maybe Text) -- ^ "DockerVersion" - The version of Docker that was used to build the image.  Depending on how the image was created, this field may be empty.  &gt; **Deprecated**: This field is only set when using the deprecated &gt; legacy builder. It is included in API responses for informational &gt; purposes, but should not be depended on as it will be omitted &gt; once the legacy builder is removed. 
...
data Network = Network
  ...
  , networkContainers :: !(Maybe (Map.Map String NetworkContainer)) -- ^ "Containers" - Contains endpoints attached to the network. 
  , networkOptions :: !(Maybe (Map.Map String Text)) -- ^ "Options" - Network-specific options uses when creating the network. 
  , networkLabels :: !(Maybe (Map.Map String Text)) -- ^ "Labels" - User-defined key/value metadata.
...
data NetworkSettings = NetworkSettings
  { networkSettingsBridge :: !(Maybe Text) -- ^ "Bridge" - Name of the default bridge interface when dockerd&#39;s --bridge flag is set.  Deprecated: This field is only set when the daemon is started with the --bridge flag specified. 
  , networkSettingsSandboxId :: !(Maybe Text) -- ^ "SandboxID" - SandboxID uniquely represents a container&#39;s network stack.
  , networkSettingsHairpinMode :: !(Maybe Bool) -- ^ "HairpinMode" - Indicates if hairpin NAT should be enabled on the virtual interface.  Deprecated: This field is never set and will be removed in a future release. 
  , networkSettingsLinkLocalIpv6Address :: !(Maybe Text) -- ^ "LinkLocalIPv6Address" - IPv6 unicast address using the link-local prefix.  Deprecated: This field is never set and will be removed in a future release. 
  , networkSettingsLinkLocalIpv6PrefixLen :: !(Maybe Int) -- ^ "LinkLocalIPv6PrefixLen" - Prefix length of the IPv6 unicast address.  Deprecated: This field is never set and will be removed in a future release. 
  ...
  , networkSettingsSecondaryIpAddresses :: !(Maybe [Address]) -- ^ "SecondaryIPAddresses" - Deprecated: This field is never set and will be removed in a future release.
  , networkSettingsSecondaryIpv6Addresses :: !(Maybe [Address]) -- ^ "SecondaryIPv6Addresses" - Deprecated: This field is never set and will be removed in a future release.
...
data PluginConfig = PluginConfig
  { pluginConfigDockerVersion :: !(Maybe Text) -- ^ "DockerVersion" - Docker Version used to create the plugin.  Depending on how the plugin was created, this field may be empty or omitted.  Deprecated: this field is no longer set, and will be removed in the next API version.
...
data PushImageInfo = PushImageInfo
  { pushImageInfoError :: !(Maybe Text) -- ^ "error" - errors encountered during the operation.   &gt; **Deprecated**: This field is deprecated since API v1.4, and will be omitted in a future API version. Use the information in errorDetail instead.
  , pushImageInfoErrorDetail :: !(Maybe ErrorDetail) -- ^ "errorDetail"
  , pushImageInfoStatus :: !(Maybe Text) -- ^ "status"
  , pushImageInfoProgress :: !(Maybe Text) -- ^ "progress" - Progress is a pre-formatted presentation of progressDetail.   &gt; **Deprecated**: This field is deprecated since API v1.8, and will be omitted in a future API version. Use the information in progressDetail instead.
...
data VolumeCreateOptions = VolumeCreateOptions
  ...
  , volumeCreateOptionsClusterVolumeSpec :: !(Maybe ClusterVolumeSpec) -- ^ "ClusterVolumeSpec"
  } deriving (P.Show, P.Eq, P.Typeable)
...
instance A.ToJSON VolumeCreateOptions where
  toJSON VolumeCreateOptions {..} =
   _omitNulls
      ...
      , "ClusterVolumeSpec" .= volumeCreateOptionsClusterVolumeSpec
      ]
...
mkVolumeCreateOptions =
  ...
  , volumeCreateOptionsClusterVolumeSpec = Nothing
  }
