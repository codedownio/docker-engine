...
data BuildCache = BuildCache
  ...
  , buildCacheParent :: !(Maybe Text) -- ^ "Parent" - ID of the parent build cache record. 
...
data ContainerUpdateRequest = ContainerUpdateRequest
  ...
  , containerUpdateRequestKernelMemory :: !(Maybe Integer) -- ^ "KernelMemory" - Kernel memory limit in bytes.  &lt;p&gt;&lt;br /&gt;&lt;/p&gt;  &gt; **Deprecated**: This field is deprecated as the kernel 5.4 deprecated &gt; &#x60;kmem.limit_in_bytes&#x60;. 
  , containerUpdateRequestKernelMemoryTcp :: !(Maybe Integer) -- ^ "KernelMemoryTCP" - Hard limit for kernel TCP buffer memory (in bytes).
