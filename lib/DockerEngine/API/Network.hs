...
-- 
networkConnect 
  :: (Consumes NetworkConnect MimeOctetStream, MimeRender MimeOctetStream InlineObject4)
  => Accept accept -- ^ request accept ('MimeType')
  -> InlineObject4 -- ^ "container"
  -> Id -- ^ "id" -  Network ID or name
  -> DockerEngineRequest NetworkConnect MimeOctetStream res accept
...
networkCreate 
  ...
  -> DockerEngineRequest NetworkCreate MimeJSON InlineResponse2011 MimeJSON
