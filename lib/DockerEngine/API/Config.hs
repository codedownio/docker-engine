...
configCreate 
  ...
  => DockerEngineRequest ConfigCreate MimeJSON InlineResponse2014 MimeJSON
configCreate =
...
configDelete 
  ...
  -> DockerEngineRequest ConfigDelete MimeNoContent res MimeJSON
configDelete (Id id) =
  _mkRequest "DELETE" ["/configs/",toPath id]

data ConfigDelete  
-- | @application/json@
instance Produces ConfigDelete MimeJSON
...
configUpdate 
  ...
  -> DockerEngineRequest ConfigUpdate contentType res accept
configUpdate _  _ (Id id) (Version version) =
...
-- | @application/json@
instance Produces ConfigUpdate MimeJSON
-- | @text/plain@
instance Produces ConfigUpdate MimePlainText
