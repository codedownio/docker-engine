...
data SecretCreate 
instance HasBodyParam SecretCreate SecretCreateRequest 
...
secretUpdate
  ...
  -> VersionInteger -- ^ "version" -  The version number of the secret object being updated. This is required to avoid conflicting writes. 
  -> DockerEngineRequest SecretUpdate contentType NoContent MimeNoContent
secretUpdate _ (Id id) (VersionInteger version) =
