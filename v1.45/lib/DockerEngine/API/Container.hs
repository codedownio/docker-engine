...
containerChanges
  :: Id -- ^ "id" -  ID or name of the container
  -> DockerEngineRequest ContainerChanges MimeNoContent [FilesystemChange] MimeJSON
...
-- 
containerCreate
  :: (Consumes ContainerCreate contentType, MimeRender contentType ContainerCreateRequest)
  => ContentType contentType -- ^ request content-type ('MimeType')
  -> ContainerCreateRequest -- ^ "body" -  Container to create
...
instance HasBodyParam ContainerCreate ContainerCreateRequest 
...
instance HasOptionalParam ContainerCreate Platform2 where
...
instance Produces ContainerLogs MimeVndDockerRawStream
-- | @application/vnd.docker.multiplexed-stream@
instance Produces ContainerLogs MimeVndDockerMultiplexedStream
...
-- | /Optional Param/ "signal" - Signal to send to the container as an integer or string (e.g. `SIGINT`). 
instance HasOptionalParam ContainerRestart Signal where
  applyOptionalParam req (Signal xs) =
    req `addQuery` toQuery ("signal", Just xs)
...
-- | /Optional Param/ "signal" - Signal to send to the container as an integer or string (e.g. `SIGINT`). 
instance HasOptionalParam ContainerStop Signal where
  applyOptionalParam req (Signal xs) =
    req `addQuery` toQuery ("signal", Just xs)
...
-- 
containerUpdate
  :: (Consumes ContainerUpdate MimeJSON, MimeRender MimeJSON ContainerUpdateRequest)
...
instance HasBodyParam ContainerUpdate ContainerUpdateRequest 
