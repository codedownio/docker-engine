...
data BuildCache = BuildCache
  ...
  , buildCacheType :: !(Maybe E'Type4) -- ^ "Type" - Cache record type. 
...
data TaskSpecPlacement = TaskSpecPlacement
  { taskSpecPlacementConstraints :: !(Maybe [Text]) -- ^ "Constraints" - An array of constraint expressions to limit the set of nodes where a task can be scheduled. Constraint expressions can either use a _match_ (&#x60;&#x3D;&#x3D;&#x60;) or _exclude_ (&#x60;!&#x3D;&#x60;) rule. Multiple constraints find nodes that satisfy every expression (AND match). Constraints can match node or Docker Engine labels as follows:  node attribute       | matches                        | example ---------------------|--------------------------------|----------------------------------------------- &#x60;node.id&#x60;            | Node ID                        | &#x60;node.id&#x3D;&#x3D;2ivku8v2gvtg4&#x60; &#x60;node.hostname&#x60;      | Node hostname                  | &#x60;node.hostname!&#x3D;node-2&#x60; &#x60;node.role&#x60;          | Node role (&#x60;manager&#x60;/&#x60;worker&#x60;) | &#x60;node.role&#x3D;&#x3D;manager&#x60; &#x60;node.labels&#x60;        | User-defined node labels       | &#x60;node.labels.security&#x3D;&#x3D;high&#x60; &#x60;engine.labels&#x60;      | Docker Engine&#39;s labels         | &#x60;engine.labels.operatingsystem&#x3D;&#x3D;ubuntu-14.04&#x60;  &#x60;engine.labels&#x60; apply to Docker Engine labels like operating system, drivers, etc. Swarm administrators add &#x60;node.labels&#x60; for operational purposes by using the [&#x60;node update endpoint&#x60;](#operation/NodeUpdate). 
...
-- Cache record type. 
data E'Type4
  = E'Type4'Internal -- ^ @"internal"@
  | E'Type4'Frontend -- ^ @"frontend"@
  | E'Type4'Source_local -- ^ @"source.local"@
  | E'Type4'Source_git_checkout -- ^ @"source.git.checkout"@
  | E'Type4'Exec_cachemount -- ^ @"exec.cachemount"@
  | E'Type4'Regular -- ^ @"regular"@
  deriving (P.Show, P.Eq, P.Typeable, P.Ord, P.Bounded, P.Enum)
...
toE'Type4 = \case
  "internal" -> P.Right E'Type4'Internal
  "frontend" -> P.Right E'Type4'Frontend
  "source.local" -> P.Right E'Type4'Source_local
  "source.git.checkout" -> P.Right E'Type4'Source_git_checkout
  "exec.cachemount" -> P.Right E'Type4'Exec_cachemount
  "regular" -> P.Right E'Type4'Regular
