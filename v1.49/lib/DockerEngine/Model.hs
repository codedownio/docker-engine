...
instance A.ToJSON ImageConfig where
  toJSON ImageConfig {..} =
   _omitNulls
      [ "Hostname" .= imageConfigHostname
      , "Domainname" .= imageConfigDomainname
      , "User" .= imageConfigUser
      , "AttachStdin" .= imageConfigAttachStdin
      , "AttachStdout" .= imageConfigAttachStdout
      , "AttachStderr" .= imageConfigAttachStderr
      , "ExposedPorts" .= imageConfigExposedPorts
      , "Tty" .= imageConfigTty
      , "OpenStdin" .= imageConfigOpenStdin
      , "StdinOnce" .= imageConfigStdinOnce
      , "Env" .= imageConfigEnv
      , "Cmd" .= imageConfigCmd
      , "Healthcheck" .= imageConfigHealthcheck
      , "ArgsEscaped" .= imageConfigArgsEscaped
      , "Image" .= imageConfigImage
      , "Volumes" .= imageConfigVolumes
      , "WorkingDir" .= imageConfigWorkingDir
      , "Entrypoint" .= imageConfigEntrypoint
      , "NetworkDisabled" .= imageConfigNetworkDisabled
      , "MacAddress" .= imageConfigMacAddress
      , "OnBuild" .= imageConfigOnBuild
      , "Labels" .= imageConfigLabels
      , "StopSignal" .= imageConfigStopSignal
      , "StopTimeout" .= imageConfigStopTimeout
...
mkImageConfig =
  ImageConfig
  { imageConfigHostname = Nothing
  , imageConfigDomainname = Nothing
  , imageConfigUser = Nothing
  , imageConfigAttachStdin = Nothing
  , imageConfigAttachStdout = Nothing
  , imageConfigAttachStderr = Nothing
  , imageConfigExposedPorts = Nothing
  , imageConfigTty = Nothing
  , imageConfigOpenStdin = Nothing
  , imageConfigStdinOnce = Nothing
  , imageConfigEnv = Nothing
  , imageConfigCmd = Nothing
  , imageConfigHealthcheck = Nothing
  , imageConfigArgsEscaped = Nothing
  , imageConfigImage = Nothing
  , imageConfigVolumes = Nothing
  , imageConfigWorkingDir = Nothing
  , imageConfigEntrypoint = Nothing
  , imageConfigNetworkDisabled = Nothing
  , imageConfigMacAddress = Nothing
  , imageConfigOnBuild = Nothing
  , imageConfigLabels = Nothing
  , imageConfigStopSignal = Nothing
  , imageConfigStopTimeout = Nothing
