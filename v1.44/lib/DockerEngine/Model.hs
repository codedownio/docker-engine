...
data ImageConfig = ImageConfig
  { imageConfigHostname :: !(Maybe Text) -- ^ "Hostname" - The hostname to use for the container, as a valid RFC 1123 hostname.  &lt;p&gt;&lt;br /&gt;&lt;/p&gt;  &gt; **Note**: this field is always empty and must not be used. 
  , imageConfigDomainname :: !(Maybe Text) -- ^ "Domainname" - The domain name to use for the container.  &lt;p&gt;&lt;br /&gt;&lt;/p&gt;  &gt; **Note**: this field is always empty and must not be used. 
  , imageConfigUser :: !(Maybe Text) -- ^ "User" - The user that commands are run as inside the container.
  , imageConfigAttachStdin :: !(Maybe Bool) -- ^ "AttachStdin" - Whether to attach to &#x60;stdin&#x60;.  &lt;p&gt;&lt;br /&gt;&lt;/p&gt;  &gt; **Note**: this field is always false and must not be used. 
  , imageConfigAttachStdout :: !(Maybe Bool) -- ^ "AttachStdout" - Whether to attach to &#x60;stdout&#x60;.  &lt;p&gt;&lt;br /&gt;&lt;/p&gt;  &gt; **Note**: this field is always false and must not be used. 
  , imageConfigAttachStderr :: !(Maybe Bool) -- ^ "AttachStderr" - Whether to attach to &#x60;stderr&#x60;.  &lt;p&gt;&lt;br /&gt;&lt;/p&gt;  &gt; **Note**: this field is always false and must not be used. 
  ...
  , imageConfigTty :: !(Maybe Bool) -- ^ "Tty" - Attach standard streams to a TTY, including &#x60;stdin&#x60; if it is not closed.  &lt;p&gt;&lt;br /&gt;&lt;/p&gt;  &gt; **Note**: this field is always false and must not be used. 
  , imageConfigOpenStdin :: !(Maybe Bool) -- ^ "OpenStdin" - Open &#x60;stdin&#x60;  &lt;p&gt;&lt;br /&gt;&lt;/p&gt;  &gt; **Note**: this field is always false and must not be used. 
  , imageConfigStdinOnce :: !(Maybe Bool) -- ^ "StdinOnce" - Close &#x60;stdin&#x60; after one attached client disconnects.  &lt;p&gt;&lt;br /&gt;&lt;/p&gt;  &gt; **Note**: this field is always false and must not be used. 
  ...
  , imageConfigImage :: !(Maybe Text) -- ^ "Image" - The name (or reference) of the image to use when creating the container, or which was used when the container was created.  &lt;p&gt;&lt;br /&gt;&lt;/p&gt;  &gt; **Note**: this field is always empty and must not be used. 
  ...
  , imageConfigNetworkDisabled :: !(Maybe Bool) -- ^ "NetworkDisabled" - Disable networking for the container.  &lt;p&gt;&lt;br /&gt;&lt;/p&gt;  &gt; **Note**: this field is always omitted and must not be used. 
  , imageConfigMacAddress :: !(Maybe Text) -- ^ "MacAddress" - MAC address of the container.  &lt;p&gt;&lt;br /&gt;&lt;/p&gt;  &gt; **Deprecated**: this field is deprecated in API v1.44 and up. It is always omitted. 
  ...
  , imageConfigStopTimeout :: !(Maybe Int) -- ^ "StopTimeout" - Timeout to stop a container in seconds.  &lt;p&gt;&lt;br /&gt;&lt;/p&gt;  &gt; **Note**: this field is always omitted and must not be used. 
...
data ImageInspect = ImageInspect
  ...
  , imageInspectContainer :: !(Maybe Text) -- ^ "Container" - The ID of the container that was used to create the image.  Depending on how the image was created, this field may be empty.  **Deprecated**: this field is kept for backward compatibility, but will be removed in API v1.45. 
...
data ImageSearchResponseItem = ImageSearchResponseItem
  ...
  , imageSearchResponseItemIsAutomated :: !(Maybe Bool) -- ^ "is_automated" - Whether this repository has automated builds enabled.  &lt;p&gt;&lt;br /&gt;&lt;/p&gt;  &gt; **Deprecated**: This field is deprecated and will always &gt; be \&quot;false\&quot; in future. 
...
data MountBindOptions = MountBindOptions
  ...
  , mountBindOptionsReadOnlyNonRecursive :: !(Maybe Bool) -- ^ "ReadOnlyNonRecursive" - Make the mount non-recursively read-only, but still leave the mount recursive (unless NonRecursive is set to true in conjunction). 
...
data NetworkCreateRequest = NetworkCreateRequest
  ...
  , networkCreateRequestCheckDuplicate :: !(Maybe Bool) -- ^ "CheckDuplicate" - Deprecated: CheckDuplicate is now always enabled. 
