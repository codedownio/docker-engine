...
data MimeJsonSeq = MimeJsonSeq deriving (P.Typeable)

-- | @application/json-seq@
instance MimeType MimeJsonSeq where
  mimeType _ = Just $ P.fromString "application/json-seq"
-- instance MimeRender MimeJsonSeq T.Text where mimeRender _ = undefined
-- instance MimeUnrender MimeJsonSeq T.Text where mimeUnrender _ = undefined

-- ** MimeVndDockerMultiplexedStream

data MimeVndDockerMultiplexedStream = MimeVndDockerMultiplexedStream deriving (P.Typeable)

-- | @application/vnd.docker.multiplexed-stream@
instance MimeType MimeVndDockerMultiplexedStream where
  mimeType _ = Just $ P.fromString "application/vnd.docker.multiplexed-stream"
-- instance MimeRender MimeVndDockerMultiplexedStream T.Text where mimeRender _ = undefined
-- instance MimeUnrender MimeVndDockerMultiplexedStream T.Text where mimeUnrender _ = undefined
...
data MimeXNdjson = MimeXNdjson deriving (P.Typeable)

-- | @application/x-ndjson@
instance MimeType MimeXNdjson where
  mimeType _ = Just $ P.fromString "application/x-ndjson"
instance A.ToJSON a => MimeRender MimeXNdjson a where mimeRender _ = A.encode
instance A.FromJSON a => MimeUnrender MimeXNdjson a where mimeUnrender _ = A.eitherDecode
-- instance MimeRender MimeXNdjson T.Text where mimeRender _ = undefined
-- instance MimeUnrender MimeXNdjson T.Text where mimeUnrender _ = undefined
