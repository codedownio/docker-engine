...
-- | 'authResponseStatus' Lens
authResponseStatusL :: Lens_' AuthResponse (Text)
authResponseStatusL f AuthResponse{..} = (\authResponseStatus -> AuthResponse { authResponseStatus, ..} ) <$> f authResponseStatus
{-# INLINE authResponseStatusL #-}

-- | 'authResponseIdentityToken' Lens
authResponseIdentityTokenL :: Lens_' AuthResponse (Maybe Text)
authResponseIdentityTokenL f AuthResponse{..} = (\authResponseIdentityToken -> AuthResponse { authResponseIdentityToken, ..} ) <$> f authResponseIdentityToken
{-# INLINE authResponseIdentityTokenL #-}
...
-- | 'buildCacheParents' Lens
buildCacheParentsL :: Lens_' BuildCache (Maybe [Text])
buildCacheParentsL f BuildCache{..} = (\buildCacheParents -> BuildCache { buildCacheParents, ..} ) <$> f buildCacheParents
{-# INLINE buildCacheParentsL #-}

-- | 'buildCacheType' Lens
buildCacheTypeL :: Lens_' BuildCache (Maybe E'Type3)
...
-- | 'buildCacheDiskUsageActiveCount' Lens
buildCacheDiskUsageActiveCountL :: Lens_' BuildCacheDiskUsage (Maybe Integer)
buildCacheDiskUsageActiveCountL f BuildCacheDiskUsage{..} = (\buildCacheDiskUsageActiveCount -> BuildCacheDiskUsage { buildCacheDiskUsageActiveCount, ..} ) <$> f buildCacheDiskUsageActiveCount
{-# INLINE buildCacheDiskUsageActiveCountL #-}

-- | 'buildCacheDiskUsageTotalCount' Lens
buildCacheDiskUsageTotalCountL :: Lens_' BuildCacheDiskUsage (Maybe Integer)
buildCacheDiskUsageTotalCountL f BuildCacheDiskUsage{..} = (\buildCacheDiskUsageTotalCount -> BuildCacheDiskUsage { buildCacheDiskUsageTotalCount, ..} ) <$> f buildCacheDiskUsageTotalCount
{-# INLINE buildCacheDiskUsageTotalCountL #-}

-- | 'buildCacheDiskUsageReclaimable' Lens
buildCacheDiskUsageReclaimableL :: Lens_' BuildCacheDiskUsage (Maybe Integer)
buildCacheDiskUsageReclaimableL f BuildCacheDiskUsage{..} = (\buildCacheDiskUsageReclaimable -> BuildCacheDiskUsage { buildCacheDiskUsageReclaimable, ..} ) <$> f buildCacheDiskUsageReclaimable
{-# INLINE buildCacheDiskUsageReclaimableL #-}

-- | 'buildCacheDiskUsageTotalSize' Lens
buildCacheDiskUsageTotalSizeL :: Lens_' BuildCacheDiskUsage (Maybe Integer)
buildCacheDiskUsageTotalSizeL f BuildCacheDiskUsage{..} = (\buildCacheDiskUsageTotalSize -> BuildCacheDiskUsage { buildCacheDiskUsageTotalSize, ..} ) <$> f buildCacheDiskUsageTotalSize
{-# INLINE buildCacheDiskUsageTotalSizeL #-}

-- | 'buildCacheDiskUsageItems' Lens
buildCacheDiskUsageItemsL :: Lens_' BuildCacheDiskUsage (Maybe [A.Value])
buildCacheDiskUsageItemsL f BuildCacheDiskUsage{..} = (\buildCacheDiskUsageItems -> BuildCacheDiskUsage { buildCacheDiskUsageItems, ..} ) <$> f buildCacheDiskUsageItems
{-# INLINE buildCacheDiskUsageItemsL #-}
...
-- | 'clusterVolumeId' Lens
clusterVolumeIdL :: Lens_' ClusterVolume (Maybe Text)
clusterVolumeIdL f ClusterVolume{..} = (\clusterVolumeId -> ClusterVolume { clusterVolumeId, ..} ) <$> f clusterVolumeId
{-# INLINE clusterVolumeIdL #-}

-- | 'clusterVolumeVersion' Lens
clusterVolumeVersionL :: Lens_' ClusterVolume (Maybe ObjectVersion)
clusterVolumeVersionL f ClusterVolume{..} = (\clusterVolumeVersion -> ClusterVolume { clusterVolumeVersion, ..} ) <$> f clusterVolumeVersion
{-# INLINE clusterVolumeVersionL #-}

-- | 'clusterVolumeCreatedAt' Lens
clusterVolumeCreatedAtL :: Lens_' ClusterVolume (Maybe Text)
clusterVolumeCreatedAtL f ClusterVolume{..} = (\clusterVolumeCreatedAt -> ClusterVolume { clusterVolumeCreatedAt, ..} ) <$> f clusterVolumeCreatedAt
{-# INLINE clusterVolumeCreatedAtL #-}

-- | 'clusterVolumeUpdatedAt' Lens
clusterVolumeUpdatedAtL :: Lens_' ClusterVolume (Maybe Text)
clusterVolumeUpdatedAtL f ClusterVolume{..} = (\clusterVolumeUpdatedAt -> ClusterVolume { clusterVolumeUpdatedAt, ..} ) <$> f clusterVolumeUpdatedAt
{-# INLINE clusterVolumeUpdatedAtL #-}

-- | 'clusterVolumeSpec' Lens
clusterVolumeSpecL :: Lens_' ClusterVolume (Maybe ClusterVolumeSpec)
clusterVolumeSpecL f ClusterVolume{..} = (\clusterVolumeSpec -> ClusterVolume { clusterVolumeSpec, ..} ) <$> f clusterVolumeSpec
{-# INLINE clusterVolumeSpecL #-}

-- | 'clusterVolumeInfo' Lens
clusterVolumeInfoL :: Lens_' ClusterVolume (Maybe ClusterVolumeInfo)
clusterVolumeInfoL f ClusterVolume{..} = (\clusterVolumeInfo -> ClusterVolume { clusterVolumeInfo, ..} ) <$> f clusterVolumeInfo
{-# INLINE clusterVolumeInfoL #-}

-- | 'clusterVolumePublishStatus' Lens
clusterVolumePublishStatusL :: Lens_' ClusterVolume (Maybe [ClusterVolumePublishStatusInner])
clusterVolumePublishStatusL f ClusterVolume{..} = (\clusterVolumePublishStatus -> ClusterVolume { clusterVolumePublishStatus, ..} ) <$> f clusterVolumePublishStatus
{-# INLINE clusterVolumePublishStatusL #-}



-- * ClusterVolumeInfo

-- | 'clusterVolumeInfoCapacityBytes' Lens
clusterVolumeInfoCapacityBytesL :: Lens_' ClusterVolumeInfo (Maybe Integer)
clusterVolumeInfoCapacityBytesL f ClusterVolumeInfo{..} = (\clusterVolumeInfoCapacityBytes -> ClusterVolumeInfo { clusterVolumeInfoCapacityBytes, ..} ) <$> f clusterVolumeInfoCapacityBytes
{-# INLINE clusterVolumeInfoCapacityBytesL #-}

-- | 'clusterVolumeInfoVolumeContext' Lens
clusterVolumeInfoVolumeContextL :: Lens_' ClusterVolumeInfo (Maybe (Map.Map String Text))
clusterVolumeInfoVolumeContextL f ClusterVolumeInfo{..} = (\clusterVolumeInfoVolumeContext -> ClusterVolumeInfo { clusterVolumeInfoVolumeContext, ..} ) <$> f clusterVolumeInfoVolumeContext
{-# INLINE clusterVolumeInfoVolumeContextL #-}

-- | 'clusterVolumeInfoVolumeId' Lens
clusterVolumeInfoVolumeIdL :: Lens_' ClusterVolumeInfo (Maybe Text)
clusterVolumeInfoVolumeIdL f ClusterVolumeInfo{..} = (\clusterVolumeInfoVolumeId -> ClusterVolumeInfo { clusterVolumeInfoVolumeId, ..} ) <$> f clusterVolumeInfoVolumeId
{-# INLINE clusterVolumeInfoVolumeIdL #-}

-- | 'clusterVolumeInfoAccessibleTopology' Lens
clusterVolumeInfoAccessibleTopologyL :: Lens_' ClusterVolumeInfo (Maybe [Map])
clusterVolumeInfoAccessibleTopologyL f ClusterVolumeInfo{..} = (\clusterVolumeInfoAccessibleTopology -> ClusterVolumeInfo { clusterVolumeInfoAccessibleTopology, ..} ) <$> f clusterVolumeInfoAccessibleTopology
{-# INLINE clusterVolumeInfoAccessibleTopologyL #-}



-- * ClusterVolumePublishStatusInner

-- | 'clusterVolumePublishStatusInnerNodeId' Lens
clusterVolumePublishStatusInnerNodeIdL :: Lens_' ClusterVolumePublishStatusInner (Maybe Text)
clusterVolumePublishStatusInnerNodeIdL f ClusterVolumePublishStatusInner{..} = (\clusterVolumePublishStatusInnerNodeId -> ClusterVolumePublishStatusInner { clusterVolumePublishStatusInnerNodeId, ..} ) <$> f clusterVolumePublishStatusInnerNodeId
{-# INLINE clusterVolumePublishStatusInnerNodeIdL #-}

-- | 'clusterVolumePublishStatusInnerState' Lens
clusterVolumePublishStatusInnerStateL :: Lens_' ClusterVolumePublishStatusInner (Maybe E'State3)
clusterVolumePublishStatusInnerStateL f ClusterVolumePublishStatusInner{..} = (\clusterVolumePublishStatusInnerState -> ClusterVolumePublishStatusInner { clusterVolumePublishStatusInnerState, ..} ) <$> f clusterVolumePublishStatusInnerState
{-# INLINE clusterVolumePublishStatusInnerStateL #-}

-- | 'clusterVolumePublishStatusInnerPublishContext' Lens
clusterVolumePublishStatusInnerPublishContextL :: Lens_' ClusterVolumePublishStatusInner (Maybe (Map.Map String Text))
clusterVolumePublishStatusInnerPublishContextL f ClusterVolumePublishStatusInner{..} = (\clusterVolumePublishStatusInnerPublishContext -> ClusterVolumePublishStatusInner { clusterVolumePublishStatusInnerPublishContext, ..} ) <$> f clusterVolumePublishStatusInnerPublishContext
...
-- | 'clusterVolumeSpecGroup' Lens
clusterVolumeSpecGroupL :: Lens_' ClusterVolumeSpec (Maybe Text)
clusterVolumeSpecGroupL f ClusterVolumeSpec{..} = (\clusterVolumeSpecGroup -> ClusterVolumeSpec { clusterVolumeSpecGroup, ..} ) <$> f clusterVolumeSpecGroup
{-# INLINE clusterVolumeSpecGroupL #-}

-- | 'clusterVolumeSpecAccessMode' Lens
clusterVolumeSpecAccessModeL :: Lens_' ClusterVolumeSpec (Maybe ClusterVolumeSpecAccessMode)
clusterVolumeSpecAccessModeL f ClusterVolumeSpec{..} = (\clusterVolumeSpecAccessMode -> ClusterVolumeSpec { clusterVolumeSpecAccessMode, ..} ) <$> f clusterVolumeSpecAccessMode
{-# INLINE clusterVolumeSpecAccessModeL #-}



-- * ClusterVolumeSpecAccessMode

-- | 'clusterVolumeSpecAccessModeScope' Lens
clusterVolumeSpecAccessModeScopeL :: Lens_' ClusterVolumeSpecAccessMode (Maybe E'Scope3)
clusterVolumeSpecAccessModeScopeL f ClusterVolumeSpecAccessMode{..} = (\clusterVolumeSpecAccessModeScope -> ClusterVolumeSpecAccessMode { clusterVolumeSpecAccessModeScope, ..} ) <$> f clusterVolumeSpecAccessModeScope
{-# INLINE clusterVolumeSpecAccessModeScopeL #-}

-- | 'clusterVolumeSpecAccessModeSharing' Lens
clusterVolumeSpecAccessModeSharingL :: Lens_' ClusterVolumeSpecAccessMode (Maybe E'Sharing)
clusterVolumeSpecAccessModeSharingL f ClusterVolumeSpecAccessMode{..} = (\clusterVolumeSpecAccessModeSharing -> ClusterVolumeSpecAccessMode { clusterVolumeSpecAccessModeSharing, ..} ) <$> f clusterVolumeSpecAccessModeSharing
{-# INLINE clusterVolumeSpecAccessModeSharingL #-}

-- | 'clusterVolumeSpecAccessModeMountVolume' Lens
clusterVolumeSpecAccessModeMountVolumeL :: Lens_' ClusterVolumeSpecAccessMode (Maybe A.Value)
clusterVolumeSpecAccessModeMountVolumeL f ClusterVolumeSpecAccessMode{..} = (\clusterVolumeSpecAccessModeMountVolume -> ClusterVolumeSpecAccessMode { clusterVolumeSpecAccessModeMountVolume, ..} ) <$> f clusterVolumeSpecAccessModeMountVolume
{-# INLINE clusterVolumeSpecAccessModeMountVolumeL #-}

-- | 'clusterVolumeSpecAccessModeSecrets' Lens
clusterVolumeSpecAccessModeSecretsL :: Lens_' ClusterVolumeSpecAccessMode (Maybe [ClusterVolumeSpecAccessModeSecretsInner])
clusterVolumeSpecAccessModeSecretsL f ClusterVolumeSpecAccessMode{..} = (\clusterVolumeSpecAccessModeSecrets -> ClusterVolumeSpecAccessMode { clusterVolumeSpecAccessModeSecrets, ..} ) <$> f clusterVolumeSpecAccessModeSecrets
{-# INLINE clusterVolumeSpecAccessModeSecretsL #-}

-- | 'clusterVolumeSpecAccessModeAccessibilityRequirements' Lens
clusterVolumeSpecAccessModeAccessibilityRequirementsL :: Lens_' ClusterVolumeSpecAccessMode (Maybe ClusterVolumeSpecAccessModeAccessibilityRequirements)
clusterVolumeSpecAccessModeAccessibilityRequirementsL f ClusterVolumeSpecAccessMode{..} = (\clusterVolumeSpecAccessModeAccessibilityRequirements -> ClusterVolumeSpecAccessMode { clusterVolumeSpecAccessModeAccessibilityRequirements, ..} ) <$> f clusterVolumeSpecAccessModeAccessibilityRequirements
{-# INLINE clusterVolumeSpecAccessModeAccessibilityRequirementsL #-}

-- | 'clusterVolumeSpecAccessModeCapacityRange' Lens
clusterVolumeSpecAccessModeCapacityRangeL :: Lens_' ClusterVolumeSpecAccessMode (Maybe ClusterVolumeSpecAccessModeCapacityRange)
clusterVolumeSpecAccessModeCapacityRangeL f ClusterVolumeSpecAccessMode{..} = (\clusterVolumeSpecAccessModeCapacityRange -> ClusterVolumeSpecAccessMode { clusterVolumeSpecAccessModeCapacityRange, ..} ) <$> f clusterVolumeSpecAccessModeCapacityRange
{-# INLINE clusterVolumeSpecAccessModeCapacityRangeL #-}

-- | 'clusterVolumeSpecAccessModeAvailability' Lens
clusterVolumeSpecAccessModeAvailabilityL :: Lens_' ClusterVolumeSpecAccessMode (Maybe E'Availability)
clusterVolumeSpecAccessModeAvailabilityL f ClusterVolumeSpecAccessMode{..} = (\clusterVolumeSpecAccessModeAvailability -> ClusterVolumeSpecAccessMode { clusterVolumeSpecAccessModeAvailability, ..} ) <$> f clusterVolumeSpecAccessModeAvailability
{-# INLINE clusterVolumeSpecAccessModeAvailabilityL #-}



-- * ClusterVolumeSpecAccessModeAccessibilityRequirements

-- | 'clusterVolumeSpecAccessModeAccessibilityRequirementsRequisite' Lens
clusterVolumeSpecAccessModeAccessibilityRequirementsRequisiteL :: Lens_' ClusterVolumeSpecAccessModeAccessibilityRequirements (Maybe [Map])
clusterVolumeSpecAccessModeAccessibilityRequirementsRequisiteL f ClusterVolumeSpecAccessModeAccessibilityRequirements{..} = (\clusterVolumeSpecAccessModeAccessibilityRequirementsRequisite -> ClusterVolumeSpecAccessModeAccessibilityRequirements { clusterVolumeSpecAccessModeAccessibilityRequirementsRequisite, ..} ) <$> f clusterVolumeSpecAccessModeAccessibilityRequirementsRequisite
{-# INLINE clusterVolumeSpecAccessModeAccessibilityRequirementsRequisiteL #-}

-- | 'clusterVolumeSpecAccessModeAccessibilityRequirementsPreferred' Lens
clusterVolumeSpecAccessModeAccessibilityRequirementsPreferredL :: Lens_' ClusterVolumeSpecAccessModeAccessibilityRequirements (Maybe [Map])
clusterVolumeSpecAccessModeAccessibilityRequirementsPreferredL f ClusterVolumeSpecAccessModeAccessibilityRequirements{..} = (\clusterVolumeSpecAccessModeAccessibilityRequirementsPreferred -> ClusterVolumeSpecAccessModeAccessibilityRequirements { clusterVolumeSpecAccessModeAccessibilityRequirementsPreferred, ..} ) <$> f clusterVolumeSpecAccessModeAccessibilityRequirementsPreferred
{-# INLINE clusterVolumeSpecAccessModeAccessibilityRequirementsPreferredL #-}



-- * ClusterVolumeSpecAccessModeCapacityRange

-- | 'clusterVolumeSpecAccessModeCapacityRangeRequiredBytes' Lens
clusterVolumeSpecAccessModeCapacityRangeRequiredBytesL :: Lens_' ClusterVolumeSpecAccessModeCapacityRange (Maybe Integer)
clusterVolumeSpecAccessModeCapacityRangeRequiredBytesL f ClusterVolumeSpecAccessModeCapacityRange{..} = (\clusterVolumeSpecAccessModeCapacityRangeRequiredBytes -> ClusterVolumeSpecAccessModeCapacityRange { clusterVolumeSpecAccessModeCapacityRangeRequiredBytes, ..} ) <$> f clusterVolumeSpecAccessModeCapacityRangeRequiredBytes
{-# INLINE clusterVolumeSpecAccessModeCapacityRangeRequiredBytesL #-}

-- | 'clusterVolumeSpecAccessModeCapacityRangeLimitBytes' Lens
clusterVolumeSpecAccessModeCapacityRangeLimitBytesL :: Lens_' ClusterVolumeSpecAccessModeCapacityRange (Maybe Integer)
clusterVolumeSpecAccessModeCapacityRangeLimitBytesL f ClusterVolumeSpecAccessModeCapacityRange{..} = (\clusterVolumeSpecAccessModeCapacityRangeLimitBytes -> ClusterVolumeSpecAccessModeCapacityRange { clusterVolumeSpecAccessModeCapacityRangeLimitBytes, ..} ) <$> f clusterVolumeSpecAccessModeCapacityRangeLimitBytes
{-# INLINE clusterVolumeSpecAccessModeCapacityRangeLimitBytesL #-}



-- * ClusterVolumeSpecAccessModeSecretsInner

-- | 'clusterVolumeSpecAccessModeSecretsInnerKey' Lens
clusterVolumeSpecAccessModeSecretsInnerKeyL :: Lens_' ClusterVolumeSpecAccessModeSecretsInner (Maybe Text)
clusterVolumeSpecAccessModeSecretsInnerKeyL f ClusterVolumeSpecAccessModeSecretsInner{..} = (\clusterVolumeSpecAccessModeSecretsInnerKey -> ClusterVolumeSpecAccessModeSecretsInner { clusterVolumeSpecAccessModeSecretsInnerKey, ..} ) <$> f clusterVolumeSpecAccessModeSecretsInnerKey
{-# INLINE clusterVolumeSpecAccessModeSecretsInnerKeyL #-}

-- | 'clusterVolumeSpecAccessModeSecretsInnerSecret' Lens
clusterVolumeSpecAccessModeSecretsInnerSecretL :: Lens_' ClusterVolumeSpecAccessModeSecretsInner (Maybe Text)
clusterVolumeSpecAccessModeSecretsInnerSecretL f ClusterVolumeSpecAccessModeSecretsInner{..} = (\clusterVolumeSpecAccessModeSecretsInnerSecret -> ClusterVolumeSpecAccessModeSecretsInner { clusterVolumeSpecAccessModeSecretsInnerSecret, ..} ) <$> f clusterVolumeSpecAccessModeSecretsInnerSecret
{-# INLINE clusterVolumeSpecAccessModeSecretsInnerSecretL #-}
...
-- | 'configReferenceNetwork' Lens
configReferenceNetworkL :: Lens_' ConfigReference (Maybe Text)
configReferenceNetworkL f ConfigReference{..} = (\configReferenceNetwork -> ConfigReference { configReferenceNetwork, ..} ) <$> f configReferenceNetwork
{-# INLINE configReferenceNetworkL #-}
...
-- | 'containerBlkioStatEntryMajor' Lens
containerBlkioStatEntryMajorL :: Lens_' ContainerBlkioStatEntry (Maybe Int)
containerBlkioStatEntryMajorL f ContainerBlkioStatEntry{..} = (\containerBlkioStatEntryMajor -> ContainerBlkioStatEntry { containerBlkioStatEntryMajor, ..} ) <$> f containerBlkioStatEntryMajor
{-# INLINE containerBlkioStatEntryMajorL #-}

-- | 'containerBlkioStatEntryMinor' Lens
containerBlkioStatEntryMinorL :: Lens_' ContainerBlkioStatEntry (Maybe Int)
containerBlkioStatEntryMinorL f ContainerBlkioStatEntry{..} = (\containerBlkioStatEntryMinor -> ContainerBlkioStatEntry { containerBlkioStatEntryMinor, ..} ) <$> f containerBlkioStatEntryMinor
{-# INLINE containerBlkioStatEntryMinorL #-}

-- | 'containerBlkioStatEntryOp' Lens
containerBlkioStatEntryOpL :: Lens_' ContainerBlkioStatEntry (Maybe Text)
containerBlkioStatEntryOpL f ContainerBlkioStatEntry{..} = (\containerBlkioStatEntryOp -> ContainerBlkioStatEntry { containerBlkioStatEntryOp, ..} ) <$> f containerBlkioStatEntryOp
{-# INLINE containerBlkioStatEntryOpL #-}

-- | 'containerBlkioStatEntryValue' Lens
containerBlkioStatEntryValueL :: Lens_' ContainerBlkioStatEntry (Maybe Int)
containerBlkioStatEntryValueL f ContainerBlkioStatEntry{..} = (\containerBlkioStatEntryValue -> ContainerBlkioStatEntry { containerBlkioStatEntryValue, ..} ) <$> f containerBlkioStatEntryValue
{-# INLINE containerBlkioStatEntryValueL #-}



-- * ContainerBlkioStats

-- | 'containerBlkioStatsIoServiceBytesRecursive' Lens
containerBlkioStatsIoServiceBytesRecursiveL :: Lens_' ContainerBlkioStats (Maybe [ContainerBlkioStatEntry])
containerBlkioStatsIoServiceBytesRecursiveL f ContainerBlkioStats{..} = (\containerBlkioStatsIoServiceBytesRecursive -> ContainerBlkioStats { containerBlkioStatsIoServiceBytesRecursive, ..} ) <$> f containerBlkioStatsIoServiceBytesRecursive
{-# INLINE containerBlkioStatsIoServiceBytesRecursiveL #-}

-- | 'containerBlkioStatsIoServicedRecursive' Lens
containerBlkioStatsIoServicedRecursiveL :: Lens_' ContainerBlkioStats (Maybe [ContainerBlkioStatEntry])
containerBlkioStatsIoServicedRecursiveL f ContainerBlkioStats{..} = (\containerBlkioStatsIoServicedRecursive -> ContainerBlkioStats { containerBlkioStatsIoServicedRecursive, ..} ) <$> f containerBlkioStatsIoServicedRecursive
{-# INLINE containerBlkioStatsIoServicedRecursiveL #-}

-- | 'containerBlkioStatsIoQueueRecursive' Lens
containerBlkioStatsIoQueueRecursiveL :: Lens_' ContainerBlkioStats (Maybe [ContainerBlkioStatEntry])
containerBlkioStatsIoQueueRecursiveL f ContainerBlkioStats{..} = (\containerBlkioStatsIoQueueRecursive -> ContainerBlkioStats { containerBlkioStatsIoQueueRecursive, ..} ) <$> f containerBlkioStatsIoQueueRecursive
{-# INLINE containerBlkioStatsIoQueueRecursiveL #-}

-- | 'containerBlkioStatsIoServiceTimeRecursive' Lens
containerBlkioStatsIoServiceTimeRecursiveL :: Lens_' ContainerBlkioStats (Maybe [ContainerBlkioStatEntry])
containerBlkioStatsIoServiceTimeRecursiveL f ContainerBlkioStats{..} = (\containerBlkioStatsIoServiceTimeRecursive -> ContainerBlkioStats { containerBlkioStatsIoServiceTimeRecursive, ..} ) <$> f containerBlkioStatsIoServiceTimeRecursive
{-# INLINE containerBlkioStatsIoServiceTimeRecursiveL #-}

-- | 'containerBlkioStatsIoWaitTimeRecursive' Lens
containerBlkioStatsIoWaitTimeRecursiveL :: Lens_' ContainerBlkioStats (Maybe [ContainerBlkioStatEntry])
containerBlkioStatsIoWaitTimeRecursiveL f ContainerBlkioStats{..} = (\containerBlkioStatsIoWaitTimeRecursive -> ContainerBlkioStats { containerBlkioStatsIoWaitTimeRecursive, ..} ) <$> f containerBlkioStatsIoWaitTimeRecursive
{-# INLINE containerBlkioStatsIoWaitTimeRecursiveL #-}

-- | 'containerBlkioStatsIoMergedRecursive' Lens
containerBlkioStatsIoMergedRecursiveL :: Lens_' ContainerBlkioStats (Maybe [ContainerBlkioStatEntry])
containerBlkioStatsIoMergedRecursiveL f ContainerBlkioStats{..} = (\containerBlkioStatsIoMergedRecursive -> ContainerBlkioStats { containerBlkioStatsIoMergedRecursive, ..} ) <$> f containerBlkioStatsIoMergedRecursive
{-# INLINE containerBlkioStatsIoMergedRecursiveL #-}

-- | 'containerBlkioStatsIoTimeRecursive' Lens
containerBlkioStatsIoTimeRecursiveL :: Lens_' ContainerBlkioStats (Maybe [ContainerBlkioStatEntry])
containerBlkioStatsIoTimeRecursiveL f ContainerBlkioStats{..} = (\containerBlkioStatsIoTimeRecursive -> ContainerBlkioStats { containerBlkioStatsIoTimeRecursive, ..} ) <$> f containerBlkioStatsIoTimeRecursive
{-# INLINE containerBlkioStatsIoTimeRecursiveL #-}

-- | 'containerBlkioStatsSectorsRecursive' Lens
containerBlkioStatsSectorsRecursiveL :: Lens_' ContainerBlkioStats (Maybe [ContainerBlkioStatEntry])
containerBlkioStatsSectorsRecursiveL f ContainerBlkioStats{..} = (\containerBlkioStatsSectorsRecursive -> ContainerBlkioStats { containerBlkioStatsSectorsRecursive, ..} ) <$> f containerBlkioStatsSectorsRecursive
{-# INLINE containerBlkioStatsSectorsRecursiveL #-}



-- * ContainerCPUStats

-- | 'containerCPUStatsCpuUsage' Lens
containerCPUStatsCpuUsageL :: Lens_' ContainerCPUStats (Maybe ContainerCPUUsage)
containerCPUStatsCpuUsageL f ContainerCPUStats{..} = (\containerCPUStatsCpuUsage -> ContainerCPUStats { containerCPUStatsCpuUsage, ..} ) <$> f containerCPUStatsCpuUsage
{-# INLINE containerCPUStatsCpuUsageL #-}

-- | 'containerCPUStatsSystemCpuUsage' Lens
containerCPUStatsSystemCpuUsageL :: Lens_' ContainerCPUStats (Maybe Int)
containerCPUStatsSystemCpuUsageL f ContainerCPUStats{..} = (\containerCPUStatsSystemCpuUsage -> ContainerCPUStats { containerCPUStatsSystemCpuUsage, ..} ) <$> f containerCPUStatsSystemCpuUsage
{-# INLINE containerCPUStatsSystemCpuUsageL #-}

-- | 'containerCPUStatsOnlineCpus' Lens
containerCPUStatsOnlineCpusL :: Lens_' ContainerCPUStats (Maybe Int)
containerCPUStatsOnlineCpusL f ContainerCPUStats{..} = (\containerCPUStatsOnlineCpus -> ContainerCPUStats { containerCPUStatsOnlineCpus, ..} ) <$> f containerCPUStatsOnlineCpus
{-# INLINE containerCPUStatsOnlineCpusL #-}

-- | 'containerCPUStatsThrottlingData' Lens
containerCPUStatsThrottlingDataL :: Lens_' ContainerCPUStats (Maybe ContainerThrottlingData)
containerCPUStatsThrottlingDataL f ContainerCPUStats{..} = (\containerCPUStatsThrottlingData -> ContainerCPUStats { containerCPUStatsThrottlingData, ..} ) <$> f containerCPUStatsThrottlingData
{-# INLINE containerCPUStatsThrottlingDataL #-}



-- * ContainerCPUUsage

-- | 'containerCPUUsageTotalUsage' Lens
containerCPUUsageTotalUsageL :: Lens_' ContainerCPUUsage (Maybe Int)
containerCPUUsageTotalUsageL f ContainerCPUUsage{..} = (\containerCPUUsageTotalUsage -> ContainerCPUUsage { containerCPUUsageTotalUsage, ..} ) <$> f containerCPUUsageTotalUsage
{-# INLINE containerCPUUsageTotalUsageL #-}

-- | 'containerCPUUsagePercpuUsage' Lens
containerCPUUsagePercpuUsageL :: Lens_' ContainerCPUUsage (Maybe [Int])
containerCPUUsagePercpuUsageL f ContainerCPUUsage{..} = (\containerCPUUsagePercpuUsage -> ContainerCPUUsage { containerCPUUsagePercpuUsage, ..} ) <$> f containerCPUUsagePercpuUsage
{-# INLINE containerCPUUsagePercpuUsageL #-}

-- | 'containerCPUUsageUsageInKernelmode' Lens
containerCPUUsageUsageInKernelmodeL :: Lens_' ContainerCPUUsage (Maybe Int)
containerCPUUsageUsageInKernelmodeL f ContainerCPUUsage{..} = (\containerCPUUsageUsageInKernelmode -> ContainerCPUUsage { containerCPUUsageUsageInKernelmode, ..} ) <$> f containerCPUUsageUsageInKernelmode
{-# INLINE containerCPUUsageUsageInKernelmodeL #-}

-- | 'containerCPUUsageUsageInUsermode' Lens
containerCPUUsageUsageInUsermodeL :: Lens_' ContainerCPUUsage (Maybe Int)
containerCPUUsageUsageInUsermodeL f ContainerCPUUsage{..} = (\containerCPUUsageUsageInUsermode -> ContainerCPUUsage { containerCPUUsageUsageInUsermode, ..} ) <$> f containerCPUUsageUsageInUsermode
{-# INLINE containerCPUUsageUsageInUsermodeL #-}
...
containerCreateRequestNetworkingConfigL :: Lens_' ContainerCreateRequest (Maybe NetworkingConfig)
...
-- | 'containerInspectResponseImageManifestDescriptor' Lens
containerInspectResponseImageManifestDescriptorL :: Lens_' ContainerInspectResponse (Maybe OCIDescriptor)
containerInspectResponseImageManifestDescriptorL f ContainerInspectResponse{..} = (\containerInspectResponseImageManifestDescriptor -> ContainerInspectResponse { containerInspectResponseImageManifestDescriptor, ..} ) <$> f containerInspectResponseImageManifestDescriptor
{-# INLINE containerInspectResponseImageManifestDescriptorL #-}
...
containerInspectResponseGraphDriverL :: Lens_' ContainerInspectResponse (Maybe DriverData)
...
-- | 'containerInspectResponseStorage' Lens
containerInspectResponseStorageL :: Lens_' ContainerInspectResponse (Maybe Storage)
containerInspectResponseStorageL f ContainerInspectResponse{..} = (\containerInspectResponseStorage -> ContainerInspectResponse { containerInspectResponseStorage, ..} ) <$> f containerInspectResponseStorage
{-# INLINE containerInspectResponseStorageL #-}
...
-- | 'containerMemoryStatsUsage' Lens
containerMemoryStatsUsageL :: Lens_' ContainerMemoryStats (Maybe Int)
containerMemoryStatsUsageL f ContainerMemoryStats{..} = (\containerMemoryStatsUsage -> ContainerMemoryStats { containerMemoryStatsUsage, ..} ) <$> f containerMemoryStatsUsage
{-# INLINE containerMemoryStatsUsageL #-}

-- | 'containerMemoryStatsMaxUsage' Lens
containerMemoryStatsMaxUsageL :: Lens_' ContainerMemoryStats (Maybe Int)
containerMemoryStatsMaxUsageL f ContainerMemoryStats{..} = (\containerMemoryStatsMaxUsage -> ContainerMemoryStats { containerMemoryStatsMaxUsage, ..} ) <$> f containerMemoryStatsMaxUsage
{-# INLINE containerMemoryStatsMaxUsageL #-}

-- | 'containerMemoryStatsStats' Lens
containerMemoryStatsStatsL :: Lens_' ContainerMemoryStats (Maybe (Map.Map String Int))
containerMemoryStatsStatsL f ContainerMemoryStats{..} = (\containerMemoryStatsStats -> ContainerMemoryStats { containerMemoryStatsStats, ..} ) <$> f containerMemoryStatsStats
{-# INLINE containerMemoryStatsStatsL #-}

-- | 'containerMemoryStatsFailcnt' Lens
containerMemoryStatsFailcntL :: Lens_' ContainerMemoryStats (Maybe Int)
containerMemoryStatsFailcntL f ContainerMemoryStats{..} = (\containerMemoryStatsFailcnt -> ContainerMemoryStats { containerMemoryStatsFailcnt, ..} ) <$> f containerMemoryStatsFailcnt
{-# INLINE containerMemoryStatsFailcntL #-}

-- | 'containerMemoryStatsLimit' Lens
containerMemoryStatsLimitL :: Lens_' ContainerMemoryStats (Maybe Int)
containerMemoryStatsLimitL f ContainerMemoryStats{..} = (\containerMemoryStatsLimit -> ContainerMemoryStats { containerMemoryStatsLimit, ..} ) <$> f containerMemoryStatsLimit
{-# INLINE containerMemoryStatsLimitL #-}

-- | 'containerMemoryStatsCommitbytes' Lens
containerMemoryStatsCommitbytesL :: Lens_' ContainerMemoryStats (Maybe Int)
containerMemoryStatsCommitbytesL f ContainerMemoryStats{..} = (\containerMemoryStatsCommitbytes -> ContainerMemoryStats { containerMemoryStatsCommitbytes, ..} ) <$> f containerMemoryStatsCommitbytes
{-# INLINE containerMemoryStatsCommitbytesL #-}

-- | 'containerMemoryStatsCommitpeakbytes' Lens
containerMemoryStatsCommitpeakbytesL :: Lens_' ContainerMemoryStats (Maybe Int)
containerMemoryStatsCommitpeakbytesL f ContainerMemoryStats{..} = (\containerMemoryStatsCommitpeakbytes -> ContainerMemoryStats { containerMemoryStatsCommitpeakbytes, ..} ) <$> f containerMemoryStatsCommitpeakbytes
{-# INLINE containerMemoryStatsCommitpeakbytesL #-}

-- | 'containerMemoryStatsPrivateworkingset' Lens
containerMemoryStatsPrivateworkingsetL :: Lens_' ContainerMemoryStats (Maybe Int)
containerMemoryStatsPrivateworkingsetL f ContainerMemoryStats{..} = (\containerMemoryStatsPrivateworkingset -> ContainerMemoryStats { containerMemoryStatsPrivateworkingset, ..} ) <$> f containerMemoryStatsPrivateworkingset
{-# INLINE containerMemoryStatsPrivateworkingsetL #-}



-- * ContainerNetworkStats

-- | 'containerNetworkStatsRxBytes' Lens
containerNetworkStatsRxBytesL :: Lens_' ContainerNetworkStats (Maybe Int)
containerNetworkStatsRxBytesL f ContainerNetworkStats{..} = (\containerNetworkStatsRxBytes -> ContainerNetworkStats { containerNetworkStatsRxBytes, ..} ) <$> f containerNetworkStatsRxBytes
{-# INLINE containerNetworkStatsRxBytesL #-}

-- | 'containerNetworkStatsRxPackets' Lens
containerNetworkStatsRxPacketsL :: Lens_' ContainerNetworkStats (Maybe Int)
containerNetworkStatsRxPacketsL f ContainerNetworkStats{..} = (\containerNetworkStatsRxPackets -> ContainerNetworkStats { containerNetworkStatsRxPackets, ..} ) <$> f containerNetworkStatsRxPackets
{-# INLINE containerNetworkStatsRxPacketsL #-}

-- | 'containerNetworkStatsRxErrors' Lens
containerNetworkStatsRxErrorsL :: Lens_' ContainerNetworkStats (Maybe Int)
containerNetworkStatsRxErrorsL f ContainerNetworkStats{..} = (\containerNetworkStatsRxErrors -> ContainerNetworkStats { containerNetworkStatsRxErrors, ..} ) <$> f containerNetworkStatsRxErrors
{-# INLINE containerNetworkStatsRxErrorsL #-}

-- | 'containerNetworkStatsRxDropped' Lens
containerNetworkStatsRxDroppedL :: Lens_' ContainerNetworkStats (Maybe Int)
containerNetworkStatsRxDroppedL f ContainerNetworkStats{..} = (\containerNetworkStatsRxDropped -> ContainerNetworkStats { containerNetworkStatsRxDropped, ..} ) <$> f containerNetworkStatsRxDropped
{-# INLINE containerNetworkStatsRxDroppedL #-}

-- | 'containerNetworkStatsTxBytes' Lens
containerNetworkStatsTxBytesL :: Lens_' ContainerNetworkStats (Maybe Int)
containerNetworkStatsTxBytesL f ContainerNetworkStats{..} = (\containerNetworkStatsTxBytes -> ContainerNetworkStats { containerNetworkStatsTxBytes, ..} ) <$> f containerNetworkStatsTxBytes
{-# INLINE containerNetworkStatsTxBytesL #-}

-- | 'containerNetworkStatsTxPackets' Lens
containerNetworkStatsTxPacketsL :: Lens_' ContainerNetworkStats (Maybe Int)
containerNetworkStatsTxPacketsL f ContainerNetworkStats{..} = (\containerNetworkStatsTxPackets -> ContainerNetworkStats { containerNetworkStatsTxPackets, ..} ) <$> f containerNetworkStatsTxPackets
{-# INLINE containerNetworkStatsTxPacketsL #-}

-- | 'containerNetworkStatsTxErrors' Lens
containerNetworkStatsTxErrorsL :: Lens_' ContainerNetworkStats (Maybe Int)
containerNetworkStatsTxErrorsL f ContainerNetworkStats{..} = (\containerNetworkStatsTxErrors -> ContainerNetworkStats { containerNetworkStatsTxErrors, ..} ) <$> f containerNetworkStatsTxErrors
{-# INLINE containerNetworkStatsTxErrorsL #-}

-- | 'containerNetworkStatsTxDropped' Lens
containerNetworkStatsTxDroppedL :: Lens_' ContainerNetworkStats (Maybe Int)
containerNetworkStatsTxDroppedL f ContainerNetworkStats{..} = (\containerNetworkStatsTxDropped -> ContainerNetworkStats { containerNetworkStatsTxDropped, ..} ) <$> f containerNetworkStatsTxDropped
{-# INLINE containerNetworkStatsTxDroppedL #-}

-- | 'containerNetworkStatsEndpointId' Lens
containerNetworkStatsEndpointIdL :: Lens_' ContainerNetworkStats (Maybe Text)
containerNetworkStatsEndpointIdL f ContainerNetworkStats{..} = (\containerNetworkStatsEndpointId -> ContainerNetworkStats { containerNetworkStatsEndpointId, ..} ) <$> f containerNetworkStatsEndpointId
{-# INLINE containerNetworkStatsEndpointIdL #-}

-- | 'containerNetworkStatsInstanceId' Lens
containerNetworkStatsInstanceIdL :: Lens_' ContainerNetworkStats (Maybe Text)
containerNetworkStatsInstanceIdL f ContainerNetworkStats{..} = (\containerNetworkStatsInstanceId -> ContainerNetworkStats { containerNetworkStatsInstanceId, ..} ) <$> f containerNetworkStatsInstanceId
{-# INLINE containerNetworkStatsInstanceIdL #-}



-- * ContainerPidsStats

-- | 'containerPidsStatsCurrent' Lens
containerPidsStatsCurrentL :: Lens_' ContainerPidsStats (Maybe Int)
containerPidsStatsCurrentL f ContainerPidsStats{..} = (\containerPidsStatsCurrent -> ContainerPidsStats { containerPidsStatsCurrent, ..} ) <$> f containerPidsStatsCurrent
{-# INLINE containerPidsStatsCurrentL #-}

-- | 'containerPidsStatsLimit' Lens
containerPidsStatsLimitL :: Lens_' ContainerPidsStats (Maybe Int)
containerPidsStatsLimitL f ContainerPidsStats{..} = (\containerPidsStatsLimit -> ContainerPidsStats { containerPidsStatsLimit, ..} ) <$> f containerPidsStatsLimit
{-# INLINE containerPidsStatsLimitL #-}
...
-- | 'containerStatsResponseId' Lens
containerStatsResponseIdL :: Lens_' ContainerStatsResponse (Maybe Text)
containerStatsResponseIdL f ContainerStatsResponse{..} = (\containerStatsResponseId -> ContainerStatsResponse { containerStatsResponseId, ..} ) <$> f containerStatsResponseId
{-# INLINE containerStatsResponseIdL #-}

-- | 'containerStatsResponseName' Lens
containerStatsResponseNameL :: Lens_' ContainerStatsResponse (Maybe Text)
containerStatsResponseNameL f ContainerStatsResponse{..} = (\containerStatsResponseName -> ContainerStatsResponse { containerStatsResponseName, ..} ) <$> f containerStatsResponseName
{-# INLINE containerStatsResponseNameL #-}

-- | 'containerStatsResponseOsType' Lens
containerStatsResponseOsTypeL :: Lens_' ContainerStatsResponse (Maybe Text)
containerStatsResponseOsTypeL f ContainerStatsResponse{..} = (\containerStatsResponseOsType -> ContainerStatsResponse { containerStatsResponseOsType, ..} ) <$> f containerStatsResponseOsType
{-# INLINE containerStatsResponseOsTypeL #-}

-- | 'containerStatsResponseRead' Lens
containerStatsResponseReadL :: Lens_' ContainerStatsResponse (Maybe DateTime)
containerStatsResponseReadL f ContainerStatsResponse{..} = (\containerStatsResponseRead -> ContainerStatsResponse { containerStatsResponseRead, ..} ) <$> f containerStatsResponseRead
{-# INLINE containerStatsResponseReadL #-}

-- | 'containerStatsResponseCpuStats' Lens
containerStatsResponseCpuStatsL :: Lens_' ContainerStatsResponse (Maybe ContainerCPUStats)
...
containerStatsResponseMemoryStatsL :: Lens_' ContainerStatsResponse (Maybe ContainerMemoryStats)
...
containerStatsResponseNetworksL :: Lens_' ContainerStatsResponse (Maybe A.Value)
...
containerStatsResponsePidsStatsL :: Lens_' ContainerStatsResponse (Maybe ContainerPidsStats)
...
containerStatsResponseBlkioStatsL :: Lens_' ContainerStatsResponse (Maybe ContainerBlkioStats)
...
-- | 'containerStatsResponseNumProcs' Lens
containerStatsResponseNumProcsL :: Lens_' ContainerStatsResponse (Maybe Int)
containerStatsResponseNumProcsL f ContainerStatsResponse{..} = (\containerStatsResponseNumProcs -> ContainerStatsResponse { containerStatsResponseNumProcs, ..} ) <$> f containerStatsResponseNumProcs
{-# INLINE containerStatsResponseNumProcsL #-}

-- | 'containerStatsResponseStorageStats' Lens
containerStatsResponseStorageStatsL :: Lens_' ContainerStatsResponse (Maybe ContainerStorageStats)
containerStatsResponseStorageStatsL f ContainerStatsResponse{..} = (\containerStatsResponseStorageStats -> ContainerStatsResponse { containerStatsResponseStorageStats, ..} ) <$> f containerStatsResponseStorageStats
{-# INLINE containerStatsResponseStorageStatsL #-}

-- | 'containerStatsResponsePreread' Lens
containerStatsResponsePrereadL :: Lens_' ContainerStatsResponse (Maybe DateTime)
containerStatsResponsePrereadL f ContainerStatsResponse{..} = (\containerStatsResponsePreread -> ContainerStatsResponse { containerStatsResponsePreread, ..} ) <$> f containerStatsResponsePreread
{-# INLINE containerStatsResponsePrereadL #-}

-- | 'containerStatsResponsePrecpuStats' Lens
containerStatsResponsePrecpuStatsL :: Lens_' ContainerStatsResponse (Maybe ContainerCPUStats)
...
-- | 'containerStatusContainerId' Lens
containerStatusContainerIdL :: Lens_' ContainerStatus (Maybe Text)
containerStatusContainerIdL f ContainerStatus{..} = (\containerStatusContainerId -> ContainerStatus { containerStatusContainerId, ..} ) <$> f containerStatusContainerId
{-# INLINE containerStatusContainerIdL #-}

-- | 'containerStatusPid' Lens
containerStatusPidL :: Lens_' ContainerStatus (Maybe Int)
containerStatusPidL f ContainerStatus{..} = (\containerStatusPid -> ContainerStatus { containerStatusPid, ..} ) <$> f containerStatusPid
{-# INLINE containerStatusPidL #-}

-- | 'containerStatusExitCode' Lens
containerStatusExitCodeL :: Lens_' ContainerStatus (Maybe Int)
containerStatusExitCodeL f ContainerStatus{..} = (\containerStatusExitCode -> ContainerStatus { containerStatusExitCode, ..} ) <$> f containerStatusExitCode
{-# INLINE containerStatusExitCodeL #-}



-- * ContainerStorageStats

-- | 'containerStorageStatsReadCountNormalized' Lens
containerStorageStatsReadCountNormalizedL :: Lens_' ContainerStorageStats (Maybe Int)
containerStorageStatsReadCountNormalizedL f ContainerStorageStats{..} = (\containerStorageStatsReadCountNormalized -> ContainerStorageStats { containerStorageStatsReadCountNormalized, ..} ) <$> f containerStorageStatsReadCountNormalized
{-# INLINE containerStorageStatsReadCountNormalizedL #-}

-- | 'containerStorageStatsReadSizeBytes' Lens
containerStorageStatsReadSizeBytesL :: Lens_' ContainerStorageStats (Maybe Int)
containerStorageStatsReadSizeBytesL f ContainerStorageStats{..} = (\containerStorageStatsReadSizeBytes -> ContainerStorageStats { containerStorageStatsReadSizeBytes, ..} ) <$> f containerStorageStatsReadSizeBytes
{-# INLINE containerStorageStatsReadSizeBytesL #-}

-- | 'containerStorageStatsWriteCountNormalized' Lens
containerStorageStatsWriteCountNormalizedL :: Lens_' ContainerStorageStats (Maybe Int)
containerStorageStatsWriteCountNormalizedL f ContainerStorageStats{..} = (\containerStorageStatsWriteCountNormalized -> ContainerStorageStats { containerStorageStatsWriteCountNormalized, ..} ) <$> f containerStorageStatsWriteCountNormalized
{-# INLINE containerStorageStatsWriteCountNormalizedL #-}

-- | 'containerStorageStatsWriteSizeBytes' Lens
containerStorageStatsWriteSizeBytesL :: Lens_' ContainerStorageStats (Maybe Int)
containerStorageStatsWriteSizeBytesL f ContainerStorageStats{..} = (\containerStorageStatsWriteSizeBytes -> ContainerStorageStats { containerStorageStatsWriteSizeBytes, ..} ) <$> f containerStorageStatsWriteSizeBytes
{-# INLINE containerStorageStatsWriteSizeBytesL #-}
...
-- | 'containerSummaryImageManifestDescriptor' Lens
containerSummaryImageManifestDescriptorL :: Lens_' ContainerSummary (Maybe OCIDescriptor)
containerSummaryImageManifestDescriptorL f ContainerSummary{..} = (\containerSummaryImageManifestDescriptor -> ContainerSummary { containerSummaryImageManifestDescriptor, ..} ) <$> f containerSummaryImageManifestDescriptor
{-# INLINE containerSummaryImageManifestDescriptorL #-}
...
containerSummaryPortsL :: Lens_' ContainerSummary (Maybe [PortSummary])
...
containerSummaryStateL :: Lens_' ContainerSummary (Maybe E'State)
...
-- | 'containerSummaryHealth' Lens
containerSummaryHealthL :: Lens_' ContainerSummary (Maybe ContainerSummaryHealth)
containerSummaryHealthL f ContainerSummary{..} = (\containerSummaryHealth -> ContainerSummary { containerSummaryHealth, ..} ) <$> f containerSummaryHealth
{-# INLINE containerSummaryHealthL #-}



-- * ContainerSummaryHealth

-- | 'containerSummaryHealthStatus' Lens
containerSummaryHealthStatusL :: Lens_' ContainerSummaryHealth (Maybe E'Status)
containerSummaryHealthStatusL f ContainerSummaryHealth{..} = (\containerSummaryHealthStatus -> ContainerSummaryHealth { containerSummaryHealthStatus, ..} ) <$> f containerSummaryHealthStatus
{-# INLINE containerSummaryHealthStatusL #-}

-- | 'containerSummaryHealthFailingStreak' Lens
containerSummaryHealthFailingStreakL :: Lens_' ContainerSummaryHealth (Maybe Int)
containerSummaryHealthFailingStreakL f ContainerSummaryHealth{..} = (\containerSummaryHealthFailingStreak -> ContainerSummaryHealth { containerSummaryHealthFailingStreak, ..} ) <$> f containerSummaryHealthFailingStreak
{-# INLINE containerSummaryHealthFailingStreakL #-}
...
-- | 'containerSummaryHostConfigAnnotations' Lens
containerSummaryHostConfigAnnotationsL :: Lens_' ContainerSummaryHostConfig (Maybe (Map.Map String Text))
containerSummaryHostConfigAnnotationsL f ContainerSummaryHostConfig{..} = (\containerSummaryHostConfigAnnotations -> ContainerSummaryHostConfig { containerSummaryHostConfigAnnotations, ..} ) <$> f containerSummaryHostConfigAnnotations
{-# INLINE containerSummaryHostConfigAnnotationsL #-}
...
-- | 'containerThrottlingDataPeriods' Lens
containerThrottlingDataPeriodsL :: Lens_' ContainerThrottlingData (Maybe Int)
containerThrottlingDataPeriodsL f ContainerThrottlingData{..} = (\containerThrottlingDataPeriods -> ContainerThrottlingData { containerThrottlingDataPeriods, ..} ) <$> f containerThrottlingDataPeriods
{-# INLINE containerThrottlingDataPeriodsL #-}

-- | 'containerThrottlingDataThrottledPeriods' Lens
containerThrottlingDataThrottledPeriodsL :: Lens_' ContainerThrottlingData (Maybe Int)
containerThrottlingDataThrottledPeriodsL f ContainerThrottlingData{..} = (\containerThrottlingDataThrottledPeriods -> ContainerThrottlingData { containerThrottlingDataThrottledPeriods, ..} ) <$> f containerThrottlingDataThrottledPeriods
{-# INLINE containerThrottlingDataThrottledPeriodsL #-}

-- | 'containerThrottlingDataThrottledTime' Lens
containerThrottlingDataThrottledTimeL :: Lens_' ContainerThrottlingData (Maybe Int)
containerThrottlingDataThrottledTimeL f ContainerThrottlingData{..} = (\containerThrottlingDataThrottledTime -> ContainerThrottlingData { containerThrottlingDataThrottledTime, ..} ) <$> f containerThrottlingDataThrottledTime
{-# INLINE containerThrottlingDataThrottledTimeL #-}
...
-- | 'containerUpdateRequestDeviceRequests' Lens
containerUpdateRequestDeviceRequestsL :: Lens_' ContainerUpdateRequest (Maybe [DeviceRequest])
containerUpdateRequestDeviceRequestsL f ContainerUpdateRequest{..} = (\containerUpdateRequestDeviceRequests -> ContainerUpdateRequest { containerUpdateRequestDeviceRequests, ..} ) <$> f containerUpdateRequestDeviceRequests
{-# INLINE containerUpdateRequestDeviceRequestsL #-}
...
containerWaitResponseStatusCodeL :: Lens_' ContainerWaitResponse (Integer)
...
containerWaitResponseErrorL :: Lens_' ContainerWaitResponse (Maybe ContainerWaitExitError)
...
-- | 'containerdInfoAddress' Lens
containerdInfoAddressL :: Lens_' ContainerdInfo (Maybe Text)
containerdInfoAddressL f ContainerdInfo{..} = (\containerdInfoAddress -> ContainerdInfo { containerdInfoAddress, ..} ) <$> f containerdInfoAddress
{-# INLINE containerdInfoAddressL #-}

-- | 'containerdInfoNamespaces' Lens
containerdInfoNamespacesL :: Lens_' ContainerdInfo (Maybe ContainerdInfoNamespaces)
containerdInfoNamespacesL f ContainerdInfo{..} = (\containerdInfoNamespaces -> ContainerdInfo { containerdInfoNamespaces, ..} ) <$> f containerdInfoNamespaces
{-# INLINE containerdInfoNamespacesL #-}



-- * ContainerdInfoNamespaces

-- | 'containerdInfoNamespacesContainers' Lens
containerdInfoNamespacesContainersL :: Lens_' ContainerdInfoNamespaces (Maybe Text)
containerdInfoNamespacesContainersL f ContainerdInfoNamespaces{..} = (\containerdInfoNamespacesContainers -> ContainerdInfoNamespaces { containerdInfoNamespacesContainers, ..} ) <$> f containerdInfoNamespacesContainers
{-# INLINE containerdInfoNamespacesContainersL #-}

-- | 'containerdInfoNamespacesPlugins' Lens
containerdInfoNamespacesPluginsL :: Lens_' ContainerdInfoNamespaces (Maybe Text)
containerdInfoNamespacesPluginsL f ContainerdInfoNamespaces{..} = (\containerdInfoNamespacesPlugins -> ContainerdInfoNamespaces { containerdInfoNamespacesPlugins, ..} ) <$> f containerdInfoNamespacesPlugins
{-# INLINE containerdInfoNamespacesPluginsL #-}



-- * ContainersDiskUsage

-- | 'containersDiskUsageActiveCount' Lens
containersDiskUsageActiveCountL :: Lens_' ContainersDiskUsage (Maybe Integer)
containersDiskUsageActiveCountL f ContainersDiskUsage{..} = (\containersDiskUsageActiveCount -> ContainersDiskUsage { containersDiskUsageActiveCount, ..} ) <$> f containersDiskUsageActiveCount
{-# INLINE containersDiskUsageActiveCountL #-}

-- | 'containersDiskUsageTotalCount' Lens
containersDiskUsageTotalCountL :: Lens_' ContainersDiskUsage (Maybe Integer)
containersDiskUsageTotalCountL f ContainersDiskUsage{..} = (\containersDiskUsageTotalCount -> ContainersDiskUsage { containersDiskUsageTotalCount, ..} ) <$> f containersDiskUsageTotalCount
{-# INLINE containersDiskUsageTotalCountL #-}

-- | 'containersDiskUsageReclaimable' Lens
containersDiskUsageReclaimableL :: Lens_' ContainersDiskUsage (Maybe Integer)
containersDiskUsageReclaimableL f ContainersDiskUsage{..} = (\containersDiskUsageReclaimable -> ContainersDiskUsage { containersDiskUsageReclaimable, ..} ) <$> f containersDiskUsageReclaimable
{-# INLINE containersDiskUsageReclaimableL #-}

-- | 'containersDiskUsageTotalSize' Lens
containersDiskUsageTotalSizeL :: Lens_' ContainersDiskUsage (Maybe Integer)
containersDiskUsageTotalSizeL f ContainersDiskUsage{..} = (\containersDiskUsageTotalSize -> ContainersDiskUsage { containersDiskUsageTotalSize, ..} ) <$> f containersDiskUsageTotalSize
{-# INLINE containersDiskUsageTotalSizeL #-}

-- | 'containersDiskUsageItems' Lens
containersDiskUsageItemsL :: Lens_' ContainersDiskUsage (Maybe [A.Value])
containersDiskUsageItemsL f ContainersDiskUsage{..} = (\containersDiskUsageItems -> ContainersDiskUsage { containersDiskUsageItems, ..} ) <$> f containersDiskUsageItems
{-# INLINE containersDiskUsageItemsL #-}
...
-- | 'createImageInfoErrorDetail' Lens
createImageInfoErrorDetailL :: Lens_' CreateImageInfo (Maybe ErrorDetail)
createImageInfoErrorDetailL f CreateImageInfo{..} = (\createImageInfoErrorDetail -> CreateImageInfo { createImageInfoErrorDetail, ..} ) <$> f createImageInfoErrorDetail
{-# INLINE createImageInfoErrorDetailL #-}
...
-- | 'deviceInfoSource' Lens
deviceInfoSourceL :: Lens_' DeviceInfo (Maybe Text)
deviceInfoSourceL f DeviceInfo{..} = (\deviceInfoSource -> DeviceInfo { deviceInfoSource, ..} ) <$> f deviceInfoSource
{-# INLINE deviceInfoSourceL #-}

-- | 'deviceInfoId' Lens
deviceInfoIdL :: Lens_' DeviceInfo (Maybe Text)
deviceInfoIdL f DeviceInfo{..} = (\deviceInfoId -> DeviceInfo { deviceInfoId, ..} ) <$> f deviceInfoId
{-# INLINE deviceInfoIdL #-}
...
-- | 'driverDataName' Lens
driverDataNameL :: Lens_' DriverData (Text)
driverDataNameL f DriverData{..} = (\driverDataName -> DriverData { driverDataName, ..} ) <$> f driverDataName
{-# INLINE driverDataNameL #-}

-- | 'driverDataData' Lens
driverDataDataL :: Lens_' DriverData ((Map.Map String Text))
driverDataDataL f DriverData{..} = (\driverDataData -> DriverData { driverDataData, ..} ) <$> f driverDataData
{-# INLINE driverDataDataL #-}
...
-- | 'endpointResourceName' Lens
endpointResourceNameL :: Lens_' EndpointResource (Maybe Text)
endpointResourceNameL f EndpointResource{..} = (\endpointResourceName -> EndpointResource { endpointResourceName, ..} ) <$> f endpointResourceName
{-# INLINE endpointResourceNameL #-}

-- | 'endpointResourceEndpointId' Lens
endpointResourceEndpointIdL :: Lens_' EndpointResource (Maybe Text)
endpointResourceEndpointIdL f EndpointResource{..} = (\endpointResourceEndpointId -> EndpointResource { endpointResourceEndpointId, ..} ) <$> f endpointResourceEndpointId
{-# INLINE endpointResourceEndpointIdL #-}

-- | 'endpointResourceMacAddress' Lens
endpointResourceMacAddressL :: Lens_' EndpointResource (Maybe Text)
endpointResourceMacAddressL f EndpointResource{..} = (\endpointResourceMacAddress -> EndpointResource { endpointResourceMacAddress, ..} ) <$> f endpointResourceMacAddress
{-# INLINE endpointResourceMacAddressL #-}

-- | 'endpointResourceIpv4Address' Lens
endpointResourceIpv4AddressL :: Lens_' EndpointResource (Maybe Text)
endpointResourceIpv4AddressL f EndpointResource{..} = (\endpointResourceIpv4Address -> EndpointResource { endpointResourceIpv4Address, ..} ) <$> f endpointResourceIpv4Address
{-# INLINE endpointResourceIpv4AddressL #-}

-- | 'endpointResourceIpv6Address' Lens
endpointResourceIpv6AddressL :: Lens_' EndpointResource (Maybe Text)
endpointResourceIpv6AddressL f EndpointResource{..} = (\endpointResourceIpv6Address -> EndpointResource { endpointResourceIpv6Address, ..} ) <$> f endpointResourceIpv6Address
{-# INLINE endpointResourceIpv6AddressL #-}
...
-- | 'endpointSettingsGwPriority' Lens
endpointSettingsGwPriorityL :: Lens_' EndpointSettings (Maybe Integer)
endpointSettingsGwPriorityL f EndpointSettings{..} = (\endpointSettingsGwPriority -> EndpointSettings { endpointSettingsGwPriority, ..} ) <$> f endpointSettingsGwPriority
{-# INLINE endpointSettingsGwPriorityL #-}
...
-- | 'endpointSettingsDnsNames' Lens
endpointSettingsDnsNamesL :: Lens_' EndpointSettings (Maybe [Text])
endpointSettingsDnsNamesL f EndpointSettings{..} = (\endpointSettingsDnsNames -> EndpointSettings { endpointSettingsDnsNames, ..} ) <$> f endpointSettingsDnsNames
{-# INLINE endpointSettingsDnsNamesL #-}
...
eventMessageTypeL :: Lens_' EventMessage (Maybe E'Type4)
...
-- | 'execConfigConsoleSize' Lens
execConfigConsoleSizeL :: Lens_' ExecConfig (Maybe [Int])
execConfigConsoleSizeL f ExecConfig{..} = (\execConfigConsoleSize -> ExecConfig { execConfigConsoleSize, ..} ) <$> f execConfigConsoleSize
{-# INLINE execConfigConsoleSizeL #-}
...
-- | 'execStartConfigConsoleSize' Lens
execStartConfigConsoleSizeL :: Lens_' ExecStartConfig (Maybe [Int])
execStartConfigConsoleSizeL f ExecStartConfig{..} = (\execStartConfigConsoleSize -> ExecStartConfig { execStartConfigConsoleSize, ..} ) <$> f execStartConfigConsoleSize
{-# INLINE execStartConfigConsoleSizeL #-}



-- * FilesystemChange

-- | 'filesystemChangePath' Lens
filesystemChangePathL :: Lens_' FilesystemChange (Text)
filesystemChangePathL f FilesystemChange{..} = (\filesystemChangePath -> FilesystemChange { filesystemChangePath, ..} ) <$> f filesystemChangePath
{-# INLINE filesystemChangePathL #-}

-- | 'filesystemChangeKind' Lens
filesystemChangeKindL :: Lens_' FilesystemChange (ChangeType)
filesystemChangeKindL f FilesystemChange{..} = (\filesystemChangeKind -> FilesystemChange { filesystemChangeKind, ..} ) <$> f filesystemChangeKind
{-# INLINE filesystemChangeKindL #-}



-- * FirewallInfo

-- | 'firewallInfoDriver' Lens
firewallInfoDriverL :: Lens_' FirewallInfo (Maybe Text)
firewallInfoDriverL f FirewallInfo{..} = (\firewallInfoDriver -> FirewallInfo { firewallInfoDriver, ..} ) <$> f firewallInfoDriver
{-# INLINE firewallInfoDriverL #-}

-- | 'firewallInfoInfo' Lens
firewallInfoInfoL :: Lens_' FirewallInfo (Maybe [[Text]])
firewallInfoInfoL f FirewallInfo{..} = (\firewallInfoInfo -> FirewallInfo { firewallInfoInfo, ..} ) <$> f firewallInfoInfo
{-# INLINE firewallInfoInfoL #-}
...
graphDriverDataDataL :: Lens_' GraphDriverData (Maybe A.Value)
...
healthConfigIntervalL :: Lens_' HealthConfig (Maybe Integer)
...
healthConfigTimeoutL :: Lens_' HealthConfig (Maybe Integer)
...
healthConfigStartPeriodL :: Lens_' HealthConfig (Maybe Integer)
...
-- | 'healthConfigStartInterval' Lens
healthConfigStartIntervalL :: Lens_' HealthConfig (Maybe Integer)
healthConfigStartIntervalL f HealthConfig{..} = (\healthConfigStartInterval -> HealthConfig { healthConfigStartInterval, ..} ) <$> f healthConfigStartInterval
{-# INLINE healthConfigStartIntervalL #-}
...
-- | 'hostConfigAnnotations' Lens
hostConfigAnnotationsL :: Lens_' HostConfig (Maybe (Map.Map String Text))
hostConfigAnnotationsL f HostConfig{..} = (\hostConfigAnnotations -> HostConfig { hostConfigAnnotations, ..} ) <$> f hostConfigAnnotations
{-# INLINE hostConfigAnnotationsL #-}
...
hostConfigShmSizeL :: Lens_' HostConfig (Maybe Integer)
...
hostConfigAllOfLogConfigTypeL :: Lens_' HostConfigAllOfLogConfig (Maybe E'Type5)
...
-- | 'iPAMStatusSubnets' Lens
iPAMStatusSubnetsL :: Lens_' IPAMStatus (Maybe (Map.Map String SubnetStatus))
iPAMStatusSubnetsL f IPAMStatus{..} = (\iPAMStatusSubnets -> IPAMStatus { iPAMStatusSubnets, ..} ) <$> f iPAMStatusSubnets
{-# INLINE iPAMStatusSubnetsL #-}



-- * ImageConfig

-- | 'imageConfigUser' Lens
imageConfigUserL :: Lens_' ImageConfig (Maybe Text)
imageConfigUserL f ImageConfig{..} = (\imageConfigUser -> ImageConfig { imageConfigUser, ..} ) <$> f imageConfigUser
{-# INLINE imageConfigUserL #-}

-- | 'imageConfigExposedPorts' Lens
imageConfigExposedPortsL :: Lens_' ImageConfig (Maybe (Map.Map String A.Value))
imageConfigExposedPortsL f ImageConfig{..} = (\imageConfigExposedPorts -> ImageConfig { imageConfigExposedPorts, ..} ) <$> f imageConfigExposedPorts
{-# INLINE imageConfigExposedPortsL #-}

-- | 'imageConfigEnv' Lens
imageConfigEnvL :: Lens_' ImageConfig (Maybe [Text])
imageConfigEnvL f ImageConfig{..} = (\imageConfigEnv -> ImageConfig { imageConfigEnv, ..} ) <$> f imageConfigEnv
{-# INLINE imageConfigEnvL #-}

-- | 'imageConfigCmd' Lens
imageConfigCmdL :: Lens_' ImageConfig (Maybe [Text])
imageConfigCmdL f ImageConfig{..} = (\imageConfigCmd -> ImageConfig { imageConfigCmd, ..} ) <$> f imageConfigCmd
{-# INLINE imageConfigCmdL #-}

-- | 'imageConfigHealthcheck' Lens
imageConfigHealthcheckL :: Lens_' ImageConfig (Maybe HealthConfig)
imageConfigHealthcheckL f ImageConfig{..} = (\imageConfigHealthcheck -> ImageConfig { imageConfigHealthcheck, ..} ) <$> f imageConfigHealthcheck
{-# INLINE imageConfigHealthcheckL #-}

-- | 'imageConfigArgsEscaped' Lens
imageConfigArgsEscapedL :: Lens_' ImageConfig (Maybe Bool)
imageConfigArgsEscapedL f ImageConfig{..} = (\imageConfigArgsEscaped -> ImageConfig { imageConfigArgsEscaped, ..} ) <$> f imageConfigArgsEscaped
{-# INLINE imageConfigArgsEscapedL #-}

-- | 'imageConfigVolumes' Lens
imageConfigVolumesL :: Lens_' ImageConfig (Maybe (Map.Map String A.Value))
imageConfigVolumesL f ImageConfig{..} = (\imageConfigVolumes -> ImageConfig { imageConfigVolumes, ..} ) <$> f imageConfigVolumes
{-# INLINE imageConfigVolumesL #-}

-- | 'imageConfigWorkingDir' Lens
imageConfigWorkingDirL :: Lens_' ImageConfig (Maybe Text)
imageConfigWorkingDirL f ImageConfig{..} = (\imageConfigWorkingDir -> ImageConfig { imageConfigWorkingDir, ..} ) <$> f imageConfigWorkingDir
{-# INLINE imageConfigWorkingDirL #-}

-- | 'imageConfigEntrypoint' Lens
imageConfigEntrypointL :: Lens_' ImageConfig (Maybe [Text])
imageConfigEntrypointL f ImageConfig{..} = (\imageConfigEntrypoint -> ImageConfig { imageConfigEntrypoint, ..} ) <$> f imageConfigEntrypoint
{-# INLINE imageConfigEntrypointL #-}

-- | 'imageConfigOnBuild' Lens
imageConfigOnBuildL :: Lens_' ImageConfig (Maybe [Text])
imageConfigOnBuildL f ImageConfig{..} = (\imageConfigOnBuild -> ImageConfig { imageConfigOnBuild, ..} ) <$> f imageConfigOnBuild
{-# INLINE imageConfigOnBuildL #-}

-- | 'imageConfigLabels' Lens
imageConfigLabelsL :: Lens_' ImageConfig (Maybe (Map.Map String Text))
imageConfigLabelsL f ImageConfig{..} = (\imageConfigLabels -> ImageConfig { imageConfigLabels, ..} ) <$> f imageConfigLabels
{-# INLINE imageConfigLabelsL #-}

-- | 'imageConfigStopSignal' Lens
imageConfigStopSignalL :: Lens_' ImageConfig (Maybe Text)
imageConfigStopSignalL f ImageConfig{..} = (\imageConfigStopSignal -> ImageConfig { imageConfigStopSignal, ..} ) <$> f imageConfigStopSignal
{-# INLINE imageConfigStopSignalL #-}

-- | 'imageConfigShell' Lens
imageConfigShellL :: Lens_' ImageConfig (Maybe [Text])
imageConfigShellL f ImageConfig{..} = (\imageConfigShell -> ImageConfig { imageConfigShell, ..} ) <$> f imageConfigShell
{-# INLINE imageConfigShellL #-}
...
-- | 'imageInspectDescriptor' Lens
imageInspectDescriptorL :: Lens_' ImageInspect (Maybe OCIDescriptor)
imageInspectDescriptorL f ImageInspect{..} = (\imageInspectDescriptor -> ImageInspect { imageInspectDescriptor, ..} ) <$> f imageInspectDescriptor
{-# INLINE imageInspectDescriptorL #-}

-- | 'imageInspectManifests' Lens
imageInspectManifestsL :: Lens_' ImageInspect (Maybe [ImageManifestSummary])
imageInspectManifestsL f ImageInspect{..} = (\imageInspectManifests -> ImageInspect { imageInspectManifests, ..} ) <$> f imageInspectManifests
{-# INLINE imageInspectManifestsL #-}
...
imageInspectConfigL :: Lens_' ImageInspect (Maybe ImageConfig)
...
imageInspectGraphDriverL :: Lens_' ImageInspect (Maybe DriverData)
...
-- | 'imageManifestSummaryId' Lens
imageManifestSummaryIdL :: Lens_' ImageManifestSummary (Text)
imageManifestSummaryIdL f ImageManifestSummary{..} = (\imageManifestSummaryId -> ImageManifestSummary { imageManifestSummaryId, ..} ) <$> f imageManifestSummaryId
{-# INLINE imageManifestSummaryIdL #-}

-- | 'imageManifestSummaryDescriptor' Lens
imageManifestSummaryDescriptorL :: Lens_' ImageManifestSummary (OCIDescriptor)
imageManifestSummaryDescriptorL f ImageManifestSummary{..} = (\imageManifestSummaryDescriptor -> ImageManifestSummary { imageManifestSummaryDescriptor, ..} ) <$> f imageManifestSummaryDescriptor
{-# INLINE imageManifestSummaryDescriptorL #-}

-- | 'imageManifestSummaryAvailable' Lens
imageManifestSummaryAvailableL :: Lens_' ImageManifestSummary (Bool)
imageManifestSummaryAvailableL f ImageManifestSummary{..} = (\imageManifestSummaryAvailable -> ImageManifestSummary { imageManifestSummaryAvailable, ..} ) <$> f imageManifestSummaryAvailable
{-# INLINE imageManifestSummaryAvailableL #-}

-- | 'imageManifestSummarySize' Lens
imageManifestSummarySizeL :: Lens_' ImageManifestSummary (ImageManifestSummarySize)
imageManifestSummarySizeL f ImageManifestSummary{..} = (\imageManifestSummarySize -> ImageManifestSummary { imageManifestSummarySize, ..} ) <$> f imageManifestSummarySize
{-# INLINE imageManifestSummarySizeL #-}

-- | 'imageManifestSummaryKind' Lens
imageManifestSummaryKindL :: Lens_' ImageManifestSummary (E'Kind)
imageManifestSummaryKindL f ImageManifestSummary{..} = (\imageManifestSummaryKind -> ImageManifestSummary { imageManifestSummaryKind, ..} ) <$> f imageManifestSummaryKind
{-# INLINE imageManifestSummaryKindL #-}

-- | 'imageManifestSummaryImageData' Lens
imageManifestSummaryImageDataL :: Lens_' ImageManifestSummary (Maybe ImageManifestSummaryImageData)
imageManifestSummaryImageDataL f ImageManifestSummary{..} = (\imageManifestSummaryImageData -> ImageManifestSummary { imageManifestSummaryImageData, ..} ) <$> f imageManifestSummaryImageData
{-# INLINE imageManifestSummaryImageDataL #-}

-- | 'imageManifestSummaryAttestationData' Lens
imageManifestSummaryAttestationDataL :: Lens_' ImageManifestSummary (Maybe ImageManifestSummaryAttestationData)
imageManifestSummaryAttestationDataL f ImageManifestSummary{..} = (\imageManifestSummaryAttestationData -> ImageManifestSummary { imageManifestSummaryAttestationData, ..} ) <$> f imageManifestSummaryAttestationData
{-# INLINE imageManifestSummaryAttestationDataL #-}



-- * ImageManifestSummaryAttestationData

-- | 'imageManifestSummaryAttestationDataFor' Lens
imageManifestSummaryAttestationDataForL :: Lens_' ImageManifestSummaryAttestationData (Text)
imageManifestSummaryAttestationDataForL f ImageManifestSummaryAttestationData{..} = (\imageManifestSummaryAttestationDataFor -> ImageManifestSummaryAttestationData { imageManifestSummaryAttestationDataFor, ..} ) <$> f imageManifestSummaryAttestationDataFor
{-# INLINE imageManifestSummaryAttestationDataForL #-}



-- * ImageManifestSummaryImageData

-- | 'imageManifestSummaryImageDataPlatform' Lens
imageManifestSummaryImageDataPlatformL :: Lens_' ImageManifestSummaryImageData (OCIPlatform)
imageManifestSummaryImageDataPlatformL f ImageManifestSummaryImageData{..} = (\imageManifestSummaryImageDataPlatform -> ImageManifestSummaryImageData { imageManifestSummaryImageDataPlatform, ..} ) <$> f imageManifestSummaryImageDataPlatform
{-# INLINE imageManifestSummaryImageDataPlatformL #-}

-- | 'imageManifestSummaryImageDataContainers' Lens
imageManifestSummaryImageDataContainersL :: Lens_' ImageManifestSummaryImageData ([Text])
imageManifestSummaryImageDataContainersL f ImageManifestSummaryImageData{..} = (\imageManifestSummaryImageDataContainers -> ImageManifestSummaryImageData { imageManifestSummaryImageDataContainers, ..} ) <$> f imageManifestSummaryImageDataContainers
{-# INLINE imageManifestSummaryImageDataContainersL #-}

-- | 'imageManifestSummaryImageDataSize' Lens
imageManifestSummaryImageDataSizeL :: Lens_' ImageManifestSummaryImageData (ImageManifestSummaryImageDataSize)
imageManifestSummaryImageDataSizeL f ImageManifestSummaryImageData{..} = (\imageManifestSummaryImageDataSize -> ImageManifestSummaryImageData { imageManifestSummaryImageDataSize, ..} ) <$> f imageManifestSummaryImageDataSize
{-# INLINE imageManifestSummaryImageDataSizeL #-}



-- * ImageManifestSummaryImageDataSize

-- | 'imageManifestSummaryImageDataSizeUnpacked' Lens
imageManifestSummaryImageDataSizeUnpackedL :: Lens_' ImageManifestSummaryImageDataSize (Integer)
imageManifestSummaryImageDataSizeUnpackedL f ImageManifestSummaryImageDataSize{..} = (\imageManifestSummaryImageDataSizeUnpacked -> ImageManifestSummaryImageDataSize { imageManifestSummaryImageDataSizeUnpacked, ..} ) <$> f imageManifestSummaryImageDataSizeUnpacked
{-# INLINE imageManifestSummaryImageDataSizeUnpackedL #-}



-- * ImageManifestSummarySize

-- | 'imageManifestSummarySizeTotal' Lens
imageManifestSummarySizeTotalL :: Lens_' ImageManifestSummarySize (Integer)
imageManifestSummarySizeTotalL f ImageManifestSummarySize{..} = (\imageManifestSummarySizeTotal -> ImageManifestSummarySize { imageManifestSummarySizeTotal, ..} ) <$> f imageManifestSummarySizeTotal
{-# INLINE imageManifestSummarySizeTotalL #-}

-- | 'imageManifestSummarySizeContent' Lens
imageManifestSummarySizeContentL :: Lens_' ImageManifestSummarySize (Integer)
imageManifestSummarySizeContentL f ImageManifestSummarySize{..} = (\imageManifestSummarySizeContent -> ImageManifestSummarySize { imageManifestSummarySizeContent, ..} ) <$> f imageManifestSummarySizeContent
{-# INLINE imageManifestSummarySizeContentL #-}
...
imageSummarySizeL :: Lens_' ImageSummary (Integer)
...
imageSummarySharedSizeL :: Lens_' ImageSummary (Integer)
...
-- | 'imageSummaryManifests' Lens
imageSummaryManifestsL :: Lens_' ImageSummary (Maybe [ImageManifestSummary])
imageSummaryManifestsL f ImageSummary{..} = (\imageSummaryManifests -> ImageSummary { imageSummaryManifests, ..} ) <$> f imageSummaryManifests
{-# INLINE imageSummaryManifestsL #-}

-- | 'imageSummaryDescriptor' Lens
imageSummaryDescriptorL :: Lens_' ImageSummary (Maybe OCIDescriptor)
imageSummaryDescriptorL f ImageSummary{..} = (\imageSummaryDescriptor -> ImageSummary { imageSummaryDescriptor, ..} ) <$> f imageSummaryDescriptor
{-# INLINE imageSummaryDescriptorL #-}



-- * ImagesDiskUsage

-- | 'imagesDiskUsageActiveCount' Lens
imagesDiskUsageActiveCountL :: Lens_' ImagesDiskUsage (Maybe Integer)
imagesDiskUsageActiveCountL f ImagesDiskUsage{..} = (\imagesDiskUsageActiveCount -> ImagesDiskUsage { imagesDiskUsageActiveCount, ..} ) <$> f imagesDiskUsageActiveCount
{-# INLINE imagesDiskUsageActiveCountL #-}

-- | 'imagesDiskUsageTotalCount' Lens
imagesDiskUsageTotalCountL :: Lens_' ImagesDiskUsage (Maybe Integer)
imagesDiskUsageTotalCountL f ImagesDiskUsage{..} = (\imagesDiskUsageTotalCount -> ImagesDiskUsage { imagesDiskUsageTotalCount, ..} ) <$> f imagesDiskUsageTotalCount
{-# INLINE imagesDiskUsageTotalCountL #-}

-- | 'imagesDiskUsageReclaimable' Lens
imagesDiskUsageReclaimableL :: Lens_' ImagesDiskUsage (Maybe Integer)
imagesDiskUsageReclaimableL f ImagesDiskUsage{..} = (\imagesDiskUsageReclaimable -> ImagesDiskUsage { imagesDiskUsageReclaimable, ..} ) <$> f imagesDiskUsageReclaimable
{-# INLINE imagesDiskUsageReclaimableL #-}

-- | 'imagesDiskUsageTotalSize' Lens
imagesDiskUsageTotalSizeL :: Lens_' ImagesDiskUsage (Maybe Integer)
imagesDiskUsageTotalSizeL f ImagesDiskUsage{..} = (\imagesDiskUsageTotalSize -> ImagesDiskUsage { imagesDiskUsageTotalSize, ..} ) <$> f imagesDiskUsageTotalSize
{-# INLINE imagesDiskUsageTotalSizeL #-}

-- | 'imagesDiskUsageItems' Lens
imagesDiskUsageItemsL :: Lens_' ImagesDiskUsage (Maybe [A.Value])
imagesDiskUsageItemsL f ImagesDiskUsage{..} = (\imagesDiskUsageItems -> ImagesDiskUsage { imagesDiskUsageItems, ..} ) <$> f imagesDiskUsageItems
{-# INLINE imagesDiskUsageItemsL #-}
...
-- | 'mountImageOptions' Lens
mountImageOptionsL :: Lens_' Mount (Maybe MountImageOptions)
mountImageOptionsL f Mount{..} = (\mountImageOptions -> Mount { mountImageOptions, ..} ) <$> f mountImageOptions
{-# INLINE mountImageOptionsL #-}
...
-- | 'mountBindOptionsCreateMountpoint' Lens
mountBindOptionsCreateMountpointL :: Lens_' MountBindOptions (Maybe Bool)
mountBindOptionsCreateMountpointL f MountBindOptions{..} = (\mountBindOptionsCreateMountpoint -> MountBindOptions { mountBindOptionsCreateMountpoint, ..} ) <$> f mountBindOptionsCreateMountpoint
{-# INLINE mountBindOptionsCreateMountpointL #-}

-- | 'mountBindOptionsReadOnlyNonRecursive' Lens
mountBindOptionsReadOnlyNonRecursiveL :: Lens_' MountBindOptions (Maybe Bool)
mountBindOptionsReadOnlyNonRecursiveL f MountBindOptions{..} = (\mountBindOptionsReadOnlyNonRecursive -> MountBindOptions { mountBindOptionsReadOnlyNonRecursive, ..} ) <$> f mountBindOptionsReadOnlyNonRecursive
{-# INLINE mountBindOptionsReadOnlyNonRecursiveL #-}

-- | 'mountBindOptionsReadOnlyForceRecursive' Lens
mountBindOptionsReadOnlyForceRecursiveL :: Lens_' MountBindOptions (Maybe Bool)
mountBindOptionsReadOnlyForceRecursiveL f MountBindOptions{..} = (\mountBindOptionsReadOnlyForceRecursive -> MountBindOptions { mountBindOptionsReadOnlyForceRecursive, ..} ) <$> f mountBindOptionsReadOnlyForceRecursive
{-# INLINE mountBindOptionsReadOnlyForceRecursiveL #-}



-- * MountImageOptions

-- | 'mountImageOptionsSubpath' Lens
mountImageOptionsSubpathL :: Lens_' MountImageOptions (Maybe Text)
mountImageOptionsSubpathL f MountImageOptions{..} = (\mountImageOptionsSubpath -> MountImageOptions { mountImageOptionsSubpath, ..} ) <$> f mountImageOptionsSubpath
{-# INLINE mountImageOptionsSubpathL #-}
...
-- | 'mountTmpfsOptionsOptions' Lens
mountTmpfsOptionsOptionsL :: Lens_' MountTmpfsOptions (Maybe [[Text]])
mountTmpfsOptionsOptionsL f MountTmpfsOptions{..} = (\mountTmpfsOptionsOptions -> MountTmpfsOptions { mountTmpfsOptionsOptions, ..} ) <$> f mountTmpfsOptionsOptions
{-# INLINE mountTmpfsOptionsOptionsL #-}
...
-- | 'mountVolumeOptionsSubpath' Lens
mountVolumeOptionsSubpathL :: Lens_' MountVolumeOptions (Maybe Text)
mountVolumeOptionsSubpathL f MountVolumeOptions{..} = (\mountVolumeOptionsSubpath -> MountVolumeOptions { mountVolumeOptionsSubpath, ..} ) <$> f mountVolumeOptionsSubpath
{-# INLINE mountVolumeOptionsSubpathL #-}
...
-- | 'networkEnableIpv4' Lens
networkEnableIpv4L :: Lens_' Network (Maybe Bool)
networkEnableIpv4L f Network{..} = (\networkEnableIpv4 -> Network { networkEnableIpv4, ..} ) <$> f networkEnableIpv4
{-# INLINE networkEnableIpv4L #-}
...
-- | 'networkConfigFrom' Lens
networkConfigFromL :: Lens_' Network (Maybe ConfigReference)
networkConfigFromL f Network{..} = (\networkConfigFrom -> Network { networkConfigFrom, ..} ) <$> f networkConfigFrom
{-# INLINE networkConfigFromL #-}

-- | 'networkConfigOnly' Lens
networkConfigOnlyL :: Lens_' Network (Maybe Bool)
networkConfigOnlyL f Network{..} = (\networkConfigOnly -> Network { networkConfigOnly, ..} ) <$> f networkConfigOnly
{-# INLINE networkConfigOnlyL #-}
...
-- | 'networkPeers' Lens
networkPeersL :: Lens_' Network (Maybe [PeerInfo])
networkPeersL f Network{..} = (\networkPeers -> Network { networkPeers, ..} ) <$> f networkPeers
{-# INLINE networkPeersL #-}
...
networkConnectRequestContainerL :: Lens_' NetworkConnectRequest (Text)
...
-- | 'networkCreateRequestScope' Lens
networkCreateRequestScopeL :: Lens_' NetworkCreateRequest (Maybe Text)
networkCreateRequestScopeL f NetworkCreateRequest{..} = (\networkCreateRequestScope -> NetworkCreateRequest { networkCreateRequestScope, ..} ) <$> f networkCreateRequestScope
{-# INLINE networkCreateRequestScopeL #-}
...
-- | 'networkCreateRequestConfigOnly' Lens
networkCreateRequestConfigOnlyL :: Lens_' NetworkCreateRequest (Maybe Bool)
networkCreateRequestConfigOnlyL f NetworkCreateRequest{..} = (\networkCreateRequestConfigOnly -> NetworkCreateRequest { networkCreateRequestConfigOnly, ..} ) <$> f networkCreateRequestConfigOnly
{-# INLINE networkCreateRequestConfigOnlyL #-}

-- | 'networkCreateRequestConfigFrom' Lens
networkCreateRequestConfigFromL :: Lens_' NetworkCreateRequest (Maybe ConfigReference)
networkCreateRequestConfigFromL f NetworkCreateRequest{..} = (\networkCreateRequestConfigFrom -> NetworkCreateRequest { networkCreateRequestConfigFrom, ..} ) <$> f networkCreateRequestConfigFrom
{-# INLINE networkCreateRequestConfigFromL #-}
...
-- | 'networkCreateRequestEnableIpv4' Lens
networkCreateRequestEnableIpv4L :: Lens_' NetworkCreateRequest (Maybe Bool)
networkCreateRequestEnableIpv4L f NetworkCreateRequest{..} = (\networkCreateRequestEnableIpv4 -> NetworkCreateRequest { networkCreateRequestEnableIpv4, ..} ) <$> f networkCreateRequestEnableIpv4
{-# INLINE networkCreateRequestEnableIpv4L #-}
...
networkCreateResponseIdL :: Lens_' NetworkCreateResponse (Text)
...
networkCreateResponseWarningL :: Lens_' NetworkCreateResponse (Text)
...
networkDisconnectRequestContainerL :: Lens_' NetworkDisconnectRequest (Text)
...
-- | 'networkInspectContainers' Lens
networkInspectContainersL :: Lens_' NetworkInspect (Maybe (Map.Map String EndpointResource))
networkInspectContainersL f NetworkInspect{..} = (\networkInspectContainers -> NetworkInspect { networkInspectContainers, ..} ) <$> f networkInspectContainers
{-# INLINE networkInspectContainersL #-}

-- | 'networkInspectServices' Lens
networkInspectServicesL :: Lens_' NetworkInspect (Maybe (Map.Map String A.Value))
networkInspectServicesL f NetworkInspect{..} = (\networkInspectServices -> NetworkInspect { networkInspectServices, ..} ) <$> f networkInspectServices
{-# INLINE networkInspectServicesL #-}

-- | 'networkInspectStatus' Lens
networkInspectStatusL :: Lens_' NetworkInspect (Maybe NetworkStatus)
networkInspectStatusL f NetworkInspect{..} = (\networkInspectStatus -> NetworkInspect { networkInspectStatus, ..} ) <$> f networkInspectStatus
{-# INLINE networkInspectStatusL #-}

-- | 'networkInspectName' Lens
networkInspectNameL :: Lens_' NetworkInspect (Maybe Text)
networkInspectNameL f NetworkInspect{..} = (\networkInspectName -> NetworkInspect { networkInspectName, ..} ) <$> f networkInspectName
{-# INLINE networkInspectNameL #-}

-- | 'networkInspectId' Lens
networkInspectIdL :: Lens_' NetworkInspect (Maybe Text)
networkInspectIdL f NetworkInspect{..} = (\networkInspectId -> NetworkInspect { networkInspectId, ..} ) <$> f networkInspectId
{-# INLINE networkInspectIdL #-}

-- | 'networkInspectCreated' Lens
networkInspectCreatedL :: Lens_' NetworkInspect (Maybe Text)
networkInspectCreatedL f NetworkInspect{..} = (\networkInspectCreated -> NetworkInspect { networkInspectCreated, ..} ) <$> f networkInspectCreated
{-# INLINE networkInspectCreatedL #-}

-- | 'networkInspectScope' Lens
networkInspectScopeL :: Lens_' NetworkInspect (Maybe Text)
networkInspectScopeL f NetworkInspect{..} = (\networkInspectScope -> NetworkInspect { networkInspectScope, ..} ) <$> f networkInspectScope
{-# INLINE networkInspectScopeL #-}

-- | 'networkInspectDriver' Lens
networkInspectDriverL :: Lens_' NetworkInspect (Maybe Text)
networkInspectDriverL f NetworkInspect{..} = (\networkInspectDriver -> NetworkInspect { networkInspectDriver, ..} ) <$> f networkInspectDriver
{-# INLINE networkInspectDriverL #-}

-- | 'networkInspectEnableIpv4' Lens
networkInspectEnableIpv4L :: Lens_' NetworkInspect (Maybe Bool)
networkInspectEnableIpv4L f NetworkInspect{..} = (\networkInspectEnableIpv4 -> NetworkInspect { networkInspectEnableIpv4, ..} ) <$> f networkInspectEnableIpv4
{-# INLINE networkInspectEnableIpv4L #-}

-- | 'networkInspectEnableIpv6' Lens
networkInspectEnableIpv6L :: Lens_' NetworkInspect (Maybe Bool)
networkInspectEnableIpv6L f NetworkInspect{..} = (\networkInspectEnableIpv6 -> NetworkInspect { networkInspectEnableIpv6, ..} ) <$> f networkInspectEnableIpv6
{-# INLINE networkInspectEnableIpv6L #-}

-- | 'networkInspectIpam' Lens
networkInspectIpamL :: Lens_' NetworkInspect (Maybe IPAM)
networkInspectIpamL f NetworkInspect{..} = (\networkInspectIpam -> NetworkInspect { networkInspectIpam, ..} ) <$> f networkInspectIpam
{-# INLINE networkInspectIpamL #-}

-- | 'networkInspectInternal' Lens
networkInspectInternalL :: Lens_' NetworkInspect (Maybe Bool)
networkInspectInternalL f NetworkInspect{..} = (\networkInspectInternal -> NetworkInspect { networkInspectInternal, ..} ) <$> f networkInspectInternal
{-# INLINE networkInspectInternalL #-}

-- | 'networkInspectAttachable' Lens
networkInspectAttachableL :: Lens_' NetworkInspect (Maybe Bool)
networkInspectAttachableL f NetworkInspect{..} = (\networkInspectAttachable -> NetworkInspect { networkInspectAttachable, ..} ) <$> f networkInspectAttachable
{-# INLINE networkInspectAttachableL #-}

-- | 'networkInspectIngress' Lens
networkInspectIngressL :: Lens_' NetworkInspect (Maybe Bool)
networkInspectIngressL f NetworkInspect{..} = (\networkInspectIngress -> NetworkInspect { networkInspectIngress, ..} ) <$> f networkInspectIngress
{-# INLINE networkInspectIngressL #-}

-- | 'networkInspectConfigFrom' Lens
networkInspectConfigFromL :: Lens_' NetworkInspect (Maybe ConfigReference)
networkInspectConfigFromL f NetworkInspect{..} = (\networkInspectConfigFrom -> NetworkInspect { networkInspectConfigFrom, ..} ) <$> f networkInspectConfigFrom
{-# INLINE networkInspectConfigFromL #-}

-- | 'networkInspectConfigOnly' Lens
networkInspectConfigOnlyL :: Lens_' NetworkInspect (Maybe Bool)
networkInspectConfigOnlyL f NetworkInspect{..} = (\networkInspectConfigOnly -> NetworkInspect { networkInspectConfigOnly, ..} ) <$> f networkInspectConfigOnly
{-# INLINE networkInspectConfigOnlyL #-}

-- | 'networkInspectOptions' Lens
networkInspectOptionsL :: Lens_' NetworkInspect (Maybe (Map.Map String Text))
networkInspectOptionsL f NetworkInspect{..} = (\networkInspectOptions -> NetworkInspect { networkInspectOptions, ..} ) <$> f networkInspectOptions
{-# INLINE networkInspectOptionsL #-}

-- | 'networkInspectLabels' Lens
networkInspectLabelsL :: Lens_' NetworkInspect (Maybe (Map.Map String Text))
networkInspectLabelsL f NetworkInspect{..} = (\networkInspectLabels -> NetworkInspect { networkInspectLabels, ..} ) <$> f networkInspectLabels
{-# INLINE networkInspectLabelsL #-}

-- | 'networkInspectPeers' Lens
networkInspectPeersL :: Lens_' NetworkInspect (Maybe [PeerInfo])
networkInspectPeersL f NetworkInspect{..} = (\networkInspectPeers -> NetworkInspect { networkInspectPeers, ..} ) <$> f networkInspectPeers
{-# INLINE networkInspectPeersL #-}
...
-- | 'networkStatusIpam' Lens
networkStatusIpamL :: Lens_' NetworkStatus (Maybe IPAMStatus)
networkStatusIpamL f NetworkStatus{..} = (\networkStatusIpam -> NetworkStatus { networkStatusIpam, ..} ) <$> f networkStatusIpam
{-# INLINE networkStatusIpamL #-}



-- * NetworkSummary

-- | 'networkSummaryName' Lens
networkSummaryNameL :: Lens_' NetworkSummary (Maybe Text)
networkSummaryNameL f NetworkSummary{..} = (\networkSummaryName -> NetworkSummary { networkSummaryName, ..} ) <$> f networkSummaryName
{-# INLINE networkSummaryNameL #-}

-- | 'networkSummaryId' Lens
networkSummaryIdL :: Lens_' NetworkSummary (Maybe Text)
networkSummaryIdL f NetworkSummary{..} = (\networkSummaryId -> NetworkSummary { networkSummaryId, ..} ) <$> f networkSummaryId
{-# INLINE networkSummaryIdL #-}

-- | 'networkSummaryCreated' Lens
networkSummaryCreatedL :: Lens_' NetworkSummary (Maybe Text)
networkSummaryCreatedL f NetworkSummary{..} = (\networkSummaryCreated -> NetworkSummary { networkSummaryCreated, ..} ) <$> f networkSummaryCreated
{-# INLINE networkSummaryCreatedL #-}

-- | 'networkSummaryScope' Lens
networkSummaryScopeL :: Lens_' NetworkSummary (Maybe Text)
networkSummaryScopeL f NetworkSummary{..} = (\networkSummaryScope -> NetworkSummary { networkSummaryScope, ..} ) <$> f networkSummaryScope
{-# INLINE networkSummaryScopeL #-}

-- | 'networkSummaryDriver' Lens
networkSummaryDriverL :: Lens_' NetworkSummary (Maybe Text)
networkSummaryDriverL f NetworkSummary{..} = (\networkSummaryDriver -> NetworkSummary { networkSummaryDriver, ..} ) <$> f networkSummaryDriver
{-# INLINE networkSummaryDriverL #-}

-- | 'networkSummaryEnableIpv4' Lens
networkSummaryEnableIpv4L :: Lens_' NetworkSummary (Maybe Bool)
networkSummaryEnableIpv4L f NetworkSummary{..} = (\networkSummaryEnableIpv4 -> NetworkSummary { networkSummaryEnableIpv4, ..} ) <$> f networkSummaryEnableIpv4
{-# INLINE networkSummaryEnableIpv4L #-}

-- | 'networkSummaryEnableIpv6' Lens
networkSummaryEnableIpv6L :: Lens_' NetworkSummary (Maybe Bool)
networkSummaryEnableIpv6L f NetworkSummary{..} = (\networkSummaryEnableIpv6 -> NetworkSummary { networkSummaryEnableIpv6, ..} ) <$> f networkSummaryEnableIpv6
{-# INLINE networkSummaryEnableIpv6L #-}

-- | 'networkSummaryIpam' Lens
networkSummaryIpamL :: Lens_' NetworkSummary (Maybe IPAM)
networkSummaryIpamL f NetworkSummary{..} = (\networkSummaryIpam -> NetworkSummary { networkSummaryIpam, ..} ) <$> f networkSummaryIpam
{-# INLINE networkSummaryIpamL #-}

-- | 'networkSummaryInternal' Lens
networkSummaryInternalL :: Lens_' NetworkSummary (Maybe Bool)
networkSummaryInternalL f NetworkSummary{..} = (\networkSummaryInternal -> NetworkSummary { networkSummaryInternal, ..} ) <$> f networkSummaryInternal
{-# INLINE networkSummaryInternalL #-}

-- | 'networkSummaryAttachable' Lens
networkSummaryAttachableL :: Lens_' NetworkSummary (Maybe Bool)
networkSummaryAttachableL f NetworkSummary{..} = (\networkSummaryAttachable -> NetworkSummary { networkSummaryAttachable, ..} ) <$> f networkSummaryAttachable
{-# INLINE networkSummaryAttachableL #-}

-- | 'networkSummaryIngress' Lens
networkSummaryIngressL :: Lens_' NetworkSummary (Maybe Bool)
networkSummaryIngressL f NetworkSummary{..} = (\networkSummaryIngress -> NetworkSummary { networkSummaryIngress, ..} ) <$> f networkSummaryIngress
{-# INLINE networkSummaryIngressL #-}

-- | 'networkSummaryConfigFrom' Lens
networkSummaryConfigFromL :: Lens_' NetworkSummary (Maybe ConfigReference)
networkSummaryConfigFromL f NetworkSummary{..} = (\networkSummaryConfigFrom -> NetworkSummary { networkSummaryConfigFrom, ..} ) <$> f networkSummaryConfigFrom
{-# INLINE networkSummaryConfigFromL #-}

-- | 'networkSummaryConfigOnly' Lens
networkSummaryConfigOnlyL :: Lens_' NetworkSummary (Maybe Bool)
networkSummaryConfigOnlyL f NetworkSummary{..} = (\networkSummaryConfigOnly -> NetworkSummary { networkSummaryConfigOnly, ..} ) <$> f networkSummaryConfigOnly
{-# INLINE networkSummaryConfigOnlyL #-}

-- | 'networkSummaryOptions' Lens
networkSummaryOptionsL :: Lens_' NetworkSummary (Maybe (Map.Map String Text))
networkSummaryOptionsL f NetworkSummary{..} = (\networkSummaryOptions -> NetworkSummary { networkSummaryOptions, ..} ) <$> f networkSummaryOptions
{-# INLINE networkSummaryOptionsL #-}

-- | 'networkSummaryLabels' Lens
networkSummaryLabelsL :: Lens_' NetworkSummary (Maybe (Map.Map String Text))
networkSummaryLabelsL f NetworkSummary{..} = (\networkSummaryLabels -> NetworkSummary { networkSummaryLabels, ..} ) <$> f networkSummaryLabels
{-# INLINE networkSummaryLabelsL #-}

-- | 'networkSummaryPeers' Lens
networkSummaryPeersL :: Lens_' NetworkSummary (Maybe [PeerInfo])
networkSummaryPeersL f NetworkSummary{..} = (\networkSummaryPeers -> NetworkSummary { networkSummaryPeers, ..} ) <$> f networkSummaryPeers
{-# INLINE networkSummaryPeersL #-}



-- * NetworkTaskInfo

-- | 'networkTaskInfoName' Lens
networkTaskInfoNameL :: Lens_' NetworkTaskInfo (Maybe Text)
networkTaskInfoNameL f NetworkTaskInfo{..} = (\networkTaskInfoName -> NetworkTaskInfo { networkTaskInfoName, ..} ) <$> f networkTaskInfoName
{-# INLINE networkTaskInfoNameL #-}

-- | 'networkTaskInfoEndpointId' Lens
networkTaskInfoEndpointIdL :: Lens_' NetworkTaskInfo (Maybe Text)
networkTaskInfoEndpointIdL f NetworkTaskInfo{..} = (\networkTaskInfoEndpointId -> NetworkTaskInfo { networkTaskInfoEndpointId, ..} ) <$> f networkTaskInfoEndpointId
{-# INLINE networkTaskInfoEndpointIdL #-}

-- | 'networkTaskInfoEndpointIp' Lens
networkTaskInfoEndpointIpL :: Lens_' NetworkTaskInfo (Maybe Text)
networkTaskInfoEndpointIpL f NetworkTaskInfo{..} = (\networkTaskInfoEndpointIp -> NetworkTaskInfo { networkTaskInfoEndpointIp, ..} ) <$> f networkTaskInfoEndpointIp
{-# INLINE networkTaskInfoEndpointIpL #-}

-- | 'networkTaskInfoInfo' Lens
networkTaskInfoInfoL :: Lens_' NetworkTaskInfo (Maybe (Map.Map String Text))
networkTaskInfoInfoL f NetworkTaskInfo{..} = (\networkTaskInfoInfo -> NetworkTaskInfo { networkTaskInfoInfo, ..} ) <$> f networkTaskInfoInfo
{-# INLINE networkTaskInfoInfoL #-}
...
-- | 'oCIDescriptorUrls' Lens
oCIDescriptorUrlsL :: Lens_' OCIDescriptor (Maybe [Text])
oCIDescriptorUrlsL f OCIDescriptor{..} = (\oCIDescriptorUrls -> OCIDescriptor { oCIDescriptorUrls, ..} ) <$> f oCIDescriptorUrls
{-# INLINE oCIDescriptorUrlsL #-}

-- | 'oCIDescriptorAnnotations' Lens
oCIDescriptorAnnotationsL :: Lens_' OCIDescriptor (Maybe (Map.Map String Text))
oCIDescriptorAnnotationsL f OCIDescriptor{..} = (\oCIDescriptorAnnotations -> OCIDescriptor { oCIDescriptorAnnotations, ..} ) <$> f oCIDescriptorAnnotations
{-# INLINE oCIDescriptorAnnotationsL #-}

-- | 'oCIDescriptorData' Lens
oCIDescriptorDataL :: Lens_' OCIDescriptor (Maybe Text)
oCIDescriptorDataL f OCIDescriptor{..} = (\oCIDescriptorData -> OCIDescriptor { oCIDescriptorData, ..} ) <$> f oCIDescriptorData
{-# INLINE oCIDescriptorDataL #-}

-- | 'oCIDescriptorPlatform' Lens
oCIDescriptorPlatformL :: Lens_' OCIDescriptor (Maybe OCIPlatform)
oCIDescriptorPlatformL f OCIDescriptor{..} = (\oCIDescriptorPlatform -> OCIDescriptor { oCIDescriptorPlatform, ..} ) <$> f oCIDescriptorPlatform
{-# INLINE oCIDescriptorPlatformL #-}

-- | 'oCIDescriptorArtifactType' Lens
oCIDescriptorArtifactTypeL :: Lens_' OCIDescriptor (Maybe Text)
oCIDescriptorArtifactTypeL f OCIDescriptor{..} = (\oCIDescriptorArtifactType -> OCIDescriptor { oCIDescriptorArtifactType, ..} ) <$> f oCIDescriptorArtifactType
{-# INLINE oCIDescriptorArtifactTypeL #-}
...
-- | 'peerInfoName' Lens
peerInfoNameL :: Lens_' PeerInfo (Maybe Text)
peerInfoNameL f PeerInfo{..} = (\peerInfoName -> PeerInfo { peerInfoName, ..} ) <$> f peerInfoName
{-# INLINE peerInfoNameL #-}

-- | 'peerInfoIp' Lens
peerInfoIpL :: Lens_' PeerInfo (Maybe Text)
peerInfoIpL f PeerInfo{..} = (\peerInfoIp -> PeerInfo { peerInfoIp, ..} ) <$> f peerInfoIp
{-# INLINE peerInfoIpL #-}
...
pluginConfigInterfaceTypesL :: Lens_' PluginConfigInterface ([Text])
...
-- | 'portStatusPorts' Lens
portStatusPortsL :: Lens_' PortStatus (Maybe [EndpointPortConfig])
portStatusPortsL f PortStatus{..} = (\portStatusPorts -> PortStatus { portStatusPorts, ..} ) <$> f portStatusPorts
{-# INLINE portStatusPortsL #-}
...
-- | 'portSummaryIp' Lens
portSummaryIpL :: Lens_' PortSummary (Maybe Text)
portSummaryIpL f PortSummary{..} = (\portSummaryIp -> PortSummary { portSummaryIp, ..} ) <$> f portSummaryIp
{-# INLINE portSummaryIpL #-}

-- | 'portSummaryPrivatePort' Lens
portSummaryPrivatePortL :: Lens_' PortSummary (Int)
portSummaryPrivatePortL f PortSummary{..} = (\portSummaryPrivatePort -> PortSummary { portSummaryPrivatePort, ..} ) <$> f portSummaryPrivatePort
{-# INLINE portSummaryPrivatePortL #-}

-- | 'portSummaryPublicPort' Lens
portSummaryPublicPortL :: Lens_' PortSummary (Maybe Int)
portSummaryPublicPortL f PortSummary{..} = (\portSummaryPublicPort -> PortSummary { portSummaryPublicPort, ..} ) <$> f portSummaryPublicPort
{-# INLINE portSummaryPublicPortL #-}

-- | 'portSummaryType' Lens
portSummaryTypeL :: Lens_' PortSummary (E'Type)
portSummaryTypeL f PortSummary{..} = (\portSummaryType -> PortSummary { portSummaryType, ..} ) <$> f portSummaryType
{-# INLINE portSummaryTypeL #-}
...
-- | 'pushImageInfoErrorDetail' Lens
pushImageInfoErrorDetailL :: Lens_' PushImageInfo (Maybe ErrorDetail)
pushImageInfoErrorDetailL f PushImageInfo{..} = (\pushImageInfoErrorDetail -> PushImageInfo { pushImageInfoErrorDetail, ..} ) <$> f pushImageInfoErrorDetail
{-# INLINE pushImageInfoErrorDetailL #-}
...
-- | 'rootFSStorageSnapshot' Lens
rootFSStorageSnapshotL :: Lens_' RootFSStorage (Maybe RootFSStorageSnapshot)
rootFSStorageSnapshotL f RootFSStorage{..} = (\rootFSStorageSnapshot -> RootFSStorage { rootFSStorageSnapshot, ..} ) <$> f rootFSStorageSnapshot
{-# INLINE rootFSStorageSnapshotL #-}



-- * RootFSStorageSnapshot

-- | 'rootFSStorageSnapshotName' Lens
rootFSStorageSnapshotNameL :: Lens_' RootFSStorageSnapshot (Maybe Text)
rootFSStorageSnapshotNameL f RootFSStorageSnapshot{..} = (\rootFSStorageSnapshotName -> RootFSStorageSnapshot { rootFSStorageSnapshotName, ..} ) <$> f rootFSStorageSnapshotName
{-# INLINE rootFSStorageSnapshotNameL #-}
...
-- | 'runtimeStatus' Lens
runtimeStatusL :: Lens_' Runtime (Maybe (Map.Map String Text))
runtimeStatusL f Runtime{..} = (\runtimeStatus -> Runtime { runtimeStatus, ..} ) <$> f runtimeStatus
{-# INLINE runtimeStatusL #-}
...
serviceCreateRequestNetworksL :: Lens_' ServiceCreateRequest (Maybe [NetworkAttachmentConfig])
...
-- | 'serviceCreateResponseWarnings' Lens
serviceCreateResponseWarningsL :: Lens_' ServiceCreateResponse (Maybe [Text])
serviceCreateResponseWarningsL f ServiceCreateResponse{..} = (\serviceCreateResponseWarnings -> ServiceCreateResponse { serviceCreateResponseWarnings, ..} ) <$> f serviceCreateResponseWarnings
...
-- | 'serviceInfoVip' Lens
serviceInfoVipL :: Lens_' ServiceInfo (Maybe Text)
serviceInfoVipL f ServiceInfo{..} = (\serviceInfoVip -> ServiceInfo { serviceInfoVip, ..} ) <$> f serviceInfoVip
{-# INLINE serviceInfoVipL #-}

-- | 'serviceInfoPorts' Lens
serviceInfoPortsL :: Lens_' ServiceInfo (Maybe [Text])
serviceInfoPortsL f ServiceInfo{..} = (\serviceInfoPorts -> ServiceInfo { serviceInfoPorts, ..} ) <$> f serviceInfoPorts
{-# INLINE serviceInfoPortsL #-}

-- | 'serviceInfoLocalLbIndex' Lens
serviceInfoLocalLbIndexL :: Lens_' ServiceInfo (Maybe Int)
serviceInfoLocalLbIndexL f ServiceInfo{..} = (\serviceInfoLocalLbIndex -> ServiceInfo { serviceInfoLocalLbIndex, ..} ) <$> f serviceInfoLocalLbIndex
{-# INLINE serviceInfoLocalLbIndexL #-}

-- | 'serviceInfoTasks' Lens
serviceInfoTasksL :: Lens_' ServiceInfo (Maybe [NetworkTaskInfo])
serviceInfoTasksL f ServiceInfo{..} = (\serviceInfoTasks -> ServiceInfo { serviceInfoTasks, ..} ) <$> f serviceInfoTasks
{-# INLINE serviceInfoTasksL #-}
...
serviceUpdateRequestNetworksL :: Lens_' ServiceUpdateRequest (Maybe [NetworkAttachmentConfig])
...
serviceUpdateStatusStateL :: Lens_' ServiceUpdateStatus (Maybe E'State2)
...
-- | 'storageRootFs' Lens
storageRootFsL :: Lens_' Storage (Maybe RootFSStorage)
storageRootFsL f Storage{..} = (\storageRootFs -> Storage { storageRootFs, ..} ) <$> f storageRootFs
{-# INLINE storageRootFsL #-}



-- * SubnetStatus

-- | 'subnetStatusIpsInUse' Lens
subnetStatusIpsInUseL :: Lens_' SubnetStatus (Maybe Int)
subnetStatusIpsInUseL f SubnetStatus{..} = (\subnetStatusIpsInUse -> SubnetStatus { subnetStatusIpsInUse, ..} ) <$> f subnetStatusIpsInUse
{-# INLINE subnetStatusIpsInUseL #-}

-- | 'subnetStatusDynamicIpsAvailable' Lens
subnetStatusDynamicIpsAvailableL :: Lens_' SubnetStatus (Maybe Int)
subnetStatusDynamicIpsAvailableL f SubnetStatus{..} = (\subnetStatusDynamicIpsAvailable -> SubnetStatus { subnetStatusDynamicIpsAvailable, ..} ) <$> f subnetStatusDynamicIpsAvailable
{-# INLINE subnetStatusDynamicIpsAvailableL #-}
...
-- | 'systemDataUsageResponseImagesDiskUsage' Lens
systemDataUsageResponseImagesDiskUsageL :: Lens_' SystemDataUsageResponse (Maybe ImagesDiskUsage)
systemDataUsageResponseImagesDiskUsageL f SystemDataUsageResponse{..} = (\systemDataUsageResponseImagesDiskUsage -> SystemDataUsageResponse { systemDataUsageResponseImagesDiskUsage, ..} ) <$> f systemDataUsageResponseImagesDiskUsage
{-# INLINE systemDataUsageResponseImagesDiskUsageL #-}

-- | 'systemDataUsageResponseContainersDiskUsage' Lens
systemDataUsageResponseContainersDiskUsageL :: Lens_' SystemDataUsageResponse (Maybe ContainersDiskUsage)
systemDataUsageResponseContainersDiskUsageL f SystemDataUsageResponse{..} = (\systemDataUsageResponseContainersDiskUsage -> SystemDataUsageResponse { systemDataUsageResponseContainersDiskUsage, ..} ) <$> f systemDataUsageResponseContainersDiskUsage
{-# INLINE systemDataUsageResponseContainersDiskUsageL #-}

-- | 'systemDataUsageResponseVolumesDiskUsage' Lens
systemDataUsageResponseVolumesDiskUsageL :: Lens_' SystemDataUsageResponse (Maybe VolumesDiskUsage)
systemDataUsageResponseVolumesDiskUsageL f SystemDataUsageResponse{..} = (\systemDataUsageResponseVolumesDiskUsage -> SystemDataUsageResponse { systemDataUsageResponseVolumesDiskUsage, ..} ) <$> f systemDataUsageResponseVolumesDiskUsage
{-# INLINE systemDataUsageResponseVolumesDiskUsageL #-}

-- | 'systemDataUsageResponseBuildCacheDiskUsage' Lens
systemDataUsageResponseBuildCacheDiskUsageL :: Lens_' SystemDataUsageResponse (Maybe BuildCacheDiskUsage)
systemDataUsageResponseBuildCacheDiskUsageL f SystemDataUsageResponse{..} = (\systemDataUsageResponseBuildCacheDiskUsage -> SystemDataUsageResponse { systemDataUsageResponseBuildCacheDiskUsage, ..} ) <$> f systemDataUsageResponseBuildCacheDiskUsage
{-# INLINE systemDataUsageResponseBuildCacheDiskUsageL #-}
...
systemInfoDefaultAddressPoolsL :: Lens_' SystemInfo (Maybe [SystemInfoDefaultAddressPoolsInner])
...
-- | 'systemInfoFirewallBackend' Lens
systemInfoFirewallBackendL :: Lens_' SystemInfo (Maybe FirewallInfo)
systemInfoFirewallBackendL f SystemInfo{..} = (\systemInfoFirewallBackend -> SystemInfo { systemInfoFirewallBackend, ..} ) <$> f systemInfoFirewallBackend
{-# INLINE systemInfoFirewallBackendL #-}

-- | 'systemInfoDiscoveredDevices' Lens
systemInfoDiscoveredDevicesL :: Lens_' SystemInfo (Maybe [DeviceInfo])
systemInfoDiscoveredDevicesL f SystemInfo{..} = (\systemInfoDiscoveredDevices -> SystemInfo { systemInfoDiscoveredDevices, ..} ) <$> f systemInfoDiscoveredDevices
{-# INLINE systemInfoDiscoveredDevicesL #-}
...
-- | 'systemInfoCdiSpecDirs' Lens
systemInfoCdiSpecDirsL :: Lens_' SystemInfo (Maybe [Text])
systemInfoCdiSpecDirsL f SystemInfo{..} = (\systemInfoCdiSpecDirs -> SystemInfo { systemInfoCdiSpecDirs, ..} ) <$> f systemInfoCdiSpecDirs
{-# INLINE systemInfoCdiSpecDirsL #-}

-- | 'systemInfoContainerd' Lens
systemInfoContainerdL :: Lens_' SystemInfo (Maybe ContainerdInfo)
systemInfoContainerdL f SystemInfo{..} = (\systemInfoContainerd -> SystemInfo { systemInfoContainerd, ..} ) <$> f systemInfoContainerd
{-# INLINE systemInfoContainerdL #-}



-- * SystemInfoDefaultAddressPoolsInner

-- | 'systemInfoDefaultAddressPoolsInnerBase' Lens
systemInfoDefaultAddressPoolsInnerBaseL :: Lens_' SystemInfoDefaultAddressPoolsInner (Maybe Text)
systemInfoDefaultAddressPoolsInnerBaseL f SystemInfoDefaultAddressPoolsInner{..} = (\systemInfoDefaultAddressPoolsInnerBase -> SystemInfoDefaultAddressPoolsInner { systemInfoDefaultAddressPoolsInnerBase, ..} ) <$> f systemInfoDefaultAddressPoolsInnerBase
{-# INLINE systemInfoDefaultAddressPoolsInnerBaseL #-}

-- | 'systemInfoDefaultAddressPoolsInnerSize' Lens
systemInfoDefaultAddressPoolsInnerSizeL :: Lens_' SystemInfoDefaultAddressPoolsInner (Maybe Int)
systemInfoDefaultAddressPoolsInnerSizeL f SystemInfoDefaultAddressPoolsInner{..} = (\systemInfoDefaultAddressPoolsInnerSize -> SystemInfoDefaultAddressPoolsInner { systemInfoDefaultAddressPoolsInnerSize, ..} ) <$> f systemInfoDefaultAddressPoolsInnerSize
{-# INLINE systemInfoDefaultAddressPoolsInnerSizeL #-}
...
systemVersionComponentsL :: Lens_' SystemVersion (Maybe [SystemVersionComponentsInner])
...
-- | 'systemVersionComponentsInnerName' Lens
systemVersionComponentsInnerNameL :: Lens_' SystemVersionComponentsInner (Text)
systemVersionComponentsInnerNameL f SystemVersionComponentsInner{..} = (\systemVersionComponentsInnerName -> SystemVersionComponentsInner { systemVersionComponentsInnerName, ..} ) <$> f systemVersionComponentsInnerName
{-# INLINE systemVersionComponentsInnerNameL #-}

-- | 'systemVersionComponentsInnerVersion' Lens
systemVersionComponentsInnerVersionL :: Lens_' SystemVersionComponentsInner (Text)
systemVersionComponentsInnerVersionL f SystemVersionComponentsInner{..} = (\systemVersionComponentsInnerVersion -> SystemVersionComponentsInner { systemVersionComponentsInnerVersion, ..} ) <$> f systemVersionComponentsInnerVersion
{-# INLINE systemVersionComponentsInnerVersionL #-}

-- | 'systemVersionComponentsInnerDetails' Lens
systemVersionComponentsInnerDetailsL :: Lens_' SystemVersionComponentsInner (Maybe A.Value)
systemVersionComponentsInnerDetailsL f SystemVersionComponentsInner{..} = (\systemVersionComponentsInnerDetails -> SystemVersionComponentsInner { systemVersionComponentsInnerDetails, ..} ) <$> f systemVersionComponentsInnerDetails
{-# INLINE systemVersionComponentsInnerDetailsL #-}
...
-- | 'taskSpecContainerSpecOomScoreAdj' Lens
taskSpecContainerSpecOomScoreAdjL :: Lens_' TaskSpecContainerSpec (Maybe Integer)
taskSpecContainerSpecOomScoreAdjL f TaskSpecContainerSpec{..} = (\taskSpecContainerSpecOomScoreAdj -> TaskSpecContainerSpec { taskSpecContainerSpecOomScoreAdj, ..} ) <$> f taskSpecContainerSpecOomScoreAdj
{-# INLINE taskSpecContainerSpecOomScoreAdjL #-}
...
taskSpecContainerSpecUlimitsL :: Lens_' TaskSpecContainerSpec (Maybe [ResourcesUlimitsInner])
...
taskSpecContainerSpecConfigsInnerFileL :: Lens_' TaskSpecContainerSpecConfigsInner (Maybe TaskSpecContainerSpecConfigsInnerFile)
...
-- | 'taskSpecContainerSpecConfigsInnerRuntime' Lens
taskSpecContainerSpecConfigsInnerRuntimeL :: Lens_' TaskSpecContainerSpecConfigsInner (Maybe A.Value)
taskSpecContainerSpecConfigsInnerRuntimeL f TaskSpecContainerSpecConfigsInner{..} = (\taskSpecContainerSpecConfigsInnerRuntime -> TaskSpecContainerSpecConfigsInner { taskSpecContainerSpecConfigsInnerRuntime, ..} ) <$> f taskSpecContainerSpecConfigsInnerRuntime
{-# INLINE taskSpecContainerSpecConfigsInnerRuntimeL #-}
...
-- | 'taskSpecContainerSpecConfigsInnerFileName' Lens
taskSpecContainerSpecConfigsInnerFileNameL :: Lens_' TaskSpecContainerSpecConfigsInnerFile (Maybe Text)
taskSpecContainerSpecConfigsInnerFileNameL f TaskSpecContainerSpecConfigsInnerFile{..} = (\taskSpecContainerSpecConfigsInnerFileName -> TaskSpecContainerSpecConfigsInnerFile { taskSpecContainerSpecConfigsInnerFileName, ..} ) <$> f taskSpecContainerSpecConfigsInnerFileName
{-# INLINE taskSpecContainerSpecConfigsInnerFileNameL #-}

-- | 'taskSpecContainerSpecConfigsInnerFileUid' Lens
taskSpecContainerSpecConfigsInnerFileUidL :: Lens_' TaskSpecContainerSpecConfigsInnerFile (Maybe Text)
taskSpecContainerSpecConfigsInnerFileUidL f TaskSpecContainerSpecConfigsInnerFile{..} = (\taskSpecContainerSpecConfigsInnerFileUid -> TaskSpecContainerSpecConfigsInnerFile { taskSpecContainerSpecConfigsInnerFileUid, ..} ) <$> f taskSpecContainerSpecConfigsInnerFileUid
{-# INLINE taskSpecContainerSpecConfigsInnerFileUidL #-}

-- | 'taskSpecContainerSpecConfigsInnerFileGid' Lens
taskSpecContainerSpecConfigsInnerFileGidL :: Lens_' TaskSpecContainerSpecConfigsInnerFile (Maybe Text)
taskSpecContainerSpecConfigsInnerFileGidL f TaskSpecContainerSpecConfigsInnerFile{..} = (\taskSpecContainerSpecConfigsInnerFileGid -> TaskSpecContainerSpecConfigsInnerFile { taskSpecContainerSpecConfigsInnerFileGid, ..} ) <$> f taskSpecContainerSpecConfigsInnerFileGid
{-# INLINE taskSpecContainerSpecConfigsInnerFileGidL #-}

-- | 'taskSpecContainerSpecConfigsInnerFileMode' Lens
taskSpecContainerSpecConfigsInnerFileModeL :: Lens_' TaskSpecContainerSpecConfigsInnerFile (Maybe Int)
taskSpecContainerSpecConfigsInnerFileModeL f TaskSpecContainerSpecConfigsInnerFile{..} = (\taskSpecContainerSpecConfigsInnerFileMode -> TaskSpecContainerSpecConfigsInnerFile { taskSpecContainerSpecConfigsInnerFileMode, ..} ) <$> f taskSpecContainerSpecConfigsInnerFileMode
{-# INLINE taskSpecContainerSpecConfigsInnerFileModeL #-}
...
-- | 'taskSpecContainerSpecPrivilegesSeccomp' Lens
taskSpecContainerSpecPrivilegesSeccompL :: Lens_' TaskSpecContainerSpecPrivileges (Maybe TaskSpecContainerSpecPrivilegesSeccomp)
taskSpecContainerSpecPrivilegesSeccompL f TaskSpecContainerSpecPrivileges{..} = (\taskSpecContainerSpecPrivilegesSeccomp -> TaskSpecContainerSpecPrivileges { taskSpecContainerSpecPrivilegesSeccomp, ..} ) <$> f taskSpecContainerSpecPrivilegesSeccomp
{-# INLINE taskSpecContainerSpecPrivilegesSeccompL #-}

-- | 'taskSpecContainerSpecPrivilegesAppArmor' Lens
taskSpecContainerSpecPrivilegesAppArmorL :: Lens_' TaskSpecContainerSpecPrivileges (Maybe TaskSpecContainerSpecPrivilegesAppArmor)
taskSpecContainerSpecPrivilegesAppArmorL f TaskSpecContainerSpecPrivileges{..} = (\taskSpecContainerSpecPrivilegesAppArmor -> TaskSpecContainerSpecPrivileges { taskSpecContainerSpecPrivilegesAppArmor, ..} ) <$> f taskSpecContainerSpecPrivilegesAppArmor
{-# INLINE taskSpecContainerSpecPrivilegesAppArmorL #-}

-- | 'taskSpecContainerSpecPrivilegesNoNewPrivileges' Lens
taskSpecContainerSpecPrivilegesNoNewPrivilegesL :: Lens_' TaskSpecContainerSpecPrivileges (Maybe Bool)
taskSpecContainerSpecPrivilegesNoNewPrivilegesL f TaskSpecContainerSpecPrivileges{..} = (\taskSpecContainerSpecPrivilegesNoNewPrivileges -> TaskSpecContainerSpecPrivileges { taskSpecContainerSpecPrivilegesNoNewPrivileges, ..} ) <$> f taskSpecContainerSpecPrivilegesNoNewPrivileges
...
-- | 'taskSpecContainerSpecPrivilegesAppArmorMode' Lens
taskSpecContainerSpecPrivilegesAppArmorModeL :: Lens_' TaskSpecContainerSpecPrivilegesAppArmor (Maybe E'Mode3)
taskSpecContainerSpecPrivilegesAppArmorModeL f TaskSpecContainerSpecPrivilegesAppArmor{..} = (\taskSpecContainerSpecPrivilegesAppArmorMode -> TaskSpecContainerSpecPrivilegesAppArmor { taskSpecContainerSpecPrivilegesAppArmorMode, ..} ) <$> f taskSpecContainerSpecPrivilegesAppArmorMode
{-# INLINE taskSpecContainerSpecPrivilegesAppArmorModeL #-}
...
-- | 'taskSpecContainerSpecPrivilegesSeccompMode' Lens
taskSpecContainerSpecPrivilegesSeccompModeL :: Lens_' TaskSpecContainerSpecPrivilegesSeccomp (Maybe E'Mode2)
taskSpecContainerSpecPrivilegesSeccompModeL f TaskSpecContainerSpecPrivilegesSeccomp{..} = (\taskSpecContainerSpecPrivilegesSeccompMode -> TaskSpecContainerSpecPrivilegesSeccomp { taskSpecContainerSpecPrivilegesSeccompMode, ..} ) <$> f taskSpecContainerSpecPrivilegesSeccompMode
{-# INLINE taskSpecContainerSpecPrivilegesSeccompModeL #-}

-- | 'taskSpecContainerSpecPrivilegesSeccompProfile' Lens
taskSpecContainerSpecPrivilegesSeccompProfileL :: Lens_' TaskSpecContainerSpecPrivilegesSeccomp (Maybe Text)
taskSpecContainerSpecPrivilegesSeccompProfileL f TaskSpecContainerSpecPrivilegesSeccomp{..} = (\taskSpecContainerSpecPrivilegesSeccompProfile -> TaskSpecContainerSpecPrivilegesSeccomp { taskSpecContainerSpecPrivilegesSeccompProfile, ..} ) <$> f taskSpecContainerSpecPrivilegesSeccompProfile
...
-- | 'taskSpecResourcesSwapBytes' Lens
taskSpecResourcesSwapBytesL :: Lens_' TaskSpecResources (Maybe Integer)
taskSpecResourcesSwapBytesL f TaskSpecResources{..} = (\taskSpecResourcesSwapBytes -> TaskSpecResources { taskSpecResourcesSwapBytes, ..} ) <$> f taskSpecResourcesSwapBytes
{-# INLINE taskSpecResourcesSwapBytesL #-}

-- | 'taskSpecResourcesMemorySwappiness' Lens
taskSpecResourcesMemorySwappinessL :: Lens_' TaskSpecResources (Maybe Integer)
taskSpecResourcesMemorySwappinessL f TaskSpecResources{..} = (\taskSpecResourcesMemorySwappiness -> TaskSpecResources { taskSpecResourcesMemorySwappiness, ..} ) <$> f taskSpecResourcesMemorySwappiness
{-# INLINE taskSpecResourcesMemorySwappinessL #-}
...
taskStatusContainerStatusL :: Lens_' TaskStatus (Maybe ContainerStatus)
...
-- | 'taskStatusPortStatus' Lens
taskStatusPortStatusL :: Lens_' TaskStatus (Maybe PortStatus)
taskStatusPortStatusL f TaskStatus{..} = (\taskStatusPortStatus -> TaskStatus { taskStatusPortStatus, ..} ) <$> f taskStatusPortStatus
{-# INLINE taskStatusPortStatusL #-}
...
-- | 'volumeClusterVolume' Lens
volumeClusterVolumeL :: Lens_' Volume (Maybe ClusterVolume)
volumeClusterVolumeL f Volume{..} = (\volumeClusterVolume -> Volume { volumeClusterVolume, ..} ) <$> f volumeClusterVolume
{-# INLINE volumeClusterVolumeL #-}
...
-- | 'volumeCreateRequestClusterVolumeSpec' Lens
volumeCreateRequestClusterVolumeSpecL :: Lens_' VolumeCreateRequest (Maybe ClusterVolumeSpec)
volumeCreateRequestClusterVolumeSpecL f VolumeCreateRequest{..} = (\volumeCreateRequestClusterVolumeSpec -> VolumeCreateRequest { volumeCreateRequestClusterVolumeSpec, ..} ) <$> f volumeCreateRequestClusterVolumeSpec
{-# INLINE volumeCreateRequestClusterVolumeSpecL #-}
...
volumeListResponseVolumesL :: Lens_' VolumeListResponse (Maybe [Volume])
...
volumeListResponseWarningsL :: Lens_' VolumeListResponse (Maybe [Text])
...
-- | 'volumeUpdateRequestSpec' Lens
volumeUpdateRequestSpecL :: Lens_' VolumeUpdateRequest (Maybe ClusterVolumeSpec)
volumeUpdateRequestSpecL f VolumeUpdateRequest{..} = (\volumeUpdateRequestSpec -> VolumeUpdateRequest { volumeUpdateRequestSpec, ..} ) <$> f volumeUpdateRequestSpec
{-# INLINE volumeUpdateRequestSpecL #-}
...
-- | 'volumesDiskUsageActiveCount' Lens
volumesDiskUsageActiveCountL :: Lens_' VolumesDiskUsage (Maybe Integer)
volumesDiskUsageActiveCountL f VolumesDiskUsage{..} = (\volumesDiskUsageActiveCount -> VolumesDiskUsage { volumesDiskUsageActiveCount, ..} ) <$> f volumesDiskUsageActiveCount
{-# INLINE volumesDiskUsageActiveCountL #-}

-- | 'volumesDiskUsageTotalCount' Lens
volumesDiskUsageTotalCountL :: Lens_' VolumesDiskUsage (Maybe Integer)
volumesDiskUsageTotalCountL f VolumesDiskUsage{..} = (\volumesDiskUsageTotalCount -> VolumesDiskUsage { volumesDiskUsageTotalCount, ..} ) <$> f volumesDiskUsageTotalCount
{-# INLINE volumesDiskUsageTotalCountL #-}

-- | 'volumesDiskUsageReclaimable' Lens
volumesDiskUsageReclaimableL :: Lens_' VolumesDiskUsage (Maybe Integer)
volumesDiskUsageReclaimableL f VolumesDiskUsage{..} = (\volumesDiskUsageReclaimable -> VolumesDiskUsage { volumesDiskUsageReclaimable, ..} ) <$> f volumesDiskUsageReclaimable
{-# INLINE volumesDiskUsageReclaimableL #-}

-- | 'volumesDiskUsageTotalSize' Lens
volumesDiskUsageTotalSizeL :: Lens_' VolumesDiskUsage (Maybe Integer)
volumesDiskUsageTotalSizeL f VolumesDiskUsage{..} = (\volumesDiskUsageTotalSize -> VolumesDiskUsage { volumesDiskUsageTotalSize, ..} ) <$> f volumesDiskUsageTotalSize
{-# INLINE volumesDiskUsageTotalSizeL #-}

-- | 'volumesDiskUsageItems' Lens
volumesDiskUsageItemsL :: Lens_' VolumesDiskUsage (Maybe [A.Value])
volumesDiskUsageItemsL f VolumesDiskUsage{..} = (\volumesDiskUsageItems -> VolumesDiskUsage { volumesDiskUsageItems, ..} ) <$> f volumesDiskUsageItems
{-# INLINE volumesDiskUsageItemsL #-}
