...
systemAuth
  ...
  => DockerEngineRequest SystemAuth MimeJSON AuthResponse MimeJSON
systemAuth =
...
-- | /Optional Param/ "verbose" - Show detailed information on space usage. 
instance HasOptionalParam SystemDataUsage Verbose where
...
systemEvents
  :: Accept accept -- ^ request accept ('MimeType')
  -> DockerEngineRequest SystemEvents MimeNoContent EventMessage accept
systemEvents  _ =
...
instance Produces SystemEvents MimeXNdjson
-- | @application/json-seq@
instance Produces SystemEvents MimeJsonSeq
