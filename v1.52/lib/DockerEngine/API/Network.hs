...
-- 
networkConnect
  :: (Consumes NetworkConnect MimeJSON, MimeRender MimeJSON NetworkConnectRequest)
...
data NetworkConnect 
instance HasBodyParam NetworkConnect NetworkConnectRequest 
...
networkCreate
  ...
  => NetworkCreateRequest -- ^ "networkConfig" -  Network configuration
...
instance HasBodyParam NetworkDisconnect NetworkDisconnectRequest 
...
networkInspect0
  :: Id -- ^ "id" -  Network ID or name
  -> DockerEngineRequest NetworkInspect0 MimeNoContent NetworkInspect MimeJSON
networkInspect0 (Id id) =
  _mkRequest "GET" ["/networks/",toPath id]

data NetworkInspect0  

-- | /Optional Param/ "verbose" - Detailed inspect output for troubleshooting
instance HasOptionalParam NetworkInspect0 Verbose where
...
instance HasOptionalParam NetworkInspect0 Scope where
  applyOptionalParam req (Scope xs) =
    req `addQuery` toQuery ("scope", Just xs)
-- | @application/json@
instance Produces NetworkInspect0 MimeJSON
...
-- 
networkList
  :: DockerEngineRequest NetworkList MimeNoContent [NetworkSummary] MimeJSON
networkList =
