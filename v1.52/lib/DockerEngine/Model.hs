{-
   ...
   Docker Engine API API version: 1.52
...
-- ** Manifests
newtype Manifests = Manifests { unManifests :: Bool } deriving (P.Eq, P.Show)

-- ** MaxUsedSpace
newtype MaxUsedSpace = MaxUsedSpace { unMaxUsedSpace :: Integer } deriving (P.Eq, P.Show)
...
-- ** MinFreeSpace
newtype MinFreeSpace = MinFreeSpace { unMinFreeSpace :: Integer } deriving (P.Eq, P.Show)
...
-- ** ParamType
newtype ParamType = ParamType { unParamType :: [E'Type6] } deriving (P.Eq, P.Show)
...
-- ** Platform3
newtype Platform3 = Platform3 { unPlatform3 :: [Text] } deriving (P.Eq, P.Show)

-- ** Platforms
newtype Platforms = Platforms { unPlatforms :: [Text] } deriving (P.Eq, P.Show)
...
-- ** ReservedSpace
newtype ReservedSpace = ReservedSpace { unReservedSpace :: Integer } deriving (P.Eq, P.Show)
...
-- ** SharedSize
newtype SharedSize = SharedSize { unSharedSize :: Bool } deriving (P.Eq, P.Show)
...
-- ** Version
newtype Version = Version { unVersion :: E'CgroupVersion } deriving (P.Eq, P.Show)

-- ** VersionInt
newtype VersionInt = VersionInt { unVersionInt :: Int } deriving (P.Eq, P.Show)

-- ** VersionInteger
newtype VersionInteger = VersionInteger { unVersionInteger :: Integer } deriving (P.Eq, P.Show)
...
data AuthResponse = AuthResponse
  { authResponseStatus :: !(Text) -- ^ /Required/ "Status" - The status of the authentication
  , authResponseIdentityToken :: !(Maybe Text) -- ^ "IdentityToken" - An opaque token used to authenticate a user after a successful login
  } deriving (P.Show, P.Eq, P.Typeable)
...
instance A.ToJSON AuthResponse where
  toJSON AuthResponse {..} =
   _omitNulls
      ...
      , "IdentityToken" .= authResponseIdentityToken
      ]


-- | Construct a value of type 'AuthResponse' (by applying it's required fields, if any)
mkAuthResponse
  :: Text -- ^ 'authResponseStatus': The status of the authentication
  -> AuthResponse
mkAuthResponse authResponseStatus =
  AuthResponse
  { authResponseStatus
  , authResponseIdentityToken = Nothing
  }
...
data BuildCache = BuildCache
  ...
  , buildCacheInUse :: !(Maybe Bool) -- ^ "InUse" - Indicates if the build cache is in use. 
  , buildCacheShared :: !(Maybe Bool) -- ^ "Shared" - Indicates if the build cache is shared. 
...
data BuildCacheDiskUsage = BuildCacheDiskUsage
  { buildCacheDiskUsageActiveCount :: !(Maybe Integer) -- ^ "ActiveCount" - Count of active build cache records. 
  , buildCacheDiskUsageTotalCount :: !(Maybe Integer) -- ^ "TotalCount" - Count of all build cache records. 
  , buildCacheDiskUsageReclaimable :: !(Maybe Integer) -- ^ "Reclaimable" - Disk space that can be reclaimed by removing inactive build cache records. 
  , buildCacheDiskUsageTotalSize :: !(Maybe Integer) -- ^ "TotalSize" - Disk space in use by build cache records. 
  , buildCacheDiskUsageItems :: !(Maybe [A.Value]) -- ^ "Items" - List of build cache records. 
  } deriving (P.Show, P.Eq, P.Typeable)

-- | FromJSON BuildCacheDiskUsage
instance A.FromJSON BuildCacheDiskUsage where
  parseJSON = A.withObject "BuildCacheDiskUsage" $ \o ->
    BuildCacheDiskUsage
      <$> (o .:? "ActiveCount")
      <*> (o .:? "TotalCount")
      <*> (o .:? "Reclaimable")
...
-- | ToJSON BuildCacheDiskUsage
instance A.ToJSON BuildCacheDiskUsage where
  toJSON BuildCacheDiskUsage {..} =
   _omitNulls
      [ "ActiveCount" .= buildCacheDiskUsageActiveCount
      , "TotalCount" .= buildCacheDiskUsageTotalCount
      , "Reclaimable" .= buildCacheDiskUsageReclaimable
      , "TotalSize" .= buildCacheDiskUsageTotalSize
      , "Items" .= buildCacheDiskUsageItems
      ]


-- | Construct a value of type 'BuildCacheDiskUsage' (by applying it's required fields, if any)
mkBuildCacheDiskUsage
  :: BuildCacheDiskUsage
mkBuildCacheDiskUsage =
  BuildCacheDiskUsage
  { buildCacheDiskUsageActiveCount = Nothing
  , buildCacheDiskUsageTotalCount = Nothing
  , buildCacheDiskUsageReclaimable = Nothing
  , buildCacheDiskUsageTotalSize = Nothing
  , buildCacheDiskUsageItems = Nothing
  }
...
data ClusterVolume = ClusterVolume
  { clusterVolumeId :: !(Maybe Text) -- ^ "ID" - The Swarm ID of this volume. Because cluster volumes are Swarm objects, they have an ID, unlike non-cluster volumes. This ID can be used to refer to the Volume instead of the name. 
  , clusterVolumeVersion :: !(Maybe ObjectVersion) -- ^ "Version"
  , clusterVolumeCreatedAt :: !(Maybe Text) -- ^ "CreatedAt"
  , clusterVolumeUpdatedAt :: !(Maybe Text) -- ^ "UpdatedAt"
  , clusterVolumeSpec :: !(Maybe ClusterVolumeSpec) -- ^ "Spec"
  , clusterVolumeInfo :: !(Maybe ClusterVolumeInfo) -- ^ "Info"
  , clusterVolumePublishStatus :: !(Maybe [ClusterVolumePublishStatusInner]) -- ^ "PublishStatus" - The status of the volume as it pertains to its publishing and use on specific nodes 
  } deriving (P.Show, P.Eq, P.Typeable)

-- | FromJSON ClusterVolume
instance A.FromJSON ClusterVolume where
  parseJSON = A.withObject "ClusterVolume" $ \o ->
    ClusterVolume
      <$> (o .:? "ID")
      <*> (o .:? "Version")
      <*> (o .:? "CreatedAt")
...
-- | ToJSON ClusterVolume
instance A.ToJSON ClusterVolume where
  toJSON ClusterVolume {..} =
   _omitNulls
      [ "ID" .= clusterVolumeId
      , "Version" .= clusterVolumeVersion
      , "CreatedAt" .= clusterVolumeCreatedAt
      , "UpdatedAt" .= clusterVolumeUpdatedAt
...
-- | Construct a value of type 'ClusterVolume' (by applying it's required fields, if any)
mkClusterVolume
  :: ClusterVolume
mkClusterVolume =
  ClusterVolume
  { clusterVolumeId = Nothing
  , clusterVolumeVersion = Nothing
  , clusterVolumeCreatedAt = Nothing
  , clusterVolumeUpdatedAt = Nothing
  , clusterVolumeSpec = Nothing
  , clusterVolumeInfo = Nothing
  , clusterVolumePublishStatus = Nothing
  }
...
data ClusterVolumeInfo = ClusterVolumeInfo
  { clusterVolumeInfoCapacityBytes :: !(Maybe Integer) -- ^ "CapacityBytes" - The capacity of the volume in bytes. A value of 0 indicates that the capacity is unknown. 
  , clusterVolumeInfoVolumeContext :: !(Maybe (Map.Map String Text)) -- ^ "VolumeContext" - A map of strings to strings returned from the storage plugin when the volume is created. 
  , clusterVolumeInfoVolumeId :: !(Maybe Text) -- ^ "VolumeID" - The ID of the volume as returned by the CSI storage plugin. This is distinct from the volume&#39;s ID as provided by Docker. This ID is never used by the user when communicating with Docker to refer to this volume. If the ID is blank, then the Volume has not been successfully created in the plugin yet. 
  , clusterVolumeInfoAccessibleTopology :: !(Maybe [Map]) -- ^ "AccessibleTopology" - The topology this volume is actually accessible from. 
  } deriving (P.Show, P.Eq, P.Typeable)

-- | FromJSON ClusterVolumeInfo
instance A.FromJSON ClusterVolumeInfo where
  parseJSON = A.withObject "ClusterVolumeInfo" $ \o ->
    ClusterVolumeInfo
      <$> (o .:? "CapacityBytes")
      <*> (o .:? "VolumeContext")
      <*> (o .:? "VolumeID")
...
-- | ToJSON ClusterVolumeInfo
instance A.ToJSON ClusterVolumeInfo where
  toJSON ClusterVolumeInfo {..} =
   _omitNulls
      [ "CapacityBytes" .= clusterVolumeInfoCapacityBytes
      , "VolumeContext" .= clusterVolumeInfoVolumeContext
      , "VolumeID" .= clusterVolumeInfoVolumeId
      , "AccessibleTopology" .= clusterVolumeInfoAccessibleTopology
      ]


-- | Construct a value of type 'ClusterVolumeInfo' (by applying it's required fields, if any)
mkClusterVolumeInfo
  :: ClusterVolumeInfo
mkClusterVolumeInfo =
  ClusterVolumeInfo
  { clusterVolumeInfoCapacityBytes = Nothing
  , clusterVolumeInfoVolumeContext = Nothing
  , clusterVolumeInfoVolumeId = Nothing
  , clusterVolumeInfoAccessibleTopology = Nothing
  }

-- ** ClusterVolumePublishStatusInner
-- | ClusterVolumePublishStatusInner
data ClusterVolumePublishStatusInner = ClusterVolumePublishStatusInner
  { clusterVolumePublishStatusInnerNodeId :: !(Maybe Text) -- ^ "NodeID" - The ID of the Swarm node the volume is published on. 
  , clusterVolumePublishStatusInnerState :: !(Maybe E'State3) -- ^ "State" - The published state of the volume. * &#x60;pending-publish&#x60; The volume should be published to this node, but the call to the controller plugin to do so has not yet been successfully completed. * &#x60;published&#x60; The volume is published successfully to the node. * &#x60;pending-node-unpublish&#x60; The volume should be unpublished from the node, and the manager is awaiting confirmation from the worker that it has done so. * &#x60;pending-controller-unpublish&#x60; The volume is successfully unpublished from the node, but has not yet been successfully unpublished on the controller. 
  , clusterVolumePublishStatusInnerPublishContext :: !(Maybe (Map.Map String Text)) -- ^ "PublishContext" - A map of strings to strings returned by the CSI controller plugin when a volume is published. 
  } deriving (P.Show, P.Eq, P.Typeable)

-- | FromJSON ClusterVolumePublishStatusInner
instance A.FromJSON ClusterVolumePublishStatusInner where
  parseJSON = A.withObject "ClusterVolumePublishStatusInner" $ \o ->
    ClusterVolumePublishStatusInner
      <$> (o .:? "NodeID")
      <*> (o .:? "State")
      <*> (o .:? "PublishContext")

-- | ToJSON ClusterVolumePublishStatusInner
instance A.ToJSON ClusterVolumePublishStatusInner where
  toJSON ClusterVolumePublishStatusInner {..} =
   _omitNulls
      [ "NodeID" .= clusterVolumePublishStatusInnerNodeId
      , "State" .= clusterVolumePublishStatusInnerState
      , "PublishContext" .= clusterVolumePublishStatusInnerPublishContext
      ]


-- | Construct a value of type 'ClusterVolumePublishStatusInner' (by applying it's required fields, if any)
mkClusterVolumePublishStatusInner
  :: ClusterVolumePublishStatusInner
mkClusterVolumePublishStatusInner =
  ClusterVolumePublishStatusInner
  { clusterVolumePublishStatusInnerNodeId = Nothing
  , clusterVolumePublishStatusInnerState = Nothing
  , clusterVolumePublishStatusInnerPublishContext = Nothing
  }
...
data ClusterVolumeSpec = ClusterVolumeSpec
  { clusterVolumeSpecGroup :: !(Maybe Text) -- ^ "Group" - Group defines the volume group of this volume. Volumes belonging to the same group can be referred to by group name when creating Services.  Referring to a volume by group instructs Swarm to treat volumes in that group interchangeably for the purpose of scheduling. Volumes with an empty string for a group technically all belong to the same, emptystring group. 
  , clusterVolumeSpecAccessMode :: !(Maybe ClusterVolumeSpecAccessMode) -- ^ "AccessMode"
  } deriving (P.Show, P.Eq, P.Typeable)

-- | FromJSON ClusterVolumeSpec
instance A.FromJSON ClusterVolumeSpec where
  parseJSON = A.withObject "ClusterVolumeSpec" $ \o ->
    ClusterVolumeSpec
      <$> (o .:? "Group")
      <*> (o .:? "AccessMode")

-- | ToJSON ClusterVolumeSpec
instance A.ToJSON ClusterVolumeSpec where
  toJSON ClusterVolumeSpec {..} =
   _omitNulls
      [ "Group" .= clusterVolumeSpecGroup
      , "AccessMode" .= clusterVolumeSpecAccessMode
      ]


-- | Construct a value of type 'ClusterVolumeSpec' (by applying it's required fields, if any)
mkClusterVolumeSpec
  :: ClusterVolumeSpec
mkClusterVolumeSpec =
  ClusterVolumeSpec
  { clusterVolumeSpecGroup = Nothing
  , clusterVolumeSpecAccessMode = Nothing
  }
...
data ClusterVolumeSpecAccessMode = ClusterVolumeSpecAccessMode
  { clusterVolumeSpecAccessModeScope :: !(Maybe E'Scope3) -- ^ "Scope" - The set of nodes this volume can be used on at one time. - &#x60;single&#x60; The volume may only be scheduled to one node at a time. - &#x60;multi&#x60; the volume may be scheduled to any supported number of nodes at a time. 
  , clusterVolumeSpecAccessModeSharing :: !(Maybe E'Sharing) -- ^ "Sharing" - The number and way that different tasks can use this volume at one time. - &#x60;none&#x60; The volume may only be used by one task at a time. - &#x60;readonly&#x60; The volume may be used by any number of tasks, but they all must mount the volume as readonly - &#x60;onewriter&#x60; The volume may be used by any number of tasks, but only one may mount it as read/write. - &#x60;all&#x60; The volume may have any number of readers and writers. 
  , clusterVolumeSpecAccessModeMountVolume :: !(Maybe A.Value) -- ^ "MountVolume" - Options for using this volume as a Mount-type volume.      Either MountVolume or BlockVolume, but not both, must be     present.   properties:     FsType:       type: \&quot;string\&quot;       description: |         Specifies the filesystem type for the mount volume.         Optional.     MountFlags:       type: \&quot;array\&quot;       description: |         Flags to pass when mounting the volume. Optional.       items:         type: \&quot;string\&quot; BlockVolume:   type: \&quot;object\&quot;   description: |     Options for using this volume as a Block-type volume.     Intentionally empty. 
  , clusterVolumeSpecAccessModeSecrets :: !(Maybe [ClusterVolumeSpecAccessModeSecretsInner]) -- ^ "Secrets" - Swarm Secrets that are passed to the CSI storage plugin when operating on this volume. 
  , clusterVolumeSpecAccessModeAccessibilityRequirements :: !(Maybe ClusterVolumeSpecAccessModeAccessibilityRequirements) -- ^ "AccessibilityRequirements"
  , clusterVolumeSpecAccessModeCapacityRange :: !(Maybe ClusterVolumeSpecAccessModeCapacityRange) -- ^ "CapacityRange"
  , clusterVolumeSpecAccessModeAvailability :: !(Maybe E'Availability) -- ^ "Availability" - The availability of the volume for use in tasks. - &#x60;active&#x60; The volume is fully available for scheduling on the cluster - &#x60;pause&#x60; No new workloads should use the volume, but existing workloads are not stopped. - &#x60;drain&#x60; All workloads using this volume should be stopped and rescheduled, and no new ones should be started. 
  } deriving (P.Show, P.Eq, P.Typeable)

-- | FromJSON ClusterVolumeSpecAccessMode
instance A.FromJSON ClusterVolumeSpecAccessMode where
  parseJSON = A.withObject "ClusterVolumeSpecAccessMode" $ \o ->
    ClusterVolumeSpecAccessMode
      <$> (o .:? "Scope")
      <*> (o .:? "Sharing")
      <*> (o .:? "MountVolume")
      <*> (o .:? "Secrets")
      <*> (o .:? "AccessibilityRequirements")
      <*> (o .:? "CapacityRange")
      <*> (o .:? "Availability")

-- | ToJSON ClusterVolumeSpecAccessMode
instance A.ToJSON ClusterVolumeSpecAccessMode where
  toJSON ClusterVolumeSpecAccessMode {..} =
   _omitNulls
      [ "Scope" .= clusterVolumeSpecAccessModeScope
      , "Sharing" .= clusterVolumeSpecAccessModeSharing
      , "MountVolume" .= clusterVolumeSpecAccessModeMountVolume
      ...
      , "Availability" .= clusterVolumeSpecAccessModeAvailability
      ]


-- | Construct a value of type 'ClusterVolumeSpecAccessMode' (by applying it's required fields, if any)
mkClusterVolumeSpecAccessMode
  :: ClusterVolumeSpecAccessMode
mkClusterVolumeSpecAccessMode =
  ClusterVolumeSpecAccessMode
  { clusterVolumeSpecAccessModeScope = Nothing
  , clusterVolumeSpecAccessModeSharing = Nothing
  , clusterVolumeSpecAccessModeMountVolume = Nothing
  , clusterVolumeSpecAccessModeSecrets = Nothing
  , clusterVolumeSpecAccessModeAccessibilityRequirements = Nothing
  , clusterVolumeSpecAccessModeCapacityRange = Nothing
  , clusterVolumeSpecAccessModeAvailability = Nothing
  }
...
data ClusterVolumeSpecAccessModeAccessibilityRequirements = ClusterVolumeSpecAccessModeAccessibilityRequirements
  { clusterVolumeSpecAccessModeAccessibilityRequirementsRequisite :: !(Maybe [Map]) -- ^ "Requisite" - A list of required topologies, at least one of which the volume must be accessible from. 
  , clusterVolumeSpecAccessModeAccessibilityRequirementsPreferred :: !(Maybe [Map]) -- ^ "Preferred" - A list of topologies that the volume should attempt to be provisioned in. 
  } deriving (P.Show, P.Eq, P.Typeable)

-- | FromJSON ClusterVolumeSpecAccessModeAccessibilityRequirements
instance A.FromJSON ClusterVolumeSpecAccessModeAccessibilityRequirements where
  parseJSON = A.withObject "ClusterVolumeSpecAccessModeAccessibilityRequirements" $ \o ->
    ClusterVolumeSpecAccessModeAccessibilityRequirements
      <$> (o .:? "Requisite")
      <*> (o .:? "Preferred")

-- | ToJSON ClusterVolumeSpecAccessModeAccessibilityRequirements
instance A.ToJSON ClusterVolumeSpecAccessModeAccessibilityRequirements where
  toJSON ClusterVolumeSpecAccessModeAccessibilityRequirements {..} =
   _omitNulls
      [ "Requisite" .= clusterVolumeSpecAccessModeAccessibilityRequirementsRequisite
      , "Preferred" .= clusterVolumeSpecAccessModeAccessibilityRequirementsPreferred
      ]


-- | Construct a value of type 'ClusterVolumeSpecAccessModeAccessibilityRequirements' (by applying it's required fields, if any)
mkClusterVolumeSpecAccessModeAccessibilityRequirements
  :: ClusterVolumeSpecAccessModeAccessibilityRequirements
mkClusterVolumeSpecAccessModeAccessibilityRequirements =
  ClusterVolumeSpecAccessModeAccessibilityRequirements
  { clusterVolumeSpecAccessModeAccessibilityRequirementsRequisite = Nothing
  , clusterVolumeSpecAccessModeAccessibilityRequirementsPreferred = Nothing
  }
...
data ClusterVolumeSpecAccessModeCapacityRange = ClusterVolumeSpecAccessModeCapacityRange
  { clusterVolumeSpecAccessModeCapacityRangeRequiredBytes :: !(Maybe Integer) -- ^ "RequiredBytes" - The volume must be at least this big. The value of 0 indicates an unspecified minimum 
  , clusterVolumeSpecAccessModeCapacityRangeLimitBytes :: !(Maybe Integer) -- ^ "LimitBytes" - The volume must not be bigger than this. The value of 0 indicates an unspecified maximum. 
  } deriving (P.Show, P.Eq, P.Typeable)

-- | FromJSON ClusterVolumeSpecAccessModeCapacityRange
instance A.FromJSON ClusterVolumeSpecAccessModeCapacityRange where
  parseJSON = A.withObject "ClusterVolumeSpecAccessModeCapacityRange" $ \o ->
    ClusterVolumeSpecAccessModeCapacityRange
      <$> (o .:? "RequiredBytes")
      <*> (o .:? "LimitBytes")

-- | ToJSON ClusterVolumeSpecAccessModeCapacityRange
instance A.ToJSON ClusterVolumeSpecAccessModeCapacityRange where
  toJSON ClusterVolumeSpecAccessModeCapacityRange {..} =
   _omitNulls
      [ "RequiredBytes" .= clusterVolumeSpecAccessModeCapacityRangeRequiredBytes
      , "LimitBytes" .= clusterVolumeSpecAccessModeCapacityRangeLimitBytes
      ]


-- | Construct a value of type 'ClusterVolumeSpecAccessModeCapacityRange' (by applying it's required fields, if any)
mkClusterVolumeSpecAccessModeCapacityRange
  :: ClusterVolumeSpecAccessModeCapacityRange
mkClusterVolumeSpecAccessModeCapacityRange =
  ClusterVolumeSpecAccessModeCapacityRange
  { clusterVolumeSpecAccessModeCapacityRangeRequiredBytes = Nothing
  , clusterVolumeSpecAccessModeCapacityRangeLimitBytes = Nothing
  }
...
data ClusterVolumeSpecAccessModeSecretsInner = ClusterVolumeSpecAccessModeSecretsInner
  { clusterVolumeSpecAccessModeSecretsInnerKey :: !(Maybe Text) -- ^ "Key" - Key is the name of the key of the key-value pair passed to the plugin. 
  , clusterVolumeSpecAccessModeSecretsInnerSecret :: !(Maybe Text) -- ^ "Secret" - Secret is the swarm Secret object from which to read data. This can be a Secret name or ID. The Secret data is retrieved by swarm and used as the value of the key-value pair passed to the plugin. 
  } deriving (P.Show, P.Eq, P.Typeable)

-- | FromJSON ClusterVolumeSpecAccessModeSecretsInner
instance A.FromJSON ClusterVolumeSpecAccessModeSecretsInner where
  parseJSON = A.withObject "ClusterVolumeSpecAccessModeSecretsInner" $ \o ->
    ClusterVolumeSpecAccessModeSecretsInner
      <$> (o .:? "Key")
      <*> (o .:? "Secret")

-- | ToJSON ClusterVolumeSpecAccessModeSecretsInner
instance A.ToJSON ClusterVolumeSpecAccessModeSecretsInner where
  toJSON ClusterVolumeSpecAccessModeSecretsInner {..} =
   _omitNulls
      [ "Key" .= clusterVolumeSpecAccessModeSecretsInnerKey
      , "Secret" .= clusterVolumeSpecAccessModeSecretsInnerSecret
      ]


-- | Construct a value of type 'ClusterVolumeSpecAccessModeSecretsInner' (by applying it's required fields, if any)
mkClusterVolumeSpecAccessModeSecretsInner
  :: ClusterVolumeSpecAccessModeSecretsInner
mkClusterVolumeSpecAccessModeSecretsInner =
  ClusterVolumeSpecAccessModeSecretsInner
  { clusterVolumeSpecAccessModeSecretsInnerKey = Nothing
  , clusterVolumeSpecAccessModeSecretsInnerSecret = Nothing
  }
...
instance A.ToJSON ConfigCreateRequest where
  toJSON ConfigCreateRequest {..} =
   _omitNulls
      ...
      , "Templating" .= configCreateRequestTemplating
      ]
...
mkConfigCreateRequest =
  ...
  , configCreateRequestTemplating = Nothing
  }

-- ** ConfigReference
-- | ConfigReference
-- The config-only network source to provide the configuration for this network. 
data ConfigReference = ConfigReference
  { configReferenceNetwork :: !(Maybe Text) -- ^ "Network" - The name of the config-only network that provides the network&#39;s configuration. The specified network must be an existing config-only network. Only network names are allowed, not network IDs. 
  } deriving (P.Show, P.Eq, P.Typeable)

-- | FromJSON ConfigReference
instance A.FromJSON ConfigReference where
  parseJSON = A.withObject "ConfigReference" $ \o ->
    ConfigReference
      <$> (o .:? "Network")

-- | ToJSON ConfigReference
instance A.ToJSON ConfigReference where
  toJSON ConfigReference {..} =
   _omitNulls
      [ "Network" .= configReferenceNetwork
      ]


-- | Construct a value of type 'ConfigReference' (by applying it's required fields, if any)
mkConfigReference
  :: ConfigReference
mkConfigReference =
  ConfigReference
  { configReferenceNetwork = Nothing
  }
...
data ContainerBlkioStatEntry = ContainerBlkioStatEntry
  { containerBlkioStatEntryMajor :: !(Maybe Int) -- ^ "major"
  , containerBlkioStatEntryMinor :: !(Maybe Int) -- ^ "minor"
  , containerBlkioStatEntryOp :: !(Maybe Text) -- ^ "op"
  , containerBlkioStatEntryValue :: !(Maybe Int) -- ^ "value"
  } deriving (P.Show, P.Eq, P.Typeable)

-- | FromJSON ContainerBlkioStatEntry
instance A.FromJSON ContainerBlkioStatEntry where
  parseJSON = A.withObject "ContainerBlkioStatEntry" $ \o ->
    ContainerBlkioStatEntry
      <$> (o .:? "major")
      <*> (o .:? "minor")
      <*> (o .:? "op")
...
-- | ToJSON ContainerBlkioStatEntry
instance A.ToJSON ContainerBlkioStatEntry where
  toJSON ContainerBlkioStatEntry {..} =
   _omitNulls
      [ "major" .= containerBlkioStatEntryMajor
      , "minor" .= containerBlkioStatEntryMinor
      , "op" .= containerBlkioStatEntryOp
      , "value" .= containerBlkioStatEntryValue
      ]


-- | Construct a value of type 'ContainerBlkioStatEntry' (by applying it's required fields, if any)
mkContainerBlkioStatEntry
  :: ContainerBlkioStatEntry
mkContainerBlkioStatEntry =
  ContainerBlkioStatEntry
  { containerBlkioStatEntryMajor = Nothing
  , containerBlkioStatEntryMinor = Nothing
  , containerBlkioStatEntryOp = Nothing
  , containerBlkioStatEntryValue = Nothing
  }
...
data ContainerBlkioStats = ContainerBlkioStats
  { containerBlkioStatsIoServiceBytesRecursive :: !(Maybe [ContainerBlkioStatEntry]) -- ^ "io_service_bytes_recursive"
  , containerBlkioStatsIoServicedRecursive :: !(Maybe [ContainerBlkioStatEntry]) -- ^ "io_serviced_recursive" - This field is only available when using Linux containers with cgroups v1. It is omitted or &#x60;null&#x60; when using cgroups v2. 
  , containerBlkioStatsIoQueueRecursive :: !(Maybe [ContainerBlkioStatEntry]) -- ^ "io_queue_recursive" - This field is only available when using Linux containers with cgroups v1. It is omitted or &#x60;null&#x60; when using cgroups v2. 
  , containerBlkioStatsIoServiceTimeRecursive :: !(Maybe [ContainerBlkioStatEntry]) -- ^ "io_service_time_recursive" - This field is only available when using Linux containers with cgroups v1. It is omitted or &#x60;null&#x60; when using cgroups v2. 
  , containerBlkioStatsIoWaitTimeRecursive :: !(Maybe [ContainerBlkioStatEntry]) -- ^ "io_wait_time_recursive" - This field is only available when using Linux containers with cgroups v1. It is omitted or &#x60;null&#x60; when using cgroups v2. 
  , containerBlkioStatsIoMergedRecursive :: !(Maybe [ContainerBlkioStatEntry]) -- ^ "io_merged_recursive" - This field is only available when using Linux containers with cgroups v1. It is omitted or &#x60;null&#x60; when using cgroups v2. 
  , containerBlkioStatsIoTimeRecursive :: !(Maybe [ContainerBlkioStatEntry]) -- ^ "io_time_recursive" - This field is only available when using Linux containers with cgroups v1. It is omitted or &#x60;null&#x60; when using cgroups v2. 
  , containerBlkioStatsSectorsRecursive :: !(Maybe [ContainerBlkioStatEntry]) -- ^ "sectors_recursive" - This field is only available when using Linux containers with cgroups v1. It is omitted or &#x60;null&#x60; when using cgroups v2. 
  } deriving (P.Show, P.Eq, P.Typeable)

-- | FromJSON ContainerBlkioStats
instance A.FromJSON ContainerBlkioStats where
  parseJSON = A.withObject "ContainerBlkioStats" $ \o ->
    ContainerBlkioStats
      <$> (o .:? "io_service_bytes_recursive")
      <*> (o .:? "io_serviced_recursive")
      <*> (o .:? "io_queue_recursive")
      <*> (o .:? "io_service_time_recursive")
      <*> (o .:? "io_wait_time_recursive")
      <*> (o .:? "io_merged_recursive")
      <*> (o .:? "io_time_recursive")
      <*> (o .:? "sectors_recursive")

-- | ToJSON ContainerBlkioStats
instance A.ToJSON ContainerBlkioStats where
  toJSON ContainerBlkioStats {..} =
   _omitNulls
      [ "io_service_bytes_recursive" .= containerBlkioStatsIoServiceBytesRecursive
      , "io_serviced_recursive" .= containerBlkioStatsIoServicedRecursive
      , "io_queue_recursive" .= containerBlkioStatsIoQueueRecursive
      , "io_service_time_recursive" .= containerBlkioStatsIoServiceTimeRecursive
      , "io_wait_time_recursive" .= containerBlkioStatsIoWaitTimeRecursive
      , "io_merged_recursive" .= containerBlkioStatsIoMergedRecursive
      , "io_time_recursive" .= containerBlkioStatsIoTimeRecursive
      , "sectors_recursive" .= containerBlkioStatsSectorsRecursive
      ]


-- | Construct a value of type 'ContainerBlkioStats' (by applying it's required fields, if any)
mkContainerBlkioStats
  :: ContainerBlkioStats
mkContainerBlkioStats =
  ContainerBlkioStats
  { containerBlkioStatsIoServiceBytesRecursive = Nothing
  , containerBlkioStatsIoServicedRecursive = Nothing
  , containerBlkioStatsIoQueueRecursive = Nothing
  , containerBlkioStatsIoServiceTimeRecursive = Nothing
  , containerBlkioStatsIoWaitTimeRecursive = Nothing
  , containerBlkioStatsIoMergedRecursive = Nothing
  , containerBlkioStatsIoTimeRecursive = Nothing
  , containerBlkioStatsSectorsRecursive = Nothing
  }

-- ** ContainerCPUStats
-- | ContainerCPUStats
-- CPU related info of the container 
data ContainerCPUStats = ContainerCPUStats
  { containerCPUStatsCpuUsage :: !(Maybe ContainerCPUUsage) -- ^ "cpu_usage"
  , containerCPUStatsSystemCpuUsage :: !(Maybe Int) -- ^ "system_cpu_usage" - System Usage.  This field is Linux-specific and omitted for Windows containers. 
  , containerCPUStatsOnlineCpus :: !(Maybe Int) -- ^ "online_cpus" - Number of online CPUs.  This field is Linux-specific and omitted for Windows containers. 
  , containerCPUStatsThrottlingData :: !(Maybe ContainerThrottlingData) -- ^ "throttling_data"
  } deriving (P.Show, P.Eq, P.Typeable)

-- | FromJSON ContainerCPUStats
instance A.FromJSON ContainerCPUStats where
  parseJSON = A.withObject "ContainerCPUStats" $ \o ->
    ContainerCPUStats
      <$> (o .:? "cpu_usage")
      <*> (o .:? "system_cpu_usage")
      <*> (o .:? "online_cpus")
...
-- | ToJSON ContainerCPUStats
instance A.ToJSON ContainerCPUStats where
  toJSON ContainerCPUStats {..} =
   _omitNulls
      [ "cpu_usage" .= containerCPUStatsCpuUsage
      , "system_cpu_usage" .= containerCPUStatsSystemCpuUsage
      , "online_cpus" .= containerCPUStatsOnlineCpus
      , "throttling_data" .= containerCPUStatsThrottlingData
      ]


-- | Construct a value of type 'ContainerCPUStats' (by applying it's required fields, if any)
mkContainerCPUStats
  :: ContainerCPUStats
mkContainerCPUStats =
  ContainerCPUStats
  { containerCPUStatsCpuUsage = Nothing
  , containerCPUStatsSystemCpuUsage = Nothing
  , containerCPUStatsOnlineCpus = Nothing
  , containerCPUStatsThrottlingData = Nothing
  }

-- ** ContainerCPUUsage
-- | ContainerCPUUsage
-- All CPU stats aggregated since container inception. 
data ContainerCPUUsage = ContainerCPUUsage
  { containerCPUUsageTotalUsage :: !(Maybe Int) -- ^ "total_usage" - Total CPU time consumed in nanoseconds (Linux) or 100&#39;s of nanoseconds (Windows). 
  , containerCPUUsagePercpuUsage :: !(Maybe [Int]) -- ^ "percpu_usage" - Total CPU time (in nanoseconds) consumed per core (Linux).  This field is Linux-specific when using cgroups v1. It is omitted when using cgroups v2 and Windows containers. 
  , containerCPUUsageUsageInKernelmode :: !(Maybe Int) -- ^ "usage_in_kernelmode" - Time (in nanoseconds) spent by tasks of the cgroup in kernel mode (Linux), or time spent (in 100&#39;s of nanoseconds) by all container processes in kernel mode (Windows).  Not populated for Windows containers using Hyper-V isolation. 
  , containerCPUUsageUsageInUsermode :: !(Maybe Int) -- ^ "usage_in_usermode" - Time (in nanoseconds) spent by tasks of the cgroup in user mode (Linux), or time spent (in 100&#39;s of nanoseconds) by all container processes in kernel mode (Windows).  Not populated for Windows containers using Hyper-V isolation. 
  } deriving (P.Show, P.Eq, P.Typeable)

-- | FromJSON ContainerCPUUsage
instance A.FromJSON ContainerCPUUsage where
  parseJSON = A.withObject "ContainerCPUUsage" $ \o ->
    ContainerCPUUsage
      <$> (o .:? "total_usage")
      <*> (o .:? "percpu_usage")
...
-- | ToJSON ContainerCPUUsage
instance A.ToJSON ContainerCPUUsage where
  toJSON ContainerCPUUsage {..} =
   _omitNulls
      [ "total_usage" .= containerCPUUsageTotalUsage
      , "percpu_usage" .= containerCPUUsagePercpuUsage
      , "usage_in_kernelmode" .= containerCPUUsageUsageInKernelmode
      , "usage_in_usermode" .= containerCPUUsageUsageInUsermode
      ]


-- | Construct a value of type 'ContainerCPUUsage' (by applying it's required fields, if any)
mkContainerCPUUsage
  :: ContainerCPUUsage
mkContainerCPUUsage =
  ContainerCPUUsage
  { containerCPUUsageTotalUsage = Nothing
  , containerCPUUsagePercpuUsage = Nothing
  , containerCPUUsageUsageInKernelmode = Nothing
  , containerCPUUsageUsageInUsermode = Nothing
  }
...
data ContainerConfig = ContainerConfig
  ...
  , containerConfigUser :: !(Maybe Text) -- ^ "User" - Commands run as this user inside the container. If omitted, commands run as the user specified in the image the container was started from.  Can be either user-name or UID, and optional group-name or GID, separated by a colon (&#x60;&lt;user-name|UID&gt;[&lt;:group-name|GID&gt;]&#x60;).
...
data ContainerCreateRequest = ContainerCreateRequest
  ...
  , containerCreateRequestUser :: !(Maybe Text) -- ^ "User" - Commands run as this user inside the container. If omitted, commands run as the user specified in the image the container was started from.  Can be either user-name or UID, and optional group-name or GID, separated by a colon (&#x60;&lt;user-name|UID&gt;[&lt;:group-name|GID&gt;]&#x60;).
  ...
  , containerCreateRequestExposedPorts :: !(Maybe (Map.Map String A.Value)) -- ^ "ExposedPorts" - An object mapping ports to an empty object in the form:  &#x60;{\&quot;&lt;port&gt;/&lt;tcp|udp|sctp&gt;\&quot;: {}}&#x60; 
  ...
  , containerCreateRequestImage :: !(Maybe Text) -- ^ "Image" - The name (or reference) of the image to use when creating the container, or which was used when the container was created. 
  , containerCreateRequestVolumes :: !(Maybe (Map.Map String A.Value)) -- ^ "Volumes" - An object mapping mount point paths inside the container to empty objects. 
  ...
  , containerCreateRequestNetworkingConfig :: !(Maybe NetworkingConfig) -- ^ "NetworkingConfig"
  } deriving (P.Show, P.Eq, P.Typeable)
...
data ContainerInspectResponse = ContainerInspectResponse
  { containerInspectResponseId :: !(Maybe Text) -- ^ "Id" - The ID of this container as a 128-bit (64-character) hexadecimal string (32 bytes).
  , containerInspectResponseCreated :: !(Maybe Text) -- ^ "Created" - Date and time at which the container was created, formatted in [RFC 3339](https://www.ietf.org/rfc/rfc3339.txt) format with nano-seconds.
  ...
  , containerInspectResponseImage :: !(Maybe Text) -- ^ "Image" - The ID (digest) of the image that this container was created from.
  , containerInspectResponseResolvConfPath :: !(Maybe Text) -- ^ "ResolvConfPath" - Location of the &#x60;/etc/resolv.conf&#x60; generated for the container on the host.  This file is managed through the docker daemon, and should not be accessed or modified by other tools.
  , containerInspectResponseHostnamePath :: !(Maybe Text) -- ^ "HostnamePath" - Location of the &#x60;/etc/hostname&#x60; generated for the container on the host.  This file is managed through the docker daemon, and should not be accessed or modified by other tools.
  , containerInspectResponseHostsPath :: !(Maybe Text) -- ^ "HostsPath" - Location of the &#x60;/etc/hosts&#x60; generated for the container on the host.  This file is managed through the docker daemon, and should not be accessed or modified by other tools.
  , containerInspectResponseLogPath :: !(Maybe Text) -- ^ "LogPath" - Location of the file used to buffer the container&#39;s logs. Depending on the logging-driver used for the container, this field may be omitted.  This file is managed through the docker daemon, and should not be accessed or modified by other tools.
  , containerInspectResponseName :: !(Maybe Text) -- ^ "Name" - The name associated with this container.  For historic reasons, the name may be prefixed with a forward-slash (&#x60;/&#x60;).
  , containerInspectResponseRestartCount :: !(Maybe Int) -- ^ "RestartCount" - Number of times the container was restarted since it was created, or since daemon was started.
  , containerInspectResponseDriver :: !(Maybe Text) -- ^ "Driver" - The storage-driver used for the container&#39;s filesystem (graph-driver or snapshotter).
  , containerInspectResponsePlatform :: !(Maybe Text) -- ^ "Platform" - The platform (operating system) for which the container was created.  This field was introduced for the experimental \&quot;LCOW\&quot; (Linux Containers On Windows) features, which has been removed. In most cases, this field is equal to the host&#39;s operating system (&#x60;linux&#x60; or &#x60;windows&#x60;).
  , containerInspectResponseImageManifestDescriptor :: !(Maybe OCIDescriptor) -- ^ "ImageManifestDescriptor"
  , containerInspectResponseMountLabel :: !(Maybe Text) -- ^ "MountLabel" - SELinux mount label set for the container.
  , containerInspectResponseProcessLabel :: !(Maybe Text) -- ^ "ProcessLabel" - SELinux process label set for the container.
  , containerInspectResponseAppArmorProfile :: !(Maybe Text) -- ^ "AppArmorProfile" - The AppArmor profile set for the container.
  ...
  , containerInspectResponseGraphDriver :: !(Maybe DriverData) -- ^ "GraphDriver"
  , containerInspectResponseStorage :: !(Maybe Storage) -- ^ "Storage"
  , containerInspectResponseSizeRw :: !(Maybe Integer) -- ^ "SizeRw" - The size of files that have been created or changed by this container.  This field is omitted by default, and only set when size is requested in the API request.
  , containerInspectResponseSizeRootFs :: !(Maybe Integer) -- ^ "SizeRootFs" - The total size of all files in the read-only layers from the image that the container uses. These layers can be shared between containers.  This field is omitted by default, and only set when size is requested in the API request.
  , containerInspectResponseMounts :: !(Maybe [MountPoint]) -- ^ "Mounts" - List of mounts used by the container.
...
instance A.ToJSON ContainerInspectResponse where
  toJSON ContainerInspectResponse {..} =
   _omitNulls
      ...
      , "ImageManifestDescriptor" .= containerInspectResponseImageManifestDescriptor
      ...
      , "Storage" .= containerInspectResponseStorage
...
mkContainerInspectResponse =
  ...
  , containerInspectResponseImageManifestDescriptor = Nothing
  ...
  , containerInspectResponseStorage = Nothing
...
data ContainerMemoryStats = ContainerMemoryStats
  { containerMemoryStatsUsage :: !(Maybe Int) -- ^ "usage" - Current &#x60;res_counter&#x60; usage for memory.  This field is Linux-specific and omitted for Windows containers. 
  , containerMemoryStatsMaxUsage :: !(Maybe Int) -- ^ "max_usage" - Maximum usage ever recorded.  This field is Linux-specific and only supported on cgroups v1. It is omitted when using cgroups v2 and for Windows containers. 
  , containerMemoryStatsStats :: !(Maybe (Map.Map String Int)) -- ^ "stats" - All the stats exported via memory.stat. when using cgroups v2.  This field is Linux-specific and omitted for Windows containers. 
  , containerMemoryStatsFailcnt :: !(Maybe Int) -- ^ "failcnt" - Number of times memory usage hits limits.  This field is Linux-specific and only supported on cgroups v1. It is omitted when using cgroups v2 and for Windows containers. 
  , containerMemoryStatsLimit :: !(Maybe Int) -- ^ "limit" - This field is Linux-specific and omitted for Windows containers. 
  , containerMemoryStatsCommitbytes :: !(Maybe Int) -- ^ "commitbytes" - Committed bytes.  This field is Windows-specific and omitted for Linux containers. 
  , containerMemoryStatsCommitpeakbytes :: !(Maybe Int) -- ^ "commitpeakbytes" - Peak committed bytes.  This field is Windows-specific and omitted for Linux containers. 
  , containerMemoryStatsPrivateworkingset :: !(Maybe Int) -- ^ "privateworkingset" - Private working set.  This field is Windows-specific and omitted for Linux containers. 
  } deriving (P.Show, P.Eq, P.Typeable)

-- | FromJSON ContainerMemoryStats
instance A.FromJSON ContainerMemoryStats where
  parseJSON = A.withObject "ContainerMemoryStats" $ \o ->
    ContainerMemoryStats
      <$> (o .:? "usage")
      <*> (o .:? "max_usage")
      <*> (o .:? "stats")
...
-- | ToJSON ContainerMemoryStats
instance A.ToJSON ContainerMemoryStats where
  toJSON ContainerMemoryStats {..} =
   _omitNulls
      [ "usage" .= containerMemoryStatsUsage
      , "max_usage" .= containerMemoryStatsMaxUsage
      , "stats" .= containerMemoryStatsStats
      , "failcnt" .= containerMemoryStatsFailcnt
      , "limit" .= containerMemoryStatsLimit
      , "commitbytes" .= containerMemoryStatsCommitbytes
      , "commitpeakbytes" .= containerMemoryStatsCommitpeakbytes
      , "privateworkingset" .= containerMemoryStatsPrivateworkingset
      ]


-- | Construct a value of type 'ContainerMemoryStats' (by applying it's required fields, if any)
mkContainerMemoryStats
  :: ContainerMemoryStats
mkContainerMemoryStats =
  ContainerMemoryStats
  { containerMemoryStatsUsage = Nothing
  , containerMemoryStatsMaxUsage = Nothing
  , containerMemoryStatsStats = Nothing
  , containerMemoryStatsFailcnt = Nothing
  , containerMemoryStatsLimit = Nothing
  , containerMemoryStatsCommitbytes = Nothing
  , containerMemoryStatsCommitpeakbytes = Nothing
  , containerMemoryStatsPrivateworkingset = Nothing
  }

-- ** ContainerNetworkStats
-- | ContainerNetworkStats
-- Aggregates the network stats of one container 
data ContainerNetworkStats = ContainerNetworkStats
  { containerNetworkStatsRxBytes :: !(Maybe Int) -- ^ "rx_bytes" - Bytes received. Windows and Linux. 
  , containerNetworkStatsRxPackets :: !(Maybe Int) -- ^ "rx_packets" - Packets received. Windows and Linux. 
  , containerNetworkStatsRxErrors :: !(Maybe Int) -- ^ "rx_errors" - Received errors. Not used on Windows.  This field is Linux-specific and always zero for Windows containers. 
  , containerNetworkStatsRxDropped :: !(Maybe Int) -- ^ "rx_dropped" - Incoming packets dropped. Windows and Linux. 
  , containerNetworkStatsTxBytes :: !(Maybe Int) -- ^ "tx_bytes" - Bytes sent. Windows and Linux. 
  , containerNetworkStatsTxPackets :: !(Maybe Int) -- ^ "tx_packets" - Packets sent. Windows and Linux. 
  , containerNetworkStatsTxErrors :: !(Maybe Int) -- ^ "tx_errors" - Sent errors. Not used on Windows.  This field is Linux-specific and always zero for Windows containers. 
  , containerNetworkStatsTxDropped :: !(Maybe Int) -- ^ "tx_dropped" - Outgoing packets dropped. Windows and Linux. 
  , containerNetworkStatsEndpointId :: !(Maybe Text) -- ^ "endpoint_id" - Endpoint ID. Not used on Linux.  This field is Windows-specific and omitted for Linux containers. 
  , containerNetworkStatsInstanceId :: !(Maybe Text) -- ^ "instance_id" - Instance ID. Not used on Linux.  This field is Windows-specific and omitted for Linux containers. 
  } deriving (P.Show, P.Eq, P.Typeable)

-- | FromJSON ContainerNetworkStats
instance A.FromJSON ContainerNetworkStats where
  parseJSON = A.withObject "ContainerNetworkStats" $ \o ->
    ContainerNetworkStats
      <$> (o .:? "rx_bytes")
      <*> (o .:? "rx_packets")
      <*> (o .:? "rx_errors")
...
-- | ToJSON ContainerNetworkStats
instance A.ToJSON ContainerNetworkStats where
  toJSON ContainerNetworkStats {..} =
   _omitNulls
      [ "rx_bytes" .= containerNetworkStatsRxBytes
      , "rx_packets" .= containerNetworkStatsRxPackets
      , "rx_errors" .= containerNetworkStatsRxErrors
      , "rx_dropped" .= containerNetworkStatsRxDropped
      , "tx_bytes" .= containerNetworkStatsTxBytes
      , "tx_packets" .= containerNetworkStatsTxPackets
      , "tx_errors" .= containerNetworkStatsTxErrors
      , "tx_dropped" .= containerNetworkStatsTxDropped
      , "endpoint_id" .= containerNetworkStatsEndpointId
      , "instance_id" .= containerNetworkStatsInstanceId
      ]


-- | Construct a value of type 'ContainerNetworkStats' (by applying it's required fields, if any)
mkContainerNetworkStats
  :: ContainerNetworkStats
mkContainerNetworkStats =
  ContainerNetworkStats
  { containerNetworkStatsRxBytes = Nothing
  , containerNetworkStatsRxPackets = Nothing
  , containerNetworkStatsRxErrors = Nothing
  , containerNetworkStatsRxDropped = Nothing
  , containerNetworkStatsTxBytes = Nothing
  , containerNetworkStatsTxPackets = Nothing
  , containerNetworkStatsTxErrors = Nothing
  , containerNetworkStatsTxDropped = Nothing
  , containerNetworkStatsEndpointId = Nothing
  , containerNetworkStatsInstanceId = Nothing
  }
...
data ContainerPidsStats = ContainerPidsStats
  { containerPidsStatsCurrent :: !(Maybe Int) -- ^ "current" - Current is the number of PIDs in the cgroup. 
  , containerPidsStatsLimit :: !(Maybe Int) -- ^ "limit" - Limit is the hard limit on the number of pids in the cgroup. A \&quot;Limit\&quot; of 0 means that there is no limit. 
  } deriving (P.Show, P.Eq, P.Typeable)

-- | FromJSON ContainerPidsStats
instance A.FromJSON ContainerPidsStats where
  parseJSON = A.withObject "ContainerPidsStats" $ \o ->
    ContainerPidsStats
      <$> (o .:? "current")
      <*> (o .:? "limit")

-- | ToJSON ContainerPidsStats
instance A.ToJSON ContainerPidsStats where
  toJSON ContainerPidsStats {..} =
   _omitNulls
      [ "current" .= containerPidsStatsCurrent
      , "limit" .= containerPidsStatsLimit
      ]


-- | Construct a value of type 'ContainerPidsStats' (by applying it's required fields, if any)
mkContainerPidsStats
  :: ContainerPidsStats
mkContainerPidsStats =
  ContainerPidsStats
  { containerPidsStatsCurrent = Nothing
  , containerPidsStatsLimit = Nothing
  }
...
data ContainerState = ContainerState
  ...
  , containerStateOomKilled :: !(Maybe Bool) -- ^ "OOMKilled" - Whether a process within this container has been killed because it ran out of memory since the container was last started. 
...
data ContainerStatsResponse = ContainerStatsResponse
  { containerStatsResponseId :: !(Maybe Text) -- ^ "id" - ID of the container for which the stats were collected. 
  , containerStatsResponseName :: !(Maybe Text) -- ^ "name" - Name of the container for which the stats were collected. 
  , containerStatsResponseOsType :: !(Maybe Text) -- ^ "os_type" - OSType is the OS of the container (\&quot;linux\&quot; or \&quot;windows\&quot;) to allow platform-specific handling of stats. 
  , containerStatsResponseRead :: !(Maybe DateTime) -- ^ "read" - Date and time at which this sample was collected. The value is formatted as [RFC 3339](https://www.ietf.org/rfc/rfc3339.txt) with nano-seconds. 
  , containerStatsResponseCpuStats :: !(Maybe ContainerCPUStats) -- ^ "cpu_stats"
  , containerStatsResponseMemoryStats :: !(Maybe ContainerMemoryStats) -- ^ "memory_stats"
  , containerStatsResponseNetworks :: !(Maybe A.Value) -- ^ "networks" - Network statistics for the container per interface.  This field is omitted if the container has no networking enabled. 
  , containerStatsResponsePidsStats :: !(Maybe ContainerPidsStats) -- ^ "pids_stats"
  , containerStatsResponseBlkioStats :: !(Maybe ContainerBlkioStats) -- ^ "blkio_stats"
  , containerStatsResponseNumProcs :: !(Maybe Int) -- ^ "num_procs" - The number of processors on the system.  This field is Windows-specific and always zero for Linux containers. 
  , containerStatsResponseStorageStats :: !(Maybe ContainerStorageStats) -- ^ "storage_stats"
  , containerStatsResponsePreread :: !(Maybe DateTime) -- ^ "preread" - Date and time at which this first sample was collected. This field is not propagated if the \&quot;one-shot\&quot; option is set. If the \&quot;one-shot\&quot; option is set, this field may be omitted, empty, or set to a default date (&#x60;0001-01-01T00:00:00Z&#x60;).  The value is formatted as [RFC 3339](https://www.ietf.org/rfc/rfc3339.txt) with nano-seconds. 
  , containerStatsResponsePrecpuStats :: !(Maybe ContainerCPUStats) -- ^ "precpu_stats"
  } deriving (P.Show, P.Eq, P.Typeable)
...
instance A.ToJSON ContainerStatsResponse where
  toJSON ContainerStatsResponse {..} =
   _omitNulls
      [ "id" .= containerStatsResponseId
      , "name" .= containerStatsResponseName
      , "os_type" .= containerStatsResponseOsType
      , "read" .= containerStatsResponseRead
      ...
      , "num_procs" .= containerStatsResponseNumProcs
      , "storage_stats" .= containerStatsResponseStorageStats
      , "preread" .= containerStatsResponsePreread
...
mkContainerStatsResponse =
  ContainerStatsResponse
  { containerStatsResponseId = Nothing
  , containerStatsResponseName = Nothing
  , containerStatsResponseOsType = Nothing
  , containerStatsResponseRead = Nothing
  ...
  , containerStatsResponseNumProcs = Nothing
  , containerStatsResponseStorageStats = Nothing
  , containerStatsResponsePreread = Nothing
...
data ContainerStatus = ContainerStatus
  { containerStatusContainerId :: !(Maybe Text) -- ^ "ContainerID"
  , containerStatusPid :: !(Maybe Int) -- ^ "PID"
  , containerStatusExitCode :: !(Maybe Int) -- ^ "ExitCode"
  } deriving (P.Show, P.Eq, P.Typeable)

-- | FromJSON ContainerStatus
instance A.FromJSON ContainerStatus where
  parseJSON = A.withObject "ContainerStatus" $ \o ->
    ContainerStatus
      <$> (o .:? "ContainerID")
      <*> (o .:? "PID")
      <*> (o .:? "ExitCode")
...
instance A.ToJSON ContainerStatus where
  toJSON ContainerStatus {..} =
   _omitNulls
      [ "ContainerID" .= containerStatusContainerId
      , "PID" .= containerStatusPid
      , "ExitCode" .= containerStatusExitCode
      ]


-- | Construct a value of type 'ContainerStatus' (by applying it's required fields, if any)
mkContainerStatus
  :: ContainerStatus
mkContainerStatus =
  ContainerStatus
  { containerStatusContainerId = Nothing
  , containerStatusPid = Nothing
  , containerStatusExitCode = Nothing
  }
...
data ContainerStorageStats = ContainerStorageStats
  { containerStorageStatsReadCountNormalized :: !(Maybe Int) -- ^ "read_count_normalized"
  , containerStorageStatsReadSizeBytes :: !(Maybe Int) -- ^ "read_size_bytes"
  , containerStorageStatsWriteCountNormalized :: !(Maybe Int) -- ^ "write_count_normalized"
  , containerStorageStatsWriteSizeBytes :: !(Maybe Int) -- ^ "write_size_bytes"
  } deriving (P.Show, P.Eq, P.Typeable)

-- | FromJSON ContainerStorageStats
instance A.FromJSON ContainerStorageStats where
  parseJSON = A.withObject "ContainerStorageStats" $ \o ->
    ContainerStorageStats
      <$> (o .:? "read_count_normalized")
      <*> (o .:? "read_size_bytes")
      <*> (o .:? "write_count_normalized")
      <*> (o .:? "write_size_bytes")

-- | ToJSON ContainerStorageStats
instance A.ToJSON ContainerStorageStats where
  toJSON ContainerStorageStats {..} =
   _omitNulls
      [ "read_count_normalized" .= containerStorageStatsReadCountNormalized
      , "read_size_bytes" .= containerStorageStatsReadSizeBytes
      , "write_count_normalized" .= containerStorageStatsWriteCountNormalized
      , "write_size_bytes" .= containerStorageStatsWriteSizeBytes
      ]


-- | Construct a value of type 'ContainerStorageStats' (by applying it's required fields, if any)
mkContainerStorageStats
  :: ContainerStorageStats
mkContainerStorageStats =
  ContainerStorageStats
  { containerStorageStatsReadCountNormalized = Nothing
  , containerStorageStatsReadSizeBytes = Nothing
  , containerStorageStatsWriteCountNormalized = Nothing
  , containerStorageStatsWriteSizeBytes = Nothing
  }

-- ** ContainerSummary
-- | ContainerSummary
data ContainerSummary = ContainerSummary
  { containerSummaryId :: !(Maybe Text) -- ^ "Id" - The ID of this container as a 128-bit (64-character) hexadecimal string (32 bytes).
  , containerSummaryNames :: !(Maybe [Text]) -- ^ "Names" - The names associated with this container. Most containers have a single name, but when using legacy \&quot;links\&quot;, the container can have multiple names.  For historic reasons, names are prefixed with a forward-slash (&#x60;/&#x60;).
  , containerSummaryImage :: !(Maybe Text) -- ^ "Image" - The name or ID of the image used to create the container.  This field shows the image reference as was specified when creating the container, which can be in its canonical form (e.g., &#x60;docker.io/library/ubuntu:latest&#x60; or &#x60;docker.io/library/ubuntu@sha256:72297848456d5d37d1262630108ab308d3e9ec7ed1c3286a32fe09856619a782&#x60;), short form (e.g., &#x60;ubuntu:latest&#x60;)), or the ID(-prefix) of the image (e.g., &#x60;72297848456d&#x60;).  The content of this field can be updated at runtime if the image used to create the container is untagged, in which case the field is updated to contain the the image ID (digest) it was resolved to in its canonical, non-truncated form (e.g., &#x60;sha256:72297848456d5d37d1262630108ab308d3e9ec7ed1c3286a32fe09856619a782&#x60;).
  , containerSummaryImageId :: !(Maybe Text) -- ^ "ImageID" - The ID (digest) of the image that this container was created from.
  , containerSummaryImageManifestDescriptor :: !(Maybe OCIDescriptor) -- ^ "ImageManifestDescriptor"
  , containerSummaryCommand :: !(Maybe Text) -- ^ "Command" - Command to run when starting the container
  , containerSummaryCreated :: !(Maybe Integer) -- ^ "Created" - Date and time at which the container was created as a Unix timestamp (number of seconds since EPOCH).
  , containerSummaryPorts :: !(Maybe [PortSummary]) -- ^ "Ports" - Port-mappings for the container.
  , containerSummarySizeRw :: !(Maybe Integer) -- ^ "SizeRw" - The size of files that have been created or changed by this container.  This field is omitted by default, and only set when size is requested in the API request.
  , containerSummarySizeRootFs :: !(Maybe Integer) -- ^ "SizeRootFs" - The total size of all files in the read-only layers from the image that the container uses. These layers can be shared between containers.  This field is omitted by default, and only set when size is requested in the API request.
  , containerSummaryLabels :: !(Maybe (Map.Map String Text)) -- ^ "Labels" - User-defined key/value metadata.
  , containerSummaryState :: !(Maybe E'State) -- ^ "State" - The state of this container. 
  ...
  , containerSummaryMounts :: !(Maybe [MountPoint]) -- ^ "Mounts" - List of mounts used by the container.
  , containerSummaryHealth :: !(Maybe ContainerSummaryHealth) -- ^ "Health"
  } deriving (P.Show, P.Eq, P.Typeable)
...
instance A.ToJSON ContainerSummary where
  toJSON ContainerSummary {..} =
   _omitNulls
      ...
      , "ImageManifestDescriptor" .= containerSummaryImageManifestDescriptor
...
mkContainerSummary =
  ...
  , containerSummaryImageManifestDescriptor = Nothing
  ...
  , containerSummaryHealth = Nothing
  }
...
data ContainerSummaryHealth = ContainerSummaryHealth
  { containerSummaryHealthStatus :: !(Maybe E'Status) -- ^ "Status" - the health status of the container
  , containerSummaryHealthFailingStreak :: !(Maybe Int) -- ^ "FailingStreak" - FailingStreak is the number of consecutive failures
  } deriving (P.Show, P.Eq, P.Typeable)

-- | FromJSON ContainerSummaryHealth
instance A.FromJSON ContainerSummaryHealth where
  parseJSON = A.withObject "ContainerSummaryHealth" $ \o ->
    ContainerSummaryHealth
      <$> (o .:? "Status")
      <*> (o .:? "FailingStreak")

-- | ToJSON ContainerSummaryHealth
instance A.ToJSON ContainerSummaryHealth where
  toJSON ContainerSummaryHealth {..} =
   _omitNulls
      [ "Status" .= containerSummaryHealthStatus
      , "FailingStreak" .= containerSummaryHealthFailingStreak
      ]


-- | Construct a value of type 'ContainerSummaryHealth' (by applying it's required fields, if any)
mkContainerSummaryHealth
  :: ContainerSummaryHealth
mkContainerSummaryHealth =
  ContainerSummaryHealth
  { containerSummaryHealthStatus = Nothing
  , containerSummaryHealthFailingStreak = Nothing
  }
...
data ContainerSummaryHostConfig = ContainerSummaryHostConfig
  { containerSummaryHostConfigNetworkMode :: !(Maybe Text) -- ^ "NetworkMode" - Networking mode (&#x60;host&#x60;, &#x60;none&#x60;, &#x60;container:&lt;id&gt;&#x60;) or name of the primary network the container is using.  This field is primarily for backward compatibility. The container can be connected to multiple networks for which information can be found in the &#x60;NetworkSettings.Networks&#x60; field, which enumerates settings per network.
  , containerSummaryHostConfigAnnotations :: !(Maybe (Map.Map String Text)) -- ^ "Annotations" - Arbitrary key-value metadata attached to the container.
  } deriving (P.Show, P.Eq, P.Typeable)
...
instance A.ToJSON ContainerSummaryHostConfig where
  toJSON ContainerSummaryHostConfig {..} =
   _omitNulls
      ...
      , "Annotations" .= containerSummaryHostConfigAnnotations
      ]
...
mkContainerSummaryHostConfig =
  ...
  , containerSummaryHostConfigAnnotations = Nothing
  }
...
data ContainerSummaryNetworkSettings = ContainerSummaryNetworkSettings
  { containerSummaryNetworkSettingsNetworks :: !(Maybe (Map.Map String EndpointSettings)) -- ^ "Networks" - Summary of network-settings for each network the container is attached to.
  } deriving (P.Show, P.Eq, P.Typeable)
...
data ContainerThrottlingData = ContainerThrottlingData
  { containerThrottlingDataPeriods :: !(Maybe Int) -- ^ "periods" - Number of periods with throttling active. 
  , containerThrottlingDataThrottledPeriods :: !(Maybe Int) -- ^ "throttled_periods" - Number of periods when the container hit its throttling limit. 
  , containerThrottlingDataThrottledTime :: !(Maybe Int) -- ^ "throttled_time" - Aggregated time (in nanoseconds) the container was throttled for. 
  } deriving (P.Show, P.Eq, P.Typeable)

-- | FromJSON ContainerThrottlingData
instance A.FromJSON ContainerThrottlingData where
  parseJSON = A.withObject "ContainerThrottlingData" $ \o ->
    ContainerThrottlingData
      <$> (o .:? "periods")
      <*> (o .:? "throttled_periods")
      <*> (o .:? "throttled_time")

-- | ToJSON ContainerThrottlingData
instance A.ToJSON ContainerThrottlingData where
  toJSON ContainerThrottlingData {..} =
   _omitNulls
      [ "periods" .= containerThrottlingDataPeriods
      , "throttled_periods" .= containerThrottlingDataThrottledPeriods
      , "throttled_time" .= containerThrottlingDataThrottledTime
      ]


-- | Construct a value of type 'ContainerThrottlingData' (by applying it's required fields, if any)
mkContainerThrottlingData
  :: ContainerThrottlingData
mkContainerThrottlingData =
  ContainerThrottlingData
  { containerThrottlingDataPeriods = Nothing
  , containerThrottlingDataThrottledPeriods = Nothing
  , containerThrottlingDataThrottledTime = Nothing
  }
...
data ContainerTopResponse = ContainerTopResponse
  ...
  , containerTopResponseProcesses :: !(Maybe [[Text]]) -- ^ "Processes" - Each process running in the container, where each process is an array of values corresponding to the titles.
  } deriving (P.Show, P.Eq, P.Typeable)
...
data ContainerUpdateRequest = ContainerUpdateRequest
  ...
  , containerUpdateRequestDeviceRequests :: !(Maybe [DeviceRequest]) -- ^ "DeviceRequests" - A list of requests for devices to be sent to device drivers. 
  ...
  , containerUpdateRequestInit :: !(Maybe Bool) -- ^ "Init" - Run an init inside the container that forwards signals and reaps processes. This field is omitted if empty, and the default (as configured on the daemon) is used. 
  , containerUpdateRequestPidsLimit :: !(Maybe Integer) -- ^ "PidsLimit" - Tune a container&#39;s PIDs limit. Set &#x60;0&#x60; or &#x60;-1&#x60; for unlimited, or &#x60;null&#x60; to not change. 
...
instance A.ToJSON ContainerUpdateRequest where
  toJSON ContainerUpdateRequest {..} =
   _omitNulls
      ...
      , "DeviceRequests" .= containerUpdateRequestDeviceRequests
      ...
      , "Init" .= containerUpdateRequestInit
...
mkContainerUpdateRequest =
  ...
  , containerUpdateRequestDeviceRequests = Nothing
  ...
  , containerUpdateRequestInit = Nothing
...
data ContainerUpdateResponse = ContainerUpdateResponse
  { containerUpdateResponseWarnings :: !(Maybe [Text]) -- ^ "Warnings" - Warnings encountered when updating the container.
  } deriving (P.Show, P.Eq, P.Typeable)
...
data ContainerWaitResponse = ContainerWaitResponse
  { containerWaitResponseStatusCode :: !(Integer) -- ^ /Required/ "StatusCode" - Exit code of the container
  , containerWaitResponseError :: !(Maybe ContainerWaitExitError) -- ^ "Error"
  } deriving (P.Show, P.Eq, P.Typeable)
...
mkContainerWaitResponse
  :: Integer -- ^ 'containerWaitResponseStatusCode': Exit code of the container
  -> ContainerWaitResponse
...
data ContainerdInfo = ContainerdInfo
  { containerdInfoAddress :: !(Maybe Text) -- ^ "Address" - The address of the containerd socket.
  , containerdInfoNamespaces :: !(Maybe ContainerdInfoNamespaces) -- ^ "Namespaces"
  } deriving (P.Show, P.Eq, P.Typeable)

-- | FromJSON ContainerdInfo
instance A.FromJSON ContainerdInfo where
  parseJSON = A.withObject "ContainerdInfo" $ \o ->
    ContainerdInfo
      <$> (o .:? "Address")
      <*> (o .:? "Namespaces")

-- | ToJSON ContainerdInfo
instance A.ToJSON ContainerdInfo where
  toJSON ContainerdInfo {..} =
   _omitNulls
      [ "Address" .= containerdInfoAddress
      , "Namespaces" .= containerdInfoNamespaces
      ]


-- | Construct a value of type 'ContainerdInfo' (by applying it's required fields, if any)
mkContainerdInfo
  :: ContainerdInfo
mkContainerdInfo =
  ContainerdInfo
  { containerdInfoAddress = Nothing
  , containerdInfoNamespaces = Nothing
  }
...
data ContainerdInfoNamespaces = ContainerdInfoNamespaces
  { containerdInfoNamespacesContainers :: !(Maybe Text) -- ^ "Containers" - The default containerd namespace used for containers managed by the daemon.  The default namespace for containers is \&quot;moby\&quot;, but will be suffixed with the &#x60;&lt;uid&gt;.&lt;gid&gt;&#x60; of the remapped &#x60;root&#x60; if user-namespaces are enabled and the containerd image-store is used. 
  , containerdInfoNamespacesPlugins :: !(Maybe Text) -- ^ "Plugins" - The default containerd namespace used for plugins managed by the daemon.  The default namespace for plugins is \&quot;plugins.moby\&quot;, but will be suffixed with the &#x60;&lt;uid&gt;.&lt;gid&gt;&#x60; of the remapped &#x60;root&#x60; if user-namespaces are enabled and the containerd image-store is used. 
  } deriving (P.Show, P.Eq, P.Typeable)

-- | FromJSON ContainerdInfoNamespaces
instance A.FromJSON ContainerdInfoNamespaces where
  parseJSON = A.withObject "ContainerdInfoNamespaces" $ \o ->
    ContainerdInfoNamespaces
      <$> (o .:? "Containers")
      <*> (o .:? "Plugins")

-- | ToJSON ContainerdInfoNamespaces
instance A.ToJSON ContainerdInfoNamespaces where
  toJSON ContainerdInfoNamespaces {..} =
   _omitNulls
      [ "Containers" .= containerdInfoNamespacesContainers
      , "Plugins" .= containerdInfoNamespacesPlugins
      ]


-- | Construct a value of type 'ContainerdInfoNamespaces' (by applying it's required fields, if any)
mkContainerdInfoNamespaces
  :: ContainerdInfoNamespaces
mkContainerdInfoNamespaces =
  ContainerdInfoNamespaces
  { containerdInfoNamespacesContainers = Nothing
  , containerdInfoNamespacesPlugins = Nothing
  }

-- ** ContainersDiskUsage
-- | ContainersDiskUsage
-- represents system data usage information for container resources. 
data ContainersDiskUsage = ContainersDiskUsage
  { containersDiskUsageActiveCount :: !(Maybe Integer) -- ^ "ActiveCount" - Count of active containers. 
  , containersDiskUsageTotalCount :: !(Maybe Integer) -- ^ "TotalCount" - Count of all containers. 
  , containersDiskUsageReclaimable :: !(Maybe Integer) -- ^ "Reclaimable" - Disk space that can be reclaimed by removing inactive containers. 
  , containersDiskUsageTotalSize :: !(Maybe Integer) -- ^ "TotalSize" - Disk space in use by containers. 
  , containersDiskUsageItems :: !(Maybe [A.Value]) -- ^ "Items" - List of container summaries. 
  } deriving (P.Show, P.Eq, P.Typeable)

-- | FromJSON ContainersDiskUsage
instance A.FromJSON ContainersDiskUsage where
  parseJSON = A.withObject "ContainersDiskUsage" $ \o ->
    ContainersDiskUsage
      <$> (o .:? "ActiveCount")
      <*> (o .:? "TotalCount")
      <*> (o .:? "Reclaimable")
...
-- | ToJSON ContainersDiskUsage
instance A.ToJSON ContainersDiskUsage where
  toJSON ContainersDiskUsage {..} =
   _omitNulls
      [ "ActiveCount" .= containersDiskUsageActiveCount
      , "TotalCount" .= containersDiskUsageTotalCount
      , "Reclaimable" .= containersDiskUsageReclaimable
      , "TotalSize" .= containersDiskUsageTotalSize
      , "Items" .= containersDiskUsageItems
      ]


-- | Construct a value of type 'ContainersDiskUsage' (by applying it's required fields, if any)
mkContainersDiskUsage
  :: ContainersDiskUsage
mkContainersDiskUsage =
  ContainersDiskUsage
  { containersDiskUsageActiveCount = Nothing
  , containersDiskUsageTotalCount = Nothing
  , containersDiskUsageReclaimable = Nothing
  , containersDiskUsageTotalSize = Nothing
  , containersDiskUsageItems = Nothing
  }
...
data CreateImageInfo = CreateImageInfo
  ...
  , createImageInfoErrorDetail :: !(Maybe ErrorDetail) -- ^ "errorDetail"
...
instance A.ToJSON CreateImageInfo where
  toJSON CreateImageInfo {..} =
   _omitNulls
      ...
      , "errorDetail" .= createImageInfoErrorDetail
...
mkCreateImageInfo =
  ...
  , createImageInfoErrorDetail = Nothing
...
data DeviceInfo = DeviceInfo
  { deviceInfoSource :: !(Maybe Text) -- ^ "Source" - The origin device driver. 
  , deviceInfoId :: !(Maybe Text) -- ^ "ID" - The unique identifier for the device within its source driver. For CDI devices, this would be an FQDN like \&quot;vendor.com/gpu&#x3D;0\&quot;. 
  } deriving (P.Show, P.Eq, P.Typeable)

-- | FromJSON DeviceInfo
instance A.FromJSON DeviceInfo where
  parseJSON = A.withObject "DeviceInfo" $ \o ->
    DeviceInfo
      <$> (o .:? "Source")
      <*> (o .:? "ID")

-- | ToJSON DeviceInfo
instance A.ToJSON DeviceInfo where
  toJSON DeviceInfo {..} =
   _omitNulls
...
-- | Construct a value of type 'DeviceInfo' (by applying it's required fields, if any)
mkDeviceInfo
  :: DeviceInfo
mkDeviceInfo =
  DeviceInfo
  { deviceInfoSource = Nothing
  , deviceInfoId = Nothing
  }
...
data DeviceRequest = DeviceRequest
  { deviceRequestDriver :: !(Maybe Text) -- ^ "Driver" - The name of the device driver to use for this request.  Note that if this is specified the capabilities are ignored when selecting a device driver. 
  , deviceRequestCount :: !(Maybe Int) -- ^ "Count"
  , deviceRequestDeviceIds :: !(Maybe [Text]) -- ^ "DeviceIDs"
  , deviceRequestCapabilities :: !(Maybe [[Text]]) -- ^ "Capabilities" - A list of capabilities; an OR list of AND lists of capabilities.  Note that if a driver is specified the capabilities have no effect on selecting a driver as the driver name is used directly.  Note that if no driver is specified the capabilities are used to select a driver with the required capabilities. 
...
data DriverData = DriverData
  { driverDataName :: !(Text) -- ^ /Required/ "Name" - Name of the storage driver.
  , driverDataData :: !((Map.Map String Text)) -- ^ /Required/ "Data" - Low-level storage metadata, provided as key/value pairs.  This information is driver-specific, and depends on the storage-driver in use, and should be used for informational purposes only. 
  } deriving (P.Show, P.Eq, P.Typeable)

-- | FromJSON DriverData
instance A.FromJSON DriverData where
  parseJSON = A.withObject "DriverData" $ \o ->
    DriverData
      <$> (o .:  "Name")
      <*> (o .:  "Data")

-- | ToJSON DriverData
instance A.ToJSON DriverData where
  toJSON DriverData {..} =
   _omitNulls
      [ "Name" .= driverDataName
      , "Data" .= driverDataData
...
-- | Construct a value of type 'DriverData' (by applying it's required fields, if any)
mkDriverData
  :: Text -- ^ 'driverDataName': Name of the storage driver.
  -> (Map.Map String Text) -- ^ 'driverDataData': Low-level storage metadata, provided as key/value pairs.  This information is driver-specific, and depends on the storage-driver in use, and should be used for informational purposes only. 
  -> DriverData
mkDriverData driverDataName driverDataData =
  DriverData
  { driverDataName
  , driverDataData
  }
...
data EndpointResource = EndpointResource
  { endpointResourceName :: !(Maybe Text) -- ^ "Name"
  , endpointResourceEndpointId :: !(Maybe Text) -- ^ "EndpointID"
  , endpointResourceMacAddress :: !(Maybe Text) -- ^ "MacAddress"
  , endpointResourceIpv4Address :: !(Maybe Text) -- ^ "IPv4Address"
  , endpointResourceIpv6Address :: !(Maybe Text) -- ^ "IPv6Address"
  } deriving (P.Show, P.Eq, P.Typeable)

-- | FromJSON EndpointResource
instance A.FromJSON EndpointResource where
  parseJSON = A.withObject "EndpointResource" $ \o ->
    EndpointResource
      <$> (o .:? "Name")
      <*> (o .:? "EndpointID")
      <*> (o .:? "MacAddress")
...
-- | ToJSON EndpointResource
instance A.ToJSON EndpointResource where
  toJSON EndpointResource {..} =
   _omitNulls
      [ "Name" .= endpointResourceName
      , "EndpointID" .= endpointResourceEndpointId
      , "MacAddress" .= endpointResourceMacAddress
      , "IPv4Address" .= endpointResourceIpv4Address
      , "IPv6Address" .= endpointResourceIpv6Address
      ]


-- | Construct a value of type 'EndpointResource' (by applying it's required fields, if any)
mkEndpointResource
  :: EndpointResource
mkEndpointResource =
  EndpointResource
  { endpointResourceName = Nothing
  , endpointResourceEndpointId = Nothing
  , endpointResourceMacAddress = Nothing
  , endpointResourceIpv4Address = Nothing
  , endpointResourceIpv6Address = Nothing
  }
...
data EndpointSettings = EndpointSettings
  ...
  , endpointSettingsDnsNames :: !(Maybe [Text]) -- ^ "DNSNames" - List of all DNS names an endpoint has on a specific network. This list is based on the container name, network aliases, container short ID, and hostname.  These DNS names are non-fully qualified but can contain several dots. You can get fully qualified DNS names by appending &#x60;.&lt;network-name&gt;&#x60;. For instance, if container name is &#x60;my.ctr&#x60; and the network is named &#x60;testnet&#x60;, &#x60;DNSNames&#x60; will contain &#x60;my.ctr&#x60; and the FQDN will be &#x60;my.ctr.testnet&#x60;. 
  } deriving (P.Show, P.Eq, P.Typeable)
...
mkEndpointSettings =
  ...
  , endpointSettingsGwPriority = Nothing
  ...
  , endpointSettingsDnsNames = Nothing
  }
...
data EventMessage = EventMessage
  { eventMessageType :: !(Maybe E'Type4) -- ^ "Type" - The type of object emitting the event
...
data ExecConfig = ExecConfig
  ...
  , execConfigConsoleSize :: !(Maybe [Int]) -- ^ "ConsoleSize" - Initial console size, as an &#x60;[height, width]&#x60; array.
...
instance A.ToJSON ExecConfig where
  toJSON ExecConfig {..} =
   _omitNulls
      ...
      , "ConsoleSize" .= execConfigConsoleSize
...
data ExecStartConfig = ExecStartConfig
  ...
  , execStartConfigConsoleSize :: !(Maybe [Int]) -- ^ "ConsoleSize" - Initial console size, as an &#x60;[height, width]&#x60; array.
  } deriving (P.Show, P.Eq, P.Typeable)
...
instance A.ToJSON ExecStartConfig where
  toJSON ExecStartConfig {..} =
   _omitNulls
      ...
      , "ConsoleSize" .= execStartConfigConsoleSize
      ]
...
mkExecStartConfig =
  ...
  , execStartConfigConsoleSize = Nothing
  }
...
data FilesystemChange = FilesystemChange
  { filesystemChangePath :: !(Text) -- ^ /Required/ "Path" - Path to file or directory that has changed. 
  , filesystemChangeKind :: !(ChangeType) -- ^ /Required/ "Kind"
  } deriving (P.Show, P.Eq, P.Typeable)

-- | FromJSON FilesystemChange
instance A.FromJSON FilesystemChange where
  parseJSON = A.withObject "FilesystemChange" $ \o ->
    FilesystemChange
      <$> (o .:  "Path")
      <*> (o .:  "Kind")

-- | ToJSON FilesystemChange
instance A.ToJSON FilesystemChange where
  toJSON FilesystemChange {..} =
   _omitNulls
...
-- | Construct a value of type 'FilesystemChange' (by applying it's required fields, if any)
mkFilesystemChange
  :: Text -- ^ 'filesystemChangePath': Path to file or directory that has changed. 
  -> ChangeType -- ^ 'filesystemChangeKind' 
  -> FilesystemChange
mkFilesystemChange filesystemChangePath filesystemChangeKind =
  FilesystemChange
  { filesystemChangePath
...
data FirewallInfo = FirewallInfo
  { firewallInfoDriver :: !(Maybe Text) -- ^ "Driver" - The name of the firewall backend driver. 
  , firewallInfoInfo :: !(Maybe [[Text]]) -- ^ "Info" - Information about the firewall backend, provided as \&quot;label\&quot; / \&quot;value\&quot; pairs.  &lt;p&gt;&lt;br /&gt;&lt;/p&gt;  &gt; **Note**: The information returned in this field, including the &gt; formatting of values and labels, should not be considered stable, &gt; and may change without notice. 
  } deriving (P.Show, P.Eq, P.Typeable)

-- | FromJSON FirewallInfo
instance A.FromJSON FirewallInfo where
  parseJSON = A.withObject "FirewallInfo" $ \o ->
    FirewallInfo
      <$> (o .:? "Driver")
      <*> (o .:? "Info")

-- | ToJSON FirewallInfo
instance A.ToJSON FirewallInfo where
  toJSON FirewallInfo {..} =
   _omitNulls
      [ "Driver" .= firewallInfoDriver
      , "Info" .= firewallInfoInfo
      ]


-- | Construct a value of type 'FirewallInfo' (by applying it's required fields, if any)
mkFirewallInfo
  :: FirewallInfo
mkFirewallInfo =
  FirewallInfo
  { firewallInfoDriver = Nothing
  , firewallInfoInfo = Nothing
  }
...
data HealthConfig = HealthConfig
  ...
  , healthConfigInterval :: !(Maybe Integer) -- ^ "Interval" - The time to wait between checks in nanoseconds. It should be 0 or at least 1000000 (1 ms). 0 means inherit. 
  , healthConfigTimeout :: !(Maybe Integer) -- ^ "Timeout" - The time to wait before considering the check to have hung. It should be 0 or at least 1000000 (1 ms). 0 means inherit. 
  ...
  , healthConfigStartPeriod :: !(Maybe Integer) -- ^ "StartPeriod" - Start period for the container to initialize before starting health-retries countdown in nanoseconds. It should be 0 or at least 1000000 (1 ms). 0 means inherit. 
  , healthConfigStartInterval :: !(Maybe Integer) -- ^ "StartInterval" - The time to wait between checks in nanoseconds during the start period. It should be 0 or at least 1000000 (1 ms). 0 means inherit. 
  } deriving (P.Show, P.Eq, P.Typeable)
...
instance A.ToJSON HealthConfig where
  toJSON HealthConfig {..} =
   _omitNulls
      ...
      , "StartInterval" .= healthConfigStartInterval
      ]
...
mkHealthConfig =
  ...
  , healthConfigStartInterval = Nothing
  }
...
data HostConfig = HostConfig
  ...
  , hostConfigConsoleSize :: !(Maybe [Int]) -- ^ "ConsoleSize" - Initial console size, as an &#x60;[height, width]&#x60; array. 
  , hostConfigAnnotations :: !(Maybe (Map.Map String Text)) -- ^ "Annotations" - Arbitrary non-identifying metadata attached to container and provided to the runtime when the container is started. 
  ...
  , hostConfigShmSize :: !(Maybe Integer) -- ^ "ShmSize" - Size of &#x60;/dev/shm&#x60; in bytes. If omitted, the system uses 64MB. 
  , hostConfigSysctls :: !(Maybe (Map.Map String Text)) -- ^ "Sysctls" - A list of kernel parameters (sysctls) to set in the container.  This field is omitted if not set.
...
data HostConfigAllOfLogConfig = HostConfigAllOfLogConfig
  { hostConfigAllOfLogConfigType :: !(Maybe E'Type5) -- ^ "Type" - Name of the logging driver used for the container or \&quot;none\&quot; if logging is disabled.
  , hostConfigAllOfLogConfigConfig :: !(Maybe (Map.Map String Text)) -- ^ "Config" - Driver-specific configuration options for the logging driver.
  } deriving (P.Show, P.Eq, P.Typeable)
...
-- ** IPAMStatus
-- | IPAMStatus
data IPAMStatus = IPAMStatus
  { iPAMStatusSubnets :: !(Maybe (Map.Map String SubnetStatus)) -- ^ "Subnets"
  } deriving (P.Show, P.Eq, P.Typeable)

-- | FromJSON IPAMStatus
instance A.FromJSON IPAMStatus where
  parseJSON = A.withObject "IPAMStatus" $ \o ->
    IPAMStatus
      <$> (o .:? "Subnets")

-- | ToJSON IPAMStatus
instance A.ToJSON IPAMStatus where
  toJSON IPAMStatus {..} =
   _omitNulls
      [ "Subnets" .= iPAMStatusSubnets
      ]


-- | Construct a value of type 'IPAMStatus' (by applying it's required fields, if any)
mkIPAMStatus
  :: IPAMStatus
mkIPAMStatus =
  IPAMStatus
  { iPAMStatusSubnets = Nothing
  }
...
-- | FromJSON ImageConfig
instance A.FromJSON ImageConfig where
  parseJSON = A.withObject "ImageConfig" $ \o ->
    ImageConfig
      <$> (o .:? "User")
      <*> (o .:? "ExposedPorts")
      <*> (o .:? "Env")
...
-- | ToJSON ImageConfig
instance A.ToJSON ImageConfig where
  toJSON ImageConfig {..} =
   _omitNulls
      [ "User" .= imageConfigUser
      , "ExposedPorts" .= imageConfigExposedPorts
      , "Env" .= imageConfigEnv
      , "Cmd" .= imageConfigCmd
      , "Healthcheck" .= imageConfigHealthcheck
      , "ArgsEscaped" .= imageConfigArgsEscaped
      , "Volumes" .= imageConfigVolumes
      , "WorkingDir" .= imageConfigWorkingDir
      , "Entrypoint" .= imageConfigEntrypoint
      , "OnBuild" .= imageConfigOnBuild
      , "Labels" .= imageConfigLabels
      , "StopSignal" .= imageConfigStopSignal
      , "Shell" .= imageConfigShell
      ]


-- | Construct a value of type 'ImageConfig' (by applying it's required fields, if any)
mkImageConfig
  :: ImageConfig
mkImageConfig =
  ImageConfig
  { imageConfigUser = Nothing
  , imageConfigExposedPorts = Nothing
  , imageConfigEnv = Nothing
  , imageConfigCmd = Nothing
  , imageConfigHealthcheck = Nothing
  , imageConfigArgsEscaped = Nothing
  , imageConfigVolumes = Nothing
  , imageConfigWorkingDir = Nothing
  , imageConfigEntrypoint = Nothing
  , imageConfigOnBuild = Nothing
  , imageConfigLabels = Nothing
  , imageConfigStopSignal = Nothing
  , imageConfigShell = Nothing
  }
...
data ImageInspect = ImageInspect
  ...
  , imageInspectCreated :: !(Maybe Text) -- ^ "Created" - Date and time at which the image was created, formatted in [RFC 3339](https://www.ietf.org/rfc/rfc3339.txt) format with nano-seconds.  This information is only available if present in the image, and omitted otherwise. 
  ...
  , imageInspectConfig :: !(Maybe ImageConfig) -- ^ "Config"
...
instance A.ToJSON ImageInspect where
  toJSON ImageInspect {..} =
   _omitNulls
      ...
      , "Manifests" .= imageInspectManifests
...
mkImageInspect =
  ...
  , imageInspectDescriptor = Nothing
  , imageInspectManifests = Nothing
...
data ImageManifestSummary = ImageManifestSummary
  { imageManifestSummaryId :: !(Text) -- ^ /Required/ "ID" - ID is the content-addressable ID of an image and is the same as the digest of the image manifest. 
  , imageManifestSummaryDescriptor :: !(OCIDescriptor) -- ^ /Required/ "Descriptor"
  , imageManifestSummaryAvailable :: !(Bool) -- ^ /Required/ "Available" - Indicates whether all the child content (image config, layers) is fully available locally.
  , imageManifestSummarySize :: !(ImageManifestSummarySize) -- ^ /Required/ "Size"
  , imageManifestSummaryKind :: !(E'Kind) -- ^ /Required/ "Kind" - The kind of the manifest.  kind         | description -------------|----------------------------------------------------------- image        | Image manifest that can be used to start a container. attestation  | Attestation manifest produced by the Buildkit builder for a specific image manifest. 
  , imageManifestSummaryImageData :: !(Maybe ImageManifestSummaryImageData) -- ^ "ImageData"
  , imageManifestSummaryAttestationData :: !(Maybe ImageManifestSummaryAttestationData) -- ^ "AttestationData"
  } deriving (P.Show, P.Eq, P.Typeable)

-- | FromJSON ImageManifestSummary
instance A.FromJSON ImageManifestSummary where
  parseJSON = A.withObject "ImageManifestSummary" $ \o ->
    ImageManifestSummary
      <$> (o .:  "ID")
      <*> (o .:  "Descriptor")
      <*> (o .:  "Available")
...
-- | ToJSON ImageManifestSummary
instance A.ToJSON ImageManifestSummary where
  toJSON ImageManifestSummary {..} =
   _omitNulls
      [ "ID" .= imageManifestSummaryId
      , "Descriptor" .= imageManifestSummaryDescriptor
      , "Available" .= imageManifestSummaryAvailable
...
-- | Construct a value of type 'ImageManifestSummary' (by applying it's required fields, if any)
mkImageManifestSummary
  :: Text -- ^ 'imageManifestSummaryId': ID is the content-addressable ID of an image and is the same as the digest of the image manifest. 
  -> OCIDescriptor -- ^ 'imageManifestSummaryDescriptor' 
  -> Bool -- ^ 'imageManifestSummaryAvailable': Indicates whether all the child content (image config, layers) is fully available locally.
  -> ImageManifestSummarySize -- ^ 'imageManifestSummarySize' 
  -> E'Kind -- ^ 'imageManifestSummaryKind': The kind of the manifest.  kind         | description -------------|----------------------------------------------------------- image        | Image manifest that can be used to start a container. attestation  | Attestation manifest produced by the Buildkit builder for a specific image manifest. 
  -> ImageManifestSummary
mkImageManifestSummary imageManifestSummaryId imageManifestSummaryDescriptor imageManifestSummaryAvailable imageManifestSummarySize imageManifestSummaryKind =
  ImageManifestSummary
  { imageManifestSummaryId
  , imageManifestSummaryDescriptor
  , imageManifestSummaryAvailable
  , imageManifestSummarySize
  , imageManifestSummaryKind
  , imageManifestSummaryImageData = Nothing
  , imageManifestSummaryAttestationData = Nothing
  }
...
data ImageManifestSummaryAttestationData = ImageManifestSummaryAttestationData
  { imageManifestSummaryAttestationDataFor :: !(Text) -- ^ /Required/ "For" - The digest of the image manifest that this attestation is for. 
  } deriving (P.Show, P.Eq, P.Typeable)

-- | FromJSON ImageManifestSummaryAttestationData
instance A.FromJSON ImageManifestSummaryAttestationData where
  parseJSON = A.withObject "ImageManifestSummaryAttestationData" $ \o ->
    ImageManifestSummaryAttestationData
      <$> (o .:  "For")

-- | ToJSON ImageManifestSummaryAttestationData
instance A.ToJSON ImageManifestSummaryAttestationData where
  toJSON ImageManifestSummaryAttestationData {..} =
   _omitNulls
      [ "For" .= imageManifestSummaryAttestationDataFor
      ]


-- | Construct a value of type 'ImageManifestSummaryAttestationData' (by applying it's required fields, if any)
mkImageManifestSummaryAttestationData
  :: Text -- ^ 'imageManifestSummaryAttestationDataFor': The digest of the image manifest that this attestation is for. 
  -> ImageManifestSummaryAttestationData
mkImageManifestSummaryAttestationData imageManifestSummaryAttestationDataFor =
  ImageManifestSummaryAttestationData
  { imageManifestSummaryAttestationDataFor
  }
...
data ImageManifestSummaryImageData = ImageManifestSummaryImageData
  { imageManifestSummaryImageDataPlatform :: !(OCIPlatform) -- ^ /Required/ "Platform"
  , imageManifestSummaryImageDataContainers :: !([Text]) -- ^ /Required/ "Containers" - The IDs of the containers that are using this image. 
  , imageManifestSummaryImageDataSize :: !(ImageManifestSummaryImageDataSize) -- ^ /Required/ "Size"
  } deriving (P.Show, P.Eq, P.Typeable)

-- | FromJSON ImageManifestSummaryImageData
instance A.FromJSON ImageManifestSummaryImageData where
  parseJSON = A.withObject "ImageManifestSummaryImageData" $ \o ->
    ImageManifestSummaryImageData
      <$> (o .:  "Platform")
      <*> (o .:  "Containers")
      <*> (o .:  "Size")

-- | ToJSON ImageManifestSummaryImageData
instance A.ToJSON ImageManifestSummaryImageData where
  toJSON ImageManifestSummaryImageData {..} =
   _omitNulls
      [ "Platform" .= imageManifestSummaryImageDataPlatform
      , "Containers" .= imageManifestSummaryImageDataContainers
      , "Size" .= imageManifestSummaryImageDataSize
      ]


-- | Construct a value of type 'ImageManifestSummaryImageData' (by applying it's required fields, if any)
mkImageManifestSummaryImageData
  :: OCIPlatform -- ^ 'imageManifestSummaryImageDataPlatform' 
  -> [Text] -- ^ 'imageManifestSummaryImageDataContainers': The IDs of the containers that are using this image. 
  -> ImageManifestSummaryImageDataSize -- ^ 'imageManifestSummaryImageDataSize' 
  -> ImageManifestSummaryImageData
mkImageManifestSummaryImageData imageManifestSummaryImageDataPlatform imageManifestSummaryImageDataContainers imageManifestSummaryImageDataSize =
  ImageManifestSummaryImageData
  { imageManifestSummaryImageDataPlatform
  , imageManifestSummaryImageDataContainers
  , imageManifestSummaryImageDataSize
  }

-- ** ImageManifestSummaryImageDataSize
-- | ImageManifestSummaryImageDataSize
data ImageManifestSummaryImageDataSize = ImageManifestSummaryImageDataSize
  { imageManifestSummaryImageDataSizeUnpacked :: !(Integer) -- ^ /Required/ "Unpacked" - Unpacked is the size (in bytes) of the locally unpacked (uncompressed) image content that&#39;s directly usable by the containers running this image. It&#39;s independent of the distributable content - e.g. the image might still have an unpacked data that&#39;s still used by some container even when the distributable/compressed content is already gone. 
  } deriving (P.Show, P.Eq, P.Typeable)

-- | FromJSON ImageManifestSummaryImageDataSize
instance A.FromJSON ImageManifestSummaryImageDataSize where
  parseJSON = A.withObject "ImageManifestSummaryImageDataSize" $ \o ->
    ImageManifestSummaryImageDataSize
      <$> (o .:  "Unpacked")

-- | ToJSON ImageManifestSummaryImageDataSize
instance A.ToJSON ImageManifestSummaryImageDataSize where
  toJSON ImageManifestSummaryImageDataSize {..} =
   _omitNulls
      [ "Unpacked" .= imageManifestSummaryImageDataSizeUnpacked
      ]


-- | Construct a value of type 'ImageManifestSummaryImageDataSize' (by applying it's required fields, if any)
mkImageManifestSummaryImageDataSize
  :: Integer -- ^ 'imageManifestSummaryImageDataSizeUnpacked': Unpacked is the size (in bytes) of the locally unpacked (uncompressed) image content that's directly usable by the containers running this image. It's independent of the distributable content - e.g. the image might still have an unpacked data that's still used by some container even when the distributable/compressed content is already gone. 
  -> ImageManifestSummaryImageDataSize
mkImageManifestSummaryImageDataSize imageManifestSummaryImageDataSizeUnpacked =
  ImageManifestSummaryImageDataSize
  { imageManifestSummaryImageDataSizeUnpacked
  }

-- ** ImageManifestSummarySize
-- | ImageManifestSummarySize
data ImageManifestSummarySize = ImageManifestSummarySize
  { imageManifestSummarySizeTotal :: !(Integer) -- ^ /Required/ "Total" - Total is the total size (in bytes) of all the locally present data (both distributable and non-distributable) that&#39;s related to this manifest and its children. This equal to the sum of [Content] size AND all the sizes in the [Size] struct present in the Kind-specific data struct. For example, for an image kind (Kind &#x3D;&#x3D; \&quot;image\&quot;) this would include the size of the image content and unpacked image snapshots ([Size.Content] + [ImageData.Size.Unpacked]). 
  , imageManifestSummarySizeContent :: !(Integer) -- ^ /Required/ "Content" - Content is the size (in bytes) of all the locally present content in the content store (e.g. image config, layers) referenced by this manifest and its children. This only includes blobs in the content store. 
  } deriving (P.Show, P.Eq, P.Typeable)

-- | FromJSON ImageManifestSummarySize
instance A.FromJSON ImageManifestSummarySize where
  parseJSON = A.withObject "ImageManifestSummarySize" $ \o ->
    ImageManifestSummarySize
      <$> (o .:  "Total")
      <*> (o .:  "Content")

-- | ToJSON ImageManifestSummarySize
instance A.ToJSON ImageManifestSummarySize where
  toJSON ImageManifestSummarySize {..} =
   _omitNulls
      [ "Total" .= imageManifestSummarySizeTotal
      , "Content" .= imageManifestSummarySizeContent
      ]


-- | Construct a value of type 'ImageManifestSummarySize' (by applying it's required fields, if any)
mkImageManifestSummarySize
  :: Integer -- ^ 'imageManifestSummarySizeTotal': Total is the total size (in bytes) of all the locally present data (both distributable and non-distributable) that's related to this manifest and its children. This equal to the sum of [Content] size AND all the sizes in the [Size] struct present in the Kind-specific data struct. For example, for an image kind (Kind == \"image\") this would include the size of the image content and unpacked image snapshots ([Size.Content] + [ImageData.Size.Unpacked]). 
  -> Integer -- ^ 'imageManifestSummarySizeContent': Content is the size (in bytes) of all the locally present content in the content store (e.g. image config, layers) referenced by this manifest and its children. This only includes blobs in the content store. 
  -> ImageManifestSummarySize
mkImageManifestSummarySize imageManifestSummarySizeTotal imageManifestSummarySizeContent =
  ImageManifestSummarySize
  { imageManifestSummarySizeTotal
  , imageManifestSummarySizeContent
  }
...
data ImageSearchResponseItem = ImageSearchResponseItem
  ...
  , imageSearchResponseItemIsAutomated :: !(Maybe Bool) -- ^ "is_automated" - Whether this repository has automated builds enabled.  &lt;p&gt;&lt;br /&gt;&lt;/p&gt;  &gt; **Deprecated**: This field is deprecated and will always be \&quot;false\&quot;. 
...
data ImageSummary = ImageSummary
  { imageSummaryId :: !(Text) -- ^ /Required/ "Id" - ID is the content-addressable ID of an image.  This identifier is a content-addressable digest calculated from the image&#39;s configuration (which includes the digests of layers used by the image).  Note that this digest differs from the &#x60;RepoDigests&#x60; below, which holds digests of image manifests that reference the image. 
  ...
  , imageSummaryContainers :: !(Int) -- ^ /Required/ "Containers" - Number of containers using this image. Includes both stopped and running containers.  &#x60;-1&#x60; indicates that the value has not been set / calculated. 
  ...
  , imageSummaryDescriptor :: !(Maybe OCIDescriptor) -- ^ "Descriptor"
  } deriving (P.Show, P.Eq, P.Typeable)
...
instance A.ToJSON ImageSummary where
  toJSON ImageSummary {..} =
   _omitNulls
      ...
      , "Descriptor" .= imageSummaryDescriptor
      ]


-- | Construct a value of type 'ImageSummary' (by applying it's required fields, if any)
mkImageSummary
  :: Text -- ^ 'imageSummaryId': ID is the content-addressable ID of an image.  This identifier is a content-addressable digest calculated from the image's configuration (which includes the digests of layers used by the image).  Note that this digest differs from the `RepoDigests` below, which holds digests of image manifests that reference the image. 
  ...
  -> Int -- ^ 'imageSummaryContainers': Number of containers using this image. Includes both stopped and running containers.  `-1` indicates that the value has not been set / calculated. 
  -> ImageSummary
mkImageSummary imageSummaryId imageSummaryParentId imageSummaryRepoTags imageSummaryRepoDigests imageSummaryCreated imageSummarySize imageSummarySharedSize imageSummaryLabels imageSummaryContainers =
  ImageSummary
  { imageSummaryId
  ...
  , imageSummaryDescriptor = Nothing
  }

-- ** ImagesDiskUsage
-- | ImagesDiskUsage
-- represents system data usage for image resources. 
data ImagesDiskUsage = ImagesDiskUsage
  { imagesDiskUsageActiveCount :: !(Maybe Integer) -- ^ "ActiveCount" - Count of active images. 
  , imagesDiskUsageTotalCount :: !(Maybe Integer) -- ^ "TotalCount" - Count of all images. 
  , imagesDiskUsageReclaimable :: !(Maybe Integer) -- ^ "Reclaimable" - Disk space that can be reclaimed by removing unused images. 
  , imagesDiskUsageTotalSize :: !(Maybe Integer) -- ^ "TotalSize" - Disk space in use by images. 
  , imagesDiskUsageItems :: !(Maybe [A.Value]) -- ^ "Items" - List of image summaries. 
  } deriving (P.Show, P.Eq, P.Typeable)

-- | FromJSON ImagesDiskUsage
instance A.FromJSON ImagesDiskUsage where
  parseJSON = A.withObject "ImagesDiskUsage" $ \o ->
    ImagesDiskUsage
      <$> (o .:? "ActiveCount")
      <*> (o .:? "TotalCount")
      <*> (o .:? "Reclaimable")
...
-- | ToJSON ImagesDiskUsage
instance A.ToJSON ImagesDiskUsage where
  toJSON ImagesDiskUsage {..} =
   _omitNulls
      [ "ActiveCount" .= imagesDiskUsageActiveCount
      , "TotalCount" .= imagesDiskUsageTotalCount
      , "Reclaimable" .= imagesDiskUsageReclaimable
      , "TotalSize" .= imagesDiskUsageTotalSize
      , "Items" .= imagesDiskUsageItems
      ]


-- | Construct a value of type 'ImagesDiskUsage' (by applying it's required fields, if any)
mkImagesDiskUsage
  :: ImagesDiskUsage
mkImagesDiskUsage =
  ImagesDiskUsage
  { imagesDiskUsageActiveCount = Nothing
  , imagesDiskUsageTotalCount = Nothing
  , imagesDiskUsageReclaimable = Nothing
  , imagesDiskUsageTotalSize = Nothing
  , imagesDiskUsageItems = Nothing
  }
...
data Mount = Mount
  ...
  , mountImageOptions :: !(Maybe MountImageOptions) -- ^ "ImageOptions"
...
instance A.FromJSON MountBindOptions where
  parseJSON = A.withObject "MountBindOptions" $ \o ->
    MountBindOptions
      ...
      <*> (o .:? "NonRecursive")
      <*> (o .:? "CreateMountpoint")
      <*> (o .:? "ReadOnlyNonRecursive")
      <*> (o .:? "ReadOnlyForceRecursive")
...
instance A.ToJSON MountBindOptions where
  toJSON MountBindOptions {..} =
   _omitNulls
      ...
      , "CreateMountpoint" .= mountBindOptionsCreateMountpoint
      , "ReadOnlyNonRecursive" .= mountBindOptionsReadOnlyNonRecursive
      , "ReadOnlyForceRecursive" .= mountBindOptionsReadOnlyForceRecursive
      ]
...
mkMountBindOptions =
  ...
  , mountBindOptionsCreateMountpoint = Nothing
  , mountBindOptionsReadOnlyNonRecursive = Nothing
  , mountBindOptionsReadOnlyForceRecursive = Nothing
  }

-- ** MountImageOptions
-- | MountImageOptions
-- Optional configuration for the `image` type.
data MountImageOptions = MountImageOptions
  { mountImageOptionsSubpath :: !(Maybe Text) -- ^ "Subpath" - Source path inside the image. Must be relative without any back traversals.
  } deriving (P.Show, P.Eq, P.Typeable)

-- | FromJSON MountImageOptions
instance A.FromJSON MountImageOptions where
  parseJSON = A.withObject "MountImageOptions" $ \o ->
    MountImageOptions
      <$> (o .:? "Subpath")

-- | ToJSON MountImageOptions
instance A.ToJSON MountImageOptions where
  toJSON MountImageOptions {..} =
   _omitNulls
      [ "Subpath" .= mountImageOptionsSubpath
      ]


-- | Construct a value of type 'MountImageOptions' (by applying it's required fields, if any)
mkMountImageOptions
  :: MountImageOptions
mkMountImageOptions =
  MountImageOptions
  { mountImageOptionsSubpath = Nothing
  }
...
data MountPoint = MountPoint
  { mountPointType :: !(Maybe E'Type2) -- ^ "Type" - The mount type:  - &#x60;bind&#x60; a mount of a file or directory from the host into the container. - &#x60;volume&#x60; a docker volume with the given &#x60;Name&#x60;. - &#x60;image&#x60; a docker image - &#x60;tmpfs&#x60; a &#x60;tmpfs&#x60;. - &#x60;npipe&#x60; a named pipe from the host into the container. - &#x60;cluster&#x60; a Swarm cluster volume 
...
data MountTmpfsOptions = MountTmpfsOptions
  ...
  , mountTmpfsOptionsOptions :: !(Maybe [[Text]]) -- ^ "Options" - The options to be passed to the tmpfs mount. An array of arrays. Flag options should be provided as 1-length arrays. Other types should be provided as as 2-length arrays, where the first item is the key and the second the value. 
  } deriving (P.Show, P.Eq, P.Typeable)
...
mkMountTmpfsOptions =
  ...
  , mountTmpfsOptionsOptions = Nothing
  }
...
data MountVolumeOptions = MountVolumeOptions
  ...
  , mountVolumeOptionsSubpath :: !(Maybe Text) -- ^ "Subpath" - Source path inside the volume. Must be relative without any back traversals.
  } deriving (P.Show, P.Eq, P.Typeable)
...
instance A.ToJSON MountVolumeOptions where
  toJSON MountVolumeOptions {..} =
   _omitNulls
      ...
      , "Subpath" .= mountVolumeOptionsSubpath
      ]
...
mkMountVolumeOptions =
  ...
  , mountVolumeOptionsSubpath = Nothing
  }
...
data Network = Network
  { networkName :: !(Maybe Text) -- ^ "Name" - Name of the network. 
  , networkId :: !(Maybe Text) -- ^ "Id" - ID that uniquely identifies a network on a single machine. 
  , networkCreated :: !(Maybe Text) -- ^ "Created" - Date and time at which the network was created in [RFC 3339](https://www.ietf.org/rfc/rfc3339.txt) format with nano-seconds. 
  , networkScope :: !(Maybe Text) -- ^ "Scope" - The level at which the network exists (e.g. &#x60;swarm&#x60; for cluster-wide or &#x60;local&#x60; for machine level) 
  , networkDriver :: !(Maybe Text) -- ^ "Driver" - The name of the driver used to create the network (e.g. &#x60;bridge&#x60;, &#x60;overlay&#x60;). 
  , networkEnableIpv4 :: !(Maybe Bool) -- ^ "EnableIPv4" - Whether the network was created with IPv4 enabled. 
  ...
  , networkOptions :: !(Maybe (Map.Map String Text)) -- ^ "Options" - Network-specific options uses when creating the network. 
  , networkLabels :: !(Maybe (Map.Map String Text)) -- ^ "Labels" - Metadata specific to the network being created. 
  , networkPeers :: !(Maybe [PeerInfo]) -- ^ "Peers" - List of peer nodes for an overlay network. This field is only present for overlay networks, and omitted for other network types. 
  } deriving (P.Show, P.Eq, P.Typeable)
...
data NetworkConnectRequest = NetworkConnectRequest
  { networkConnectRequestContainer :: !(Text) -- ^ /Required/ "Container" - The ID or name of the container to connect to the network.
...
mkNetworkConnectRequest
  :: Text -- ^ 'networkConnectRequestContainer': The ID or name of the container to connect to the network.
  -> NetworkConnectRequest
mkNetworkConnectRequest networkConnectRequestContainer =
  NetworkConnectRequest
  { networkConnectRequestContainer
...
data NetworkCreateRequest = NetworkCreateRequest
  ...
  , networkCreateRequestScope :: !(Maybe Text) -- ^ "Scope" - The level at which the network exists (e.g. &#x60;swarm&#x60; for cluster-wide or &#x60;local&#x60; for machine level). 
  ...
  , networkCreateRequestConfigOnly :: !(Maybe Bool) -- ^ "ConfigOnly" - Creates a config-only network. Config-only networks are placeholder networks for network configurations to be used by other networks. Config-only networks cannot be used directly to run containers or services. 
  , networkCreateRequestConfigFrom :: !(Maybe ConfigReference) -- ^ "ConfigFrom"
  , networkCreateRequestIpam :: !(Maybe IPAM) -- ^ "IPAM"
  , networkCreateRequestEnableIpv4 :: !(Maybe Bool) -- ^ "EnableIPv4" - Enable IPv4 on the network.
...
instance A.ToJSON NetworkCreateRequest where
  toJSON NetworkCreateRequest {..} =
   _omitNulls
      ...
      , "Scope" .= networkCreateRequestScope
      , "Internal" .= networkCreateRequestInternal
      , "Attachable" .= networkCreateRequestAttachable
      , "Ingress" .= networkCreateRequestIngress
      , "ConfigOnly" .= networkCreateRequestConfigOnly
      , "ConfigFrom" .= networkCreateRequestConfigFrom
      , "IPAM" .= networkCreateRequestIpam
      , "EnableIPv4" .= networkCreateRequestEnableIpv4
...
mkNetworkCreateRequest networkCreateRequestName =
  ...
  , networkCreateRequestScope = Nothing
  , networkCreateRequestInternal = Nothing
  , networkCreateRequestAttachable = Nothing
  , networkCreateRequestIngress = Nothing
  , networkCreateRequestConfigOnly = Nothing
  , networkCreateRequestConfigFrom = Nothing
  , networkCreateRequestIpam = Nothing
  , networkCreateRequestEnableIpv4 = Nothing
...
data NetworkCreateResponse = NetworkCreateResponse
  { networkCreateResponseId :: !(Text) -- ^ /Required/ "Id" - The ID of the created network.
  , networkCreateResponseWarning :: !(Text) -- ^ /Required/ "Warning" - Warnings encountered when creating the container
  } deriving (P.Show, P.Eq, P.Typeable)
...
mkNetworkCreateResponse
  :: Text -- ^ 'networkCreateResponseId': The ID of the created network.
  -> Text -- ^ 'networkCreateResponseWarning': Warnings encountered when creating the container
  -> NetworkCreateResponse
mkNetworkCreateResponse networkCreateResponseId networkCreateResponseWarning =
  NetworkCreateResponse
  { networkCreateResponseId
  , networkCreateResponseWarning
  }
...
data NetworkDisconnectRequest = NetworkDisconnectRequest
  { networkDisconnectRequestContainer :: !(Text) -- ^ /Required/ "Container" - The ID or name of the container to disconnect from the network.
...
mkNetworkDisconnectRequest
  :: Text -- ^ 'networkDisconnectRequestContainer': The ID or name of the container to disconnect from the network.
  -> NetworkDisconnectRequest
mkNetworkDisconnectRequest networkDisconnectRequestContainer =
  NetworkDisconnectRequest
  { networkDisconnectRequestContainer
...
data NetworkInspect = NetworkInspect
  { networkInspectContainers :: !(Maybe (Map.Map String EndpointResource)) -- ^ "Containers" - Contains endpoints attached to the network. 
  , networkInspectServices :: !(Maybe (Map.Map String A.Value)) -- ^ "Services" - List of services using the network. This field is only present for swarm scope networks, and omitted for local scope networks. 
  , networkInspectStatus :: !(Maybe NetworkStatus) -- ^ "Status"
  , networkInspectName :: !(Maybe Text) -- ^ "Name" - Name of the network. 
  , networkInspectId :: !(Maybe Text) -- ^ "Id" - ID that uniquely identifies a network on a single machine. 
  , networkInspectCreated :: !(Maybe Text) -- ^ "Created" - Date and time at which the network was created in [RFC 3339](https://www.ietf.org/rfc/rfc3339.txt) format with nano-seconds. 
  , networkInspectScope :: !(Maybe Text) -- ^ "Scope" - The level at which the network exists (e.g. &#x60;swarm&#x60; for cluster-wide or &#x60;local&#x60; for machine level) 
  , networkInspectDriver :: !(Maybe Text) -- ^ "Driver" - The name of the driver used to create the network (e.g. &#x60;bridge&#x60;, &#x60;overlay&#x60;). 
  , networkInspectEnableIpv4 :: !(Maybe Bool) -- ^ "EnableIPv4" - Whether the network was created with IPv4 enabled. 
  , networkInspectEnableIpv6 :: !(Maybe Bool) -- ^ "EnableIPv6" - Whether the network was created with IPv6 enabled. 
  , networkInspectIpam :: !(Maybe IPAM) -- ^ "IPAM"
  , networkInspectInternal :: !(Maybe Bool) -- ^ "Internal" - Whether the network is created to only allow internal networking connectivity. 
  , networkInspectAttachable :: !(Maybe Bool) -- ^ "Attachable" - Whether a global / swarm scope network is manually attachable by regular containers from workers in swarm mode. 
  , networkInspectIngress :: !(Maybe Bool) -- ^ "Ingress" - Whether the network is providing the routing-mesh for the swarm cluster. 
  , networkInspectConfigFrom :: !(Maybe ConfigReference) -- ^ "ConfigFrom"
  , networkInspectConfigOnly :: !(Maybe Bool) -- ^ "ConfigOnly" - Whether the network is a config-only network. Config-only networks are placeholder networks for network configurations to be used by other networks. Config-only networks cannot be used directly to run containers or services. 
  , networkInspectOptions :: !(Maybe (Map.Map String Text)) -- ^ "Options" - Network-specific options uses when creating the network. 
  , networkInspectLabels :: !(Maybe (Map.Map String Text)) -- ^ "Labels" - Metadata specific to the network being created. 
  , networkInspectPeers :: !(Maybe [PeerInfo]) -- ^ "Peers" - List of peer nodes for an overlay network. This field is only present for overlay networks, and omitted for other network types. 
  } deriving (P.Show, P.Eq, P.Typeable)

-- | FromJSON NetworkInspect
instance A.FromJSON NetworkInspect where
  parseJSON = A.withObject "NetworkInspect" $ \o ->
    NetworkInspect
      <$> (o .:? "Containers")
      <*> (o .:? "Services")
      <*> (o .:? "Status")
...
-- | ToJSON NetworkInspect
instance A.ToJSON NetworkInspect where
  toJSON NetworkInspect {..} =
   _omitNulls
      [ "Containers" .= networkInspectContainers
      , "Services" .= networkInspectServices
      , "Status" .= networkInspectStatus
      , "Name" .= networkInspectName
      , "Id" .= networkInspectId
      , "Created" .= networkInspectCreated
      , "Scope" .= networkInspectScope
      , "Driver" .= networkInspectDriver
      , "EnableIPv4" .= networkInspectEnableIpv4
      , "EnableIPv6" .= networkInspectEnableIpv6
      , "IPAM" .= networkInspectIpam
      , "Internal" .= networkInspectInternal
      , "Attachable" .= networkInspectAttachable
      , "Ingress" .= networkInspectIngress
      , "ConfigFrom" .= networkInspectConfigFrom
      , "ConfigOnly" .= networkInspectConfigOnly
      , "Options" .= networkInspectOptions
      , "Labels" .= networkInspectLabels
      , "Peers" .= networkInspectPeers
      ]


-- | Construct a value of type 'NetworkInspect' (by applying it's required fields, if any)
mkNetworkInspect
  :: NetworkInspect
mkNetworkInspect =
  NetworkInspect
  { networkInspectContainers = Nothing
  , networkInspectServices = Nothing
  , networkInspectStatus = Nothing
  , networkInspectName = Nothing
  , networkInspectId = Nothing
  , networkInspectCreated = Nothing
  , networkInspectScope = Nothing
  , networkInspectDriver = Nothing
  , networkInspectEnableIpv4 = Nothing
  , networkInspectEnableIpv6 = Nothing
  , networkInspectIpam = Nothing
  , networkInspectInternal = Nothing
  , networkInspectAttachable = Nothing
  , networkInspectIngress = Nothing
  , networkInspectConfigFrom = Nothing
  , networkInspectConfigOnly = Nothing
  , networkInspectOptions = Nothing
  , networkInspectLabels = Nothing
  , networkInspectPeers = Nothing
  }
...
data NetworkSettings = NetworkSettings
  ...
  , networkSettingsSandboxKey :: !(Maybe Text) -- ^ "SandboxKey" - SandboxKey is the full path of the netns handle
...
data NetworkStatus = NetworkStatus
  { networkStatusIpam :: !(Maybe IPAMStatus) -- ^ "IPAM"
  } deriving (P.Show, P.Eq, P.Typeable)

-- | FromJSON NetworkStatus
instance A.FromJSON NetworkStatus where
  parseJSON = A.withObject "NetworkStatus" $ \o ->
    NetworkStatus
      <$> (o .:? "IPAM")

-- | ToJSON NetworkStatus
instance A.ToJSON NetworkStatus where
  toJSON NetworkStatus {..} =
   _omitNulls
      [ "IPAM" .= networkStatusIpam
      ]


-- | Construct a value of type 'NetworkStatus' (by applying it's required fields, if any)
mkNetworkStatus
  :: NetworkStatus
mkNetworkStatus =
  NetworkStatus
  { networkStatusIpam = Nothing
  }
...
data NetworkSummary = NetworkSummary
  { networkSummaryName :: !(Maybe Text) -- ^ "Name" - Name of the network. 
  , networkSummaryId :: !(Maybe Text) -- ^ "Id" - ID that uniquely identifies a network on a single machine. 
  , networkSummaryCreated :: !(Maybe Text) -- ^ "Created" - Date and time at which the network was created in [RFC 3339](https://www.ietf.org/rfc/rfc3339.txt) format with nano-seconds. 
  , networkSummaryScope :: !(Maybe Text) -- ^ "Scope" - The level at which the network exists (e.g. &#x60;swarm&#x60; for cluster-wide or &#x60;local&#x60; for machine level) 
  , networkSummaryDriver :: !(Maybe Text) -- ^ "Driver" - The name of the driver used to create the network (e.g. &#x60;bridge&#x60;, &#x60;overlay&#x60;). 
  , networkSummaryEnableIpv4 :: !(Maybe Bool) -- ^ "EnableIPv4" - Whether the network was created with IPv4 enabled. 
  , networkSummaryEnableIpv6 :: !(Maybe Bool) -- ^ "EnableIPv6" - Whether the network was created with IPv6 enabled. 
  , networkSummaryIpam :: !(Maybe IPAM) -- ^ "IPAM"
  , networkSummaryInternal :: !(Maybe Bool) -- ^ "Internal" - Whether the network is created to only allow internal networking connectivity. 
  , networkSummaryAttachable :: !(Maybe Bool) -- ^ "Attachable" - Whether a global / swarm scope network is manually attachable by regular containers from workers in swarm mode. 
  , networkSummaryIngress :: !(Maybe Bool) -- ^ "Ingress" - Whether the network is providing the routing-mesh for the swarm cluster. 
  , networkSummaryConfigFrom :: !(Maybe ConfigReference) -- ^ "ConfigFrom"
  , networkSummaryConfigOnly :: !(Maybe Bool) -- ^ "ConfigOnly" - Whether the network is a config-only network. Config-only networks are placeholder networks for network configurations to be used by other networks. Config-only networks cannot be used directly to run containers or services. 
  , networkSummaryOptions :: !(Maybe (Map.Map String Text)) -- ^ "Options" - Network-specific options uses when creating the network. 
  , networkSummaryLabels :: !(Maybe (Map.Map String Text)) -- ^ "Labels" - Metadata specific to the network being created. 
  , networkSummaryPeers :: !(Maybe [PeerInfo]) -- ^ "Peers" - List of peer nodes for an overlay network. This field is only present for overlay networks, and omitted for other network types. 
  } deriving (P.Show, P.Eq, P.Typeable)

-- | FromJSON NetworkSummary
instance A.FromJSON NetworkSummary where
  parseJSON = A.withObject "NetworkSummary" $ \o ->
    NetworkSummary
      <$> (o .:? "Name")
      <*> (o .:? "Id")
      <*> (o .:? "Created")
...
-- | ToJSON NetworkSummary
instance A.ToJSON NetworkSummary where
  toJSON NetworkSummary {..} =
   _omitNulls
      [ "Name" .= networkSummaryName
      , "Id" .= networkSummaryId
      , "Created" .= networkSummaryCreated
      , "Scope" .= networkSummaryScope
      , "Driver" .= networkSummaryDriver
      , "EnableIPv4" .= networkSummaryEnableIpv4
      , "EnableIPv6" .= networkSummaryEnableIpv6
      , "IPAM" .= networkSummaryIpam
      , "Internal" .= networkSummaryInternal
      , "Attachable" .= networkSummaryAttachable
      , "Ingress" .= networkSummaryIngress
      , "ConfigFrom" .= networkSummaryConfigFrom
      , "ConfigOnly" .= networkSummaryConfigOnly
      , "Options" .= networkSummaryOptions
      , "Labels" .= networkSummaryLabels
      , "Peers" .= networkSummaryPeers
      ]


-- | Construct a value of type 'NetworkSummary' (by applying it's required fields, if any)
mkNetworkSummary
  :: NetworkSummary
mkNetworkSummary =
  NetworkSummary
  { networkSummaryName = Nothing
  , networkSummaryId = Nothing
  , networkSummaryCreated = Nothing
  , networkSummaryScope = Nothing
  , networkSummaryDriver = Nothing
  , networkSummaryEnableIpv4 = Nothing
  , networkSummaryEnableIpv6 = Nothing
  , networkSummaryIpam = Nothing
  , networkSummaryInternal = Nothing
  , networkSummaryAttachable = Nothing
  , networkSummaryIngress = Nothing
  , networkSummaryConfigFrom = Nothing
  , networkSummaryConfigOnly = Nothing
  , networkSummaryOptions = Nothing
  , networkSummaryLabels = Nothing
  , networkSummaryPeers = Nothing
  }

-- ** NetworkTaskInfo
-- | NetworkTaskInfo
-- carries the information about one backend task 
data NetworkTaskInfo = NetworkTaskInfo
  { networkTaskInfoName :: !(Maybe Text) -- ^ "Name"
  , networkTaskInfoEndpointId :: !(Maybe Text) -- ^ "EndpointID"
  , networkTaskInfoEndpointIp :: !(Maybe Text) -- ^ "EndpointIP"
  , networkTaskInfoInfo :: !(Maybe (Map.Map String Text)) -- ^ "Info"
  } deriving (P.Show, P.Eq, P.Typeable)

-- | FromJSON NetworkTaskInfo
instance A.FromJSON NetworkTaskInfo where
  parseJSON = A.withObject "NetworkTaskInfo" $ \o ->
    NetworkTaskInfo
      <$> (o .:? "Name")
      <*> (o .:? "EndpointID")
      <*> (o .:? "EndpointIP")
...
-- | ToJSON NetworkTaskInfo
instance A.ToJSON NetworkTaskInfo where
  toJSON NetworkTaskInfo {..} =
   _omitNulls
      [ "Name" .= networkTaskInfoName
      , "EndpointID" .= networkTaskInfoEndpointId
      , "EndpointIP" .= networkTaskInfoEndpointIp
      , "Info" .= networkTaskInfoInfo
      ]


-- | Construct a value of type 'NetworkTaskInfo' (by applying it's required fields, if any)
mkNetworkTaskInfo
  :: NetworkTaskInfo
mkNetworkTaskInfo =
  NetworkTaskInfo
  { networkTaskInfoName = Nothing
  , networkTaskInfoEndpointId = Nothing
  , networkTaskInfoEndpointIp = Nothing
  , networkTaskInfoInfo = Nothing
  }
...
data NetworkingConfig = NetworkingConfig
  { networkingConfigEndpointsConfig :: !(Maybe (Map.Map String EndpointSettings)) -- ^ "EndpointsConfig" - A mapping of network name to endpoint configuration for that network. The endpoint configuration can be left empty to connect to that network with no particular endpoint configuration. 
  } deriving (P.Show, P.Eq, P.Typeable)
...
data OCIDescriptor = OCIDescriptor
  ...
  , oCIDescriptorUrls :: !(Maybe [Text]) -- ^ "urls" - List of URLs from which this object MAY be downloaded.
  , oCIDescriptorAnnotations :: !(Maybe (Map.Map String Text)) -- ^ "annotations" - Arbitrary metadata relating to the targeted content.
  , oCIDescriptorData :: !(Maybe Text) -- ^ "data" - Data is an embedding of the targeted content. This is encoded as a base64 string when marshalled to JSON (automatically, by encoding/json). If present, Data can be used directly to avoid fetching the targeted content.
  , oCIDescriptorPlatform :: !(Maybe OCIPlatform) -- ^ "platform"
  , oCIDescriptorArtifactType :: !(Maybe Text) -- ^ "artifactType" - ArtifactType is the IANA media type of this artifact.
  } deriving (P.Show, P.Eq, P.Typeable)
...
instance A.ToJSON OCIDescriptor where
  toJSON OCIDescriptor {..} =
   _omitNulls
      ...
      , "urls" .= oCIDescriptorUrls
      , "annotations" .= oCIDescriptorAnnotations
      , "data" .= oCIDescriptorData
      , "platform" .= oCIDescriptorPlatform
      , "artifactType" .= oCIDescriptorArtifactType
      ]
...
mkOCIDescriptor =
  ...
  , oCIDescriptorUrls = Nothing
  , oCIDescriptorAnnotations = Nothing
  , oCIDescriptorData = Nothing
  , oCIDescriptorPlatform = Nothing
  , oCIDescriptorArtifactType = Nothing
  }
...
data PeerInfo = PeerInfo
  { peerInfoName :: !(Maybe Text) -- ^ "Name" - ID of the peer-node in the Swarm cluster.
  , peerInfoIp :: !(Maybe Text) -- ^ "IP" - IP-address of the peer-node in the Swarm cluster.
  } deriving (P.Show, P.Eq, P.Typeable)

-- | FromJSON PeerInfo
instance A.FromJSON PeerInfo where
  parseJSON = A.withObject "PeerInfo" $ \o ->
    PeerInfo
      <$> (o .:? "Name")
      <*> (o .:? "IP")

-- | ToJSON PeerInfo
instance A.ToJSON PeerInfo where
  toJSON PeerInfo {..} =
   _omitNulls
      [ "Name" .= peerInfoName
      , "IP" .= peerInfoIp
...
-- | Construct a value of type 'PeerInfo' (by applying it's required fields, if any)
mkPeerInfo
  :: PeerInfo
mkPeerInfo =
  PeerInfo
  { peerInfoName = Nothing
  , peerInfoIp = Nothing
  }
...
data PluginConfigInterface = PluginConfigInterface
  { pluginConfigInterfaceTypes :: !([Text]) -- ^ /Required/ "Types"
...
mkPluginConfigInterface
  :: [Text] -- ^ 'pluginConfigInterfaceTypes' 
...
data PortStatus = PortStatus
  { portStatusPorts :: !(Maybe [EndpointPortConfig]) -- ^ "Ports"
  } deriving (P.Show, P.Eq, P.Typeable)

-- | FromJSON PortStatus
instance A.FromJSON PortStatus where
  parseJSON = A.withObject "PortStatus" $ \o ->
    PortStatus
      <$> (o .:? "Ports")

-- | ToJSON PortStatus
instance A.ToJSON PortStatus where
  toJSON PortStatus {..} =
   _omitNulls
      [ "Ports" .= portStatusPorts
      ]


-- | Construct a value of type 'PortStatus' (by applying it's required fields, if any)
mkPortStatus
  :: PortStatus
mkPortStatus =
  PortStatus
  { portStatusPorts = Nothing
  }

-- ** PortSummary
-- | PortSummary
-- Describes a port-mapping between the container and the host. 
data PortSummary = PortSummary
  { portSummaryIp :: !(Maybe Text) -- ^ "IP" - Host IP address that the container&#39;s port is mapped to
  , portSummaryPrivatePort :: !(Int) -- ^ /Required/ "PrivatePort" - Port on the container
  , portSummaryPublicPort :: !(Maybe Int) -- ^ "PublicPort" - Port exposed on the host
  , portSummaryType :: !(E'Type) -- ^ /Required/ "Type"
  } deriving (P.Show, P.Eq, P.Typeable)

-- | FromJSON PortSummary
instance A.FromJSON PortSummary where
  parseJSON = A.withObject "PortSummary" $ \o ->
    PortSummary
      <$> (o .:? "IP")
      <*> (o .:  "PrivatePort")
      <*> (o .:? "PublicPort")
...
-- | ToJSON PortSummary
instance A.ToJSON PortSummary where
  toJSON PortSummary {..} =
   _omitNulls
      [ "IP" .= portSummaryIp
...
-- | Construct a value of type 'PortSummary' (by applying it's required fields, if any)
mkPortSummary
  :: Int -- ^ 'portSummaryPrivatePort': Port on the container
  -> E'Type -- ^ 'portSummaryType' 
  -> PortSummary
mkPortSummary portSummaryPrivatePort portSummaryType =
  PortSummary
  { portSummaryIp = Nothing
  , portSummaryPrivatePort
  , portSummaryPublicPort = Nothing
  , portSummaryType
  }
...
data PushImageInfo = PushImageInfo
  { pushImageInfoErrorDetail :: !(Maybe ErrorDetail) -- ^ "errorDetail"
...
instance A.ToJSON PushImageInfo where
  toJSON PushImageInfo {..} =
   _omitNulls
      [ "errorDetail" .= pushImageInfoErrorDetail
...
mkPushImageInfo =
  PushImageInfo
  { pushImageInfoErrorDetail = Nothing
...
data RootFSStorage = RootFSStorage
  { rootFSStorageSnapshot :: !(Maybe RootFSStorageSnapshot) -- ^ "Snapshot"
  } deriving (P.Show, P.Eq, P.Typeable)

-- | FromJSON RootFSStorage
instance A.FromJSON RootFSStorage where
  parseJSON = A.withObject "RootFSStorage" $ \o ->
    RootFSStorage
      <$> (o .:? "Snapshot")

-- | ToJSON RootFSStorage
instance A.ToJSON RootFSStorage where
  toJSON RootFSStorage {..} =
   _omitNulls
...
-- | Construct a value of type 'RootFSStorage' (by applying it's required fields, if any)
mkRootFSStorage
  :: RootFSStorage
mkRootFSStorage =
  RootFSStorage
  { rootFSStorageSnapshot = Nothing
  }

-- ** RootFSStorageSnapshot
-- | RootFSStorageSnapshot
-- Information about a snapshot backend of the container's root filesystem. 
data RootFSStorageSnapshot = RootFSStorageSnapshot
  { rootFSStorageSnapshotName :: !(Maybe Text) -- ^ "Name" - Name of the snapshotter.
  } deriving (P.Show, P.Eq, P.Typeable)

-- | FromJSON RootFSStorageSnapshot
instance A.FromJSON RootFSStorageSnapshot where
  parseJSON = A.withObject "RootFSStorageSnapshot" $ \o ->
    RootFSStorageSnapshot
      <$> (o .:? "Name")

-- | ToJSON RootFSStorageSnapshot
instance A.ToJSON RootFSStorageSnapshot where
  toJSON RootFSStorageSnapshot {..} =
   _omitNulls
      [ "Name" .= rootFSStorageSnapshotName
      ]


-- | Construct a value of type 'RootFSStorageSnapshot' (by applying it's required fields, if any)
mkRootFSStorageSnapshot
  :: RootFSStorageSnapshot
mkRootFSStorageSnapshot =
  RootFSStorageSnapshot
  { rootFSStorageSnapshotName = Nothing
  }
...
instance A.ToJSON SecretCreateRequest where
  toJSON SecretCreateRequest {..} =
   _omitNulls
      ...
      , "Templating" .= secretCreateRequestTemplating
      ]
...
mkSecretCreateRequest =
  ...
  , secretCreateRequestTemplating = Nothing
  }
...
data ServiceCreateRequest = ServiceCreateRequest
  ...
  , serviceCreateRequestNetworks :: !(Maybe [NetworkAttachmentConfig]) -- ^ "Networks" - Specifies which networks the service should attach to.  Deprecated: This field is deprecated since v1.44. The Networks field in TaskSpec should be used instead. 
...
data ServiceCreateResponse = ServiceCreateResponse
  ...
  , serviceCreateResponseWarnings :: !(Maybe [Text]) -- ^ "Warnings" - Optional warning message.  FIXME(thaJeztah): this should have \&quot;omitempty\&quot; in the generated type. 
  } deriving (P.Show, P.Eq, P.Typeable)
...
instance A.ToJSON ServiceCreateResponse where
  toJSON ServiceCreateResponse {..} =
   _omitNulls
      ...
      , "Warnings" .= serviceCreateResponseWarnings
      ]
...
mkServiceCreateResponse =
  ...
  , serviceCreateResponseWarnings = Nothing
  }
...
data ServiceInfo = ServiceInfo
  { serviceInfoVip :: !(Maybe Text) -- ^ "VIP"
  , serviceInfoPorts :: !(Maybe [Text]) -- ^ "Ports"
  , serviceInfoLocalLbIndex :: !(Maybe Int) -- ^ "LocalLBIndex"
  , serviceInfoTasks :: !(Maybe [NetworkTaskInfo]) -- ^ "Tasks"
  } deriving (P.Show, P.Eq, P.Typeable)

-- | FromJSON ServiceInfo
instance A.FromJSON ServiceInfo where
  parseJSON = A.withObject "ServiceInfo" $ \o ->
    ServiceInfo
      <$> (o .:? "VIP")
      <*> (o .:? "Ports")
      <*> (o .:? "LocalLBIndex")
...
-- | ToJSON ServiceInfo
instance A.ToJSON ServiceInfo where
  toJSON ServiceInfo {..} =
   _omitNulls
      [ "VIP" .= serviceInfoVip
      , "Ports" .= serviceInfoPorts
      , "LocalLBIndex" .= serviceInfoLocalLbIndex
      , "Tasks" .= serviceInfoTasks
      ]


-- | Construct a value of type 'ServiceInfo' (by applying it's required fields, if any)
mkServiceInfo
  :: ServiceInfo
mkServiceInfo =
  ServiceInfo
  { serviceInfoVip = Nothing
  , serviceInfoPorts = Nothing
  , serviceInfoLocalLbIndex = Nothing
  , serviceInfoTasks = Nothing
  }
...
data ServiceSpec = ServiceSpec
  ...
  , serviceSpecNetworks :: !(Maybe [NetworkAttachmentConfig]) -- ^ "Networks" - Specifies which networks the service should attach to.  Deprecated: This field is deprecated since v1.44. The Networks field in TaskSpec should be used instead. 
...
data ServiceUpdateRequest = ServiceUpdateRequest
  ...
  , serviceUpdateRequestNetworks :: !(Maybe [NetworkAttachmentConfig]) -- ^ "Networks" - Specifies which networks the service should attach to.  Deprecated: This field is deprecated since v1.44. The Networks field in TaskSpec should be used instead. 
...
data ServiceUpdateStatus = ServiceUpdateStatus
  { serviceUpdateStatusState :: !(Maybe E'State2) -- ^ "State"
...
data Storage = Storage
  { storageRootFs :: !(Maybe RootFSStorage) -- ^ "RootFS"
  } deriving (P.Show, P.Eq, P.Typeable)

-- | FromJSON Storage
instance A.FromJSON Storage where
  parseJSON = A.withObject "Storage" $ \o ->
    Storage
      <$> (o .:? "RootFS")

-- | ToJSON Storage
instance A.ToJSON Storage where
  toJSON Storage {..} =
   _omitNulls
      [ "RootFS" .= storageRootFs
      ]


-- | Construct a value of type 'Storage' (by applying it's required fields, if any)
mkStorage
  :: Storage
mkStorage =
  Storage
  { storageRootFs = Nothing
  }

-- ** SubnetStatus
-- | SubnetStatus
data SubnetStatus = SubnetStatus
  { subnetStatusIpsInUse :: !(Maybe Int) -- ^ "IPsInUse" - Number of IP addresses in the subnet that are in use or reserved and are therefore unavailable for allocation, saturating at 2&lt;sup&gt;64&lt;/sup&gt; - 1. 
  , subnetStatusDynamicIpsAvailable :: !(Maybe Int) -- ^ "DynamicIPsAvailable" - Number of IP addresses within the network&#39;s IPRange for the subnet that are available for allocation, saturating at 2&lt;sup&gt;64&lt;/sup&gt; - 1. 
  } deriving (P.Show, P.Eq, P.Typeable)

-- | FromJSON SubnetStatus
instance A.FromJSON SubnetStatus where
  parseJSON = A.withObject "SubnetStatus" $ \o ->
    SubnetStatus
      <$> (o .:? "IPsInUse")
      <*> (o .:? "DynamicIPsAvailable")

-- | ToJSON SubnetStatus
instance A.ToJSON SubnetStatus where
  toJSON SubnetStatus {..} =
   _omitNulls
      [ "IPsInUse" .= subnetStatusIpsInUse
      , "DynamicIPsAvailable" .= subnetStatusDynamicIpsAvailable
      ]


-- | Construct a value of type 'SubnetStatus' (by applying it's required fields, if any)
mkSubnetStatus
  :: SubnetStatus
mkSubnetStatus =
  SubnetStatus
  { subnetStatusIpsInUse = Nothing
  , subnetStatusDynamicIpsAvailable = Nothing
  }
...
data SystemDataUsageResponse = SystemDataUsageResponse
  { systemDataUsageResponseImagesDiskUsage :: !(Maybe ImagesDiskUsage) -- ^ "ImagesDiskUsage"
  , systemDataUsageResponseContainersDiskUsage :: !(Maybe ContainersDiskUsage) -- ^ "ContainersDiskUsage"
  , systemDataUsageResponseVolumesDiskUsage :: !(Maybe VolumesDiskUsage) -- ^ "VolumesDiskUsage"
  , systemDataUsageResponseBuildCacheDiskUsage :: !(Maybe BuildCacheDiskUsage) -- ^ "BuildCacheDiskUsage"
  } deriving (P.Show, P.Eq, P.Typeable)
...
instance A.FromJSON SystemDataUsageResponse where
  parseJSON = A.withObject "SystemDataUsageResponse" $ \o ->
    SystemDataUsageResponse
      <$> (o .:? "ImagesDiskUsage")
      <*> (o .:? "ContainersDiskUsage")
      <*> (o .:? "VolumesDiskUsage")
      <*> (o .:? "BuildCacheDiskUsage")

-- | ToJSON SystemDataUsageResponse
instance A.ToJSON SystemDataUsageResponse where
  toJSON SystemDataUsageResponse {..} =
   _omitNulls
      [ "ImagesDiskUsage" .= systemDataUsageResponseImagesDiskUsage
      , "ContainersDiskUsage" .= systemDataUsageResponseContainersDiskUsage
      , "VolumesDiskUsage" .= systemDataUsageResponseVolumesDiskUsage
      , "BuildCacheDiskUsage" .= systemDataUsageResponseBuildCacheDiskUsage
      ]
...
mkSystemDataUsageResponse =
  SystemDataUsageResponse
  { systemDataUsageResponseImagesDiskUsage = Nothing
  , systemDataUsageResponseContainersDiskUsage = Nothing
  , systemDataUsageResponseVolumesDiskUsage = Nothing
  , systemDataUsageResponseBuildCacheDiskUsage = Nothing
  }
...
data SystemInfo = SystemInfo
  ...
  , systemInfoOperatingSystem :: !(Maybe Text) -- ^ "OperatingSystem" - Name of the host&#39;s operating system, for example: \&quot;Ubuntu 24.04 LTS\&quot; or \&quot;Windows Server 2016 Datacenter\&quot; 
  ...
  , systemInfoSecurityOptions :: !(Maybe [Text]) -- ^ "SecurityOptions" - List of security features that are enabled on the daemon, such as apparmor, seccomp, SELinux, user-namespaces (userns), rootless and no-new-privileges.  Additional configuration options for each security feature may be present, and are included as a comma-separated list of key/value pairs. 
  ...
  , systemInfoFirewallBackend :: !(Maybe FirewallInfo) -- ^ "FirewallBackend"
  , systemInfoDiscoveredDevices :: !(Maybe [DeviceInfo]) -- ^ "DiscoveredDevices" - List of devices discovered by device drivers.  Each device includes information about its source driver, kind, name, and additional driver-specific attributes. 
...
instance A.ToJSON SystemInfo where
  toJSON SystemInfo {..} =
   _omitNulls
      ...
      , "FirewallBackend" .= systemInfoFirewallBackend
      , "DiscoveredDevices" .= systemInfoDiscoveredDevices
      , "Warnings" .= systemInfoWarnings
      , "CDISpecDirs" .= systemInfoCdiSpecDirs
      , "Containerd" .= systemInfoContainerd
      ]
...
mkSystemInfo =
  ...
  , systemInfoFirewallBackend = Nothing
  , systemInfoDiscoveredDevices = Nothing
  , systemInfoWarnings = Nothing
  , systemInfoCdiSpecDirs = Nothing
  , systemInfoContainerd = Nothing
  }

-- ** SystemInfoDefaultAddressPoolsInner
-- | SystemInfoDefaultAddressPoolsInner
data SystemInfoDefaultAddressPoolsInner = SystemInfoDefaultAddressPoolsInner
  { systemInfoDefaultAddressPoolsInnerBase :: !(Maybe Text) -- ^ "Base" - The network address in CIDR format
  , systemInfoDefaultAddressPoolsInnerSize :: !(Maybe Int) -- ^ "Size" - The network pool size
  } deriving (P.Show, P.Eq, P.Typeable)

-- | FromJSON SystemInfoDefaultAddressPoolsInner
instance A.FromJSON SystemInfoDefaultAddressPoolsInner where
  parseJSON = A.withObject "SystemInfoDefaultAddressPoolsInner" $ \o ->
    SystemInfoDefaultAddressPoolsInner
      <$> (o .:? "Base")
      <*> (o .:? "Size")

-- | ToJSON SystemInfoDefaultAddressPoolsInner
instance A.ToJSON SystemInfoDefaultAddressPoolsInner where
  toJSON SystemInfoDefaultAddressPoolsInner {..} =
   _omitNulls
      [ "Base" .= systemInfoDefaultAddressPoolsInnerBase
      , "Size" .= systemInfoDefaultAddressPoolsInnerSize
      ]


-- | Construct a value of type 'SystemInfoDefaultAddressPoolsInner' (by applying it's required fields, if any)
mkSystemInfoDefaultAddressPoolsInner
  :: SystemInfoDefaultAddressPoolsInner
mkSystemInfoDefaultAddressPoolsInner =
  SystemInfoDefaultAddressPoolsInner
  { systemInfoDefaultAddressPoolsInnerBase = Nothing
  , systemInfoDefaultAddressPoolsInnerSize = Nothing
  }
...
data SystemVersion = SystemVersion
  ...
  , systemVersionComponents :: !(Maybe [SystemVersionComponentsInner]) -- ^ "Components" - Information about system components 
...
-- | SystemVersionComponentsInner
data SystemVersionComponentsInner = SystemVersionComponentsInner
  { systemVersionComponentsInnerName :: !(Text) -- ^ /Required/ "Name" - Name of the component 
  , systemVersionComponentsInnerVersion :: !(Text) -- ^ /Required/ "Version" - Version of the component 
  , systemVersionComponentsInnerDetails :: !(Maybe A.Value) -- ^ "Details" - Key/value pairs of strings with additional information about the component. These values are intended for informational purposes only, and their content is not defined, and not part of the API specification.  These messages can be printed by the client as information to the user. 
  } deriving (P.Show, P.Eq, P.Typeable)

-- | FromJSON SystemVersionComponentsInner
instance A.FromJSON SystemVersionComponentsInner where
  parseJSON = A.withObject "SystemVersionComponentsInner" $ \o ->
    SystemVersionComponentsInner
      <$> (o .:  "Name")
      <*> (o .:  "Version")
      <*> (o .:? "Details")

-- | ToJSON SystemVersionComponentsInner
instance A.ToJSON SystemVersionComponentsInner where
  toJSON SystemVersionComponentsInner {..} =
   _omitNulls
      [ "Name" .= systemVersionComponentsInnerName
      , "Version" .= systemVersionComponentsInnerVersion
      , "Details" .= systemVersionComponentsInnerDetails
      ]


-- | Construct a value of type 'SystemVersionComponentsInner' (by applying it's required fields, if any)
mkSystemVersionComponentsInner
  :: Text -- ^ 'systemVersionComponentsInnerName': Name of the component 
  -> Text -- ^ 'systemVersionComponentsInnerVersion': Version of the component 
  -> SystemVersionComponentsInner
mkSystemVersionComponentsInner systemVersionComponentsInnerName systemVersionComponentsInnerVersion =
  SystemVersionComponentsInner
  { systemVersionComponentsInnerName
  , systemVersionComponentsInnerVersion
  , systemVersionComponentsInnerDetails = Nothing
  }
...
data TaskSpecContainerSpec = TaskSpecContainerSpec
  ...
  , taskSpecContainerSpecOomScoreAdj :: !(Maybe Integer) -- ^ "OomScoreAdj" - An integer value containing the score given to the container in order to tune OOM killer preferences. 
  ...
  , taskSpecContainerSpecUlimits :: !(Maybe [ResourcesUlimitsInner]) -- ^ "Ulimits" - A list of resource limits to set in the container. For example: &#x60;{\&quot;Name\&quot;: \&quot;nofile\&quot;, \&quot;Soft\&quot;: 1024, \&quot;Hard\&quot;: 2048}&#x60;\&quot; 
  } deriving (P.Show, P.Eq, P.Typeable)
...
instance A.ToJSON TaskSpecContainerSpec where
  toJSON TaskSpecContainerSpec {..} =
   _omitNulls
      ...
      , "OomScoreAdj" .= taskSpecContainerSpecOomScoreAdj
...
mkTaskSpecContainerSpec =
  ...
  , taskSpecContainerSpecOomScoreAdj = Nothing
...
data TaskSpecContainerSpecConfigsInner = TaskSpecContainerSpecConfigsInner
  { taskSpecContainerSpecConfigsInnerFile :: !(Maybe TaskSpecContainerSpecConfigsInnerFile) -- ^ "File"
  , taskSpecContainerSpecConfigsInnerRuntime :: !(Maybe A.Value) -- ^ "Runtime" - Runtime represents a target that is not mounted into the container but is used by the task  &lt;p&gt;&lt;br /&gt;&lt;p&gt;  &gt; **Note**: &#x60;Configs.File&#x60; and &#x60;Configs.Runtime&#x60; are mutually &gt; exclusive 
...
instance A.ToJSON TaskSpecContainerSpecConfigsInner where
  toJSON TaskSpecContainerSpecConfigsInner {..} =
   _omitNulls
      ...
      , "Runtime" .= taskSpecContainerSpecConfigsInnerRuntime
...
mkTaskSpecContainerSpecConfigsInner =
  ...
  , taskSpecContainerSpecConfigsInnerRuntime = Nothing
...
data TaskSpecContainerSpecConfigsInnerFile = TaskSpecContainerSpecConfigsInnerFile
  { taskSpecContainerSpecConfigsInnerFileName :: !(Maybe Text) -- ^ "Name" - Name represents the final filename in the filesystem. 
  , taskSpecContainerSpecConfigsInnerFileUid :: !(Maybe Text) -- ^ "UID" - UID represents the file UID.
  , taskSpecContainerSpecConfigsInnerFileGid :: !(Maybe Text) -- ^ "GID" - GID represents the file GID.
  , taskSpecContainerSpecConfigsInnerFileMode :: !(Maybe Int) -- ^ "Mode" - Mode represents the FileMode of the file.
  } deriving (P.Show, P.Eq, P.Typeable)

-- | FromJSON TaskSpecContainerSpecConfigsInnerFile
instance A.FromJSON TaskSpecContainerSpecConfigsInnerFile where
  parseJSON = A.withObject "TaskSpecContainerSpecConfigsInnerFile" $ \o ->
    TaskSpecContainerSpecConfigsInnerFile
      <$> (o .:? "Name")
      <*> (o .:? "UID")
      <*> (o .:? "GID")
...
-- | ToJSON TaskSpecContainerSpecConfigsInnerFile
instance A.ToJSON TaskSpecContainerSpecConfigsInnerFile where
  toJSON TaskSpecContainerSpecConfigsInnerFile {..} =
   _omitNulls
      [ "Name" .= taskSpecContainerSpecConfigsInnerFileName
      , "UID" .= taskSpecContainerSpecConfigsInnerFileUid
      , "GID" .= taskSpecContainerSpecConfigsInnerFileGid
      , "Mode" .= taskSpecContainerSpecConfigsInnerFileMode
      ]


-- | Construct a value of type 'TaskSpecContainerSpecConfigsInnerFile' (by applying it's required fields, if any)
mkTaskSpecContainerSpecConfigsInnerFile
  :: TaskSpecContainerSpecConfigsInnerFile
mkTaskSpecContainerSpecConfigsInnerFile =
  TaskSpecContainerSpecConfigsInnerFile
  { taskSpecContainerSpecConfigsInnerFileName = Nothing
  , taskSpecContainerSpecConfigsInnerFileUid = Nothing
  , taskSpecContainerSpecConfigsInnerFileGid = Nothing
  , taskSpecContainerSpecConfigsInnerFileMode = Nothing
  }
...
data TaskSpecContainerSpecPrivileges = TaskSpecContainerSpecPrivileges
  ...
  , taskSpecContainerSpecPrivilegesSeccomp :: !(Maybe TaskSpecContainerSpecPrivilegesSeccomp) -- ^ "Seccomp"
  , taskSpecContainerSpecPrivilegesAppArmor :: !(Maybe TaskSpecContainerSpecPrivilegesAppArmor) -- ^ "AppArmor"
  , taskSpecContainerSpecPrivilegesNoNewPrivileges :: !(Maybe Bool) -- ^ "NoNewPrivileges" - Configuration of the no_new_privs bit in the container
  } deriving (P.Show, P.Eq, P.Typeable)
...
instance A.ToJSON TaskSpecContainerSpecPrivileges where
  toJSON TaskSpecContainerSpecPrivileges {..} =
   _omitNulls
      ...
      , "NoNewPrivileges" .= taskSpecContainerSpecPrivilegesNoNewPrivileges
      ]
...
mkTaskSpecContainerSpecPrivileges =
  ...
  , taskSpecContainerSpecPrivilegesSeccomp = Nothing
  , taskSpecContainerSpecPrivilegesAppArmor = Nothing
  , taskSpecContainerSpecPrivilegesNoNewPrivileges = Nothing
  }

-- ** TaskSpecContainerSpecPrivilegesAppArmor
-- | TaskSpecContainerSpecPrivilegesAppArmor
-- Options for configuring AppArmor on the container
data TaskSpecContainerSpecPrivilegesAppArmor = TaskSpecContainerSpecPrivilegesAppArmor
  { taskSpecContainerSpecPrivilegesAppArmorMode :: !(Maybe E'Mode3) -- ^ "Mode"
  } deriving (P.Show, P.Eq, P.Typeable)

-- | FromJSON TaskSpecContainerSpecPrivilegesAppArmor
instance A.FromJSON TaskSpecContainerSpecPrivilegesAppArmor where
  parseJSON = A.withObject "TaskSpecContainerSpecPrivilegesAppArmor" $ \o ->
    TaskSpecContainerSpecPrivilegesAppArmor
      <$> (o .:? "Mode")

-- | ToJSON TaskSpecContainerSpecPrivilegesAppArmor
instance A.ToJSON TaskSpecContainerSpecPrivilegesAppArmor where
  toJSON TaskSpecContainerSpecPrivilegesAppArmor {..} =
   _omitNulls
      [ "Mode" .= taskSpecContainerSpecPrivilegesAppArmorMode
      ]


-- | Construct a value of type 'TaskSpecContainerSpecPrivilegesAppArmor' (by applying it's required fields, if any)
mkTaskSpecContainerSpecPrivilegesAppArmor
  :: TaskSpecContainerSpecPrivilegesAppArmor
mkTaskSpecContainerSpecPrivilegesAppArmor =
  TaskSpecContainerSpecPrivilegesAppArmor
  { taskSpecContainerSpecPrivilegesAppArmorMode = Nothing
  }
...
data TaskSpecContainerSpecPrivilegesSeccomp = TaskSpecContainerSpecPrivilegesSeccomp
  { taskSpecContainerSpecPrivilegesSeccompMode :: !(Maybe E'Mode2) -- ^ "Mode"
  , taskSpecContainerSpecPrivilegesSeccompProfile :: !(Maybe Text) -- ^ "Profile" - The custom seccomp profile as a json object
  } deriving (P.Show, P.Eq, P.Typeable)

-- | FromJSON TaskSpecContainerSpecPrivilegesSeccomp
instance A.FromJSON TaskSpecContainerSpecPrivilegesSeccomp where
  parseJSON = A.withObject "TaskSpecContainerSpecPrivilegesSeccomp" $ \o ->
    TaskSpecContainerSpecPrivilegesSeccomp
      <$> (o .:? "Mode")
      <*> (o .:? "Profile")

-- | ToJSON TaskSpecContainerSpecPrivilegesSeccomp
instance A.ToJSON TaskSpecContainerSpecPrivilegesSeccomp where
  toJSON TaskSpecContainerSpecPrivilegesSeccomp {..} =
   _omitNulls
      [ "Mode" .= taskSpecContainerSpecPrivilegesSeccompMode
      , "Profile" .= taskSpecContainerSpecPrivilegesSeccompProfile
      ]


-- | Construct a value of type 'TaskSpecContainerSpecPrivilegesSeccomp' (by applying it's required fields, if any)
mkTaskSpecContainerSpecPrivilegesSeccomp
  :: TaskSpecContainerSpecPrivilegesSeccomp
mkTaskSpecContainerSpecPrivilegesSeccomp =
  TaskSpecContainerSpecPrivilegesSeccomp
  { taskSpecContainerSpecPrivilegesSeccompMode = Nothing
  , taskSpecContainerSpecPrivilegesSeccompProfile = Nothing
  }
...
data TaskSpecResources = TaskSpecResources
  ...
  , taskSpecResourcesSwapBytes :: !(Maybe Integer) -- ^ "SwapBytes" - Amount of swap in bytes - can only be used together with a memory limit. If not specified, the default behaviour is to grant a swap space twice as big as the memory limit. Set to -1 to enable unlimited swap. 
  , taskSpecResourcesMemorySwappiness :: !(Maybe Integer) -- ^ "MemorySwappiness" - Tune the service&#39;s containers&#39; memory swappiness (0 to 100). If not specified, defaults to the containers&#39; OS&#39; default, generally 60, or whatever value was predefined in the image. Set to -1 to unset a previously set value. 
  } deriving (P.Show, P.Eq, P.Typeable)
...
instance A.ToJSON TaskSpecResources where
  toJSON TaskSpecResources {..} =
   _omitNulls
      ...
      , "SwapBytes" .= taskSpecResourcesSwapBytes
      , "MemorySwappiness" .= taskSpecResourcesMemorySwappiness
      ]
...
mkTaskSpecResources =
  ...
  , taskSpecResourcesSwapBytes = Nothing
  , taskSpecResourcesMemorySwappiness = Nothing
  }
...
data TaskStatus = TaskStatus
  ...
  , taskStatusContainerStatus :: !(Maybe ContainerStatus) -- ^ "ContainerStatus"
  , taskStatusPortStatus :: !(Maybe PortStatus) -- ^ "PortStatus"
  } deriving (P.Show, P.Eq, P.Typeable)
...
instance A.ToJSON TaskStatus where
  toJSON TaskStatus {..} =
   _omitNulls
      ...
      , "PortStatus" .= taskStatusPortStatus
      ]
...
data Volume = Volume
  ...
  , volumeClusterVolume :: !(Maybe ClusterVolume) -- ^ "ClusterVolume"
...
instance A.ToJSON Volume where
  toJSON Volume {..} =
   _omitNulls
      ...
      , "Labels" .= volumeLabels
      , "Scope" .= volumeScope
      , "ClusterVolume" .= volumeClusterVolume
...
data VolumeCreateRequest = VolumeCreateRequest
  ...
  , volumeCreateRequestClusterVolumeSpec :: !(Maybe ClusterVolumeSpec) -- ^ "ClusterVolumeSpec"
  } deriving (P.Show, P.Eq, P.Typeable)
...
instance A.ToJSON VolumeCreateRequest where
  toJSON VolumeCreateRequest {..} =
   _omitNulls
      ...
      , "ClusterVolumeSpec" .= volumeCreateRequestClusterVolumeSpec
      ]
...
mkVolumeCreateRequest =
  ...
  , volumeCreateRequestClusterVolumeSpec = Nothing
  }
...
data VolumeListResponse = VolumeListResponse
  { volumeListResponseVolumes :: !(Maybe [Volume]) -- ^ "Volumes" - List of volumes
  , volumeListResponseWarnings :: !(Maybe [Text]) -- ^ "Warnings" - Warnings that occurred when fetching the list of volumes. 
  } deriving (P.Show, P.Eq, P.Typeable)
...
mkVolumeListResponse =
  VolumeListResponse
  { volumeListResponseVolumes = Nothing
  , volumeListResponseWarnings = Nothing
  }
...
-- | VolumeUpdateRequest
-- Volume configuration
data VolumeUpdateRequest = VolumeUpdateRequest
  { volumeUpdateRequestSpec :: !(Maybe ClusterVolumeSpec) -- ^ "Spec"
  } deriving (P.Show, P.Eq, P.Typeable)

-- | FromJSON VolumeUpdateRequest
instance A.FromJSON VolumeUpdateRequest where
  parseJSON = A.withObject "VolumeUpdateRequest" $ \o ->
    VolumeUpdateRequest
      <$> (o .:? "Spec")

-- | ToJSON VolumeUpdateRequest
instance A.ToJSON VolumeUpdateRequest where
  toJSON VolumeUpdateRequest {..} =
   _omitNulls
      [ "Spec" .= volumeUpdateRequestSpec
      ]


-- | Construct a value of type 'VolumeUpdateRequest' (by applying it's required fields, if any)
mkVolumeUpdateRequest
  :: VolumeUpdateRequest
mkVolumeUpdateRequest =
  VolumeUpdateRequest
  { volumeUpdateRequestSpec = Nothing
  }
...
data VolumesDiskUsage = VolumesDiskUsage
  { volumesDiskUsageActiveCount :: !(Maybe Integer) -- ^ "ActiveCount" - Count of active volumes. 
  , volumesDiskUsageTotalCount :: !(Maybe Integer) -- ^ "TotalCount" - Count of all volumes. 
  , volumesDiskUsageReclaimable :: !(Maybe Integer) -- ^ "Reclaimable" - Disk space that can be reclaimed by removing inactive volumes. 
  , volumesDiskUsageTotalSize :: !(Maybe Integer) -- ^ "TotalSize" - Disk space in use by volumes. 
  , volumesDiskUsageItems :: !(Maybe [A.Value]) -- ^ "Items" - List of volumes. 
  } deriving (P.Show, P.Eq, P.Typeable)

-- | FromJSON VolumesDiskUsage
instance A.FromJSON VolumesDiskUsage where
  parseJSON = A.withObject "VolumesDiskUsage" $ \o ->
    VolumesDiskUsage
      <$> (o .:? "ActiveCount")
      <*> (o .:? "TotalCount")
      <*> (o .:? "Reclaimable")
...
-- | ToJSON VolumesDiskUsage
instance A.ToJSON VolumesDiskUsage where
  toJSON VolumesDiskUsage {..} =
   _omitNulls
      [ "ActiveCount" .= volumesDiskUsageActiveCount
      , "TotalCount" .= volumesDiskUsageTotalCount
      , "Reclaimable" .= volumesDiskUsageReclaimable
      , "TotalSize" .= volumesDiskUsageTotalSize
      , "Items" .= volumesDiskUsageItems
      ]


-- | Construct a value of type 'VolumesDiskUsage' (by applying it's required fields, if any)
mkVolumesDiskUsage
  :: VolumesDiskUsage
mkVolumesDiskUsage =
  VolumesDiskUsage
  { volumesDiskUsageActiveCount = Nothing
  , volumesDiskUsageTotalCount = Nothing
  , volumesDiskUsageReclaimable = Nothing
  , volumesDiskUsageTotalSize = Nothing
  , volumesDiskUsageItems = Nothing
  }
...
instance A.ToJSON ChangeType where toJSON = A.toJSON . fromChangeType
instance A.FromJSON ChangeType where parseJSON o = P.either P.fail (pure . P.id) . toChangeType =<< A.parseJSON o
instance WH.ToHttpApiData ChangeType where toQueryParam = WH.toQueryParam . fromChangeType
instance WH.FromHttpApiData ChangeType where parseQueryParam o = WH.parseQueryParam o >>= P.left T.pack . toChangeType
instance MimeRender MimeMultipartFormData ChangeType where mimeRender _ = mimeRenderDefaultMultipartFormData

-- | unwrap 'ChangeType' enum
fromChangeType :: ChangeType -> Int
fromChangeType = \case
  ChangeType'Num0 -> 0
  ChangeType'Num1 -> 1
  ChangeType'Num2 -> 2

-- | parse 'ChangeType' enum
toChangeType :: Int -> P.Either String ChangeType
toChangeType = \case
  0 -> P.Right ChangeType'Num0
  1 -> P.Right ChangeType'Num1
  2 -> P.Right ChangeType'Num2
  s -> P.Left $ "toChangeType: enum parse failure: " P.++ P.show s
...
data E'Kind
  = E'Kind'Image -- ^ @"image"@
  | E'Kind'Attestation -- ^ @"attestation"@
  | E'Kind'Unknown -- ^ @"unknown"@
  deriving (P.Show, P.Eq, P.Typeable, P.Ord, P.Bounded, P.Enum)
...
toE'Kind = \case
  "image" -> P.Right E'Kind'Image
  "attestation" -> P.Right E'Kind'Attestation
  "unknown" -> P.Right E'Kind'Unknown
...
-- | Enum of 'Text'
data E'Mode2
  = E'Mode2'Default -- ^ @"default"@
  | E'Mode2'Unconfined -- ^ @"unconfined"@
  | E'Mode2'Custom -- ^ @"custom"@
  deriving (P.Show, P.Eq, P.Typeable, P.Ord, P.Bounded, P.Enum)
...
toE'Mode2 = \case
  "default" -> P.Right E'Mode2'Default
  "unconfined" -> P.Right E'Mode2'Unconfined
  "custom" -> P.Right E'Mode2'Custom
...
-- | Enum of 'Text'
data E'Mode3
  = E'Mode3'Default -- ^ @"default"@
  | E'Mode3'Disabled -- ^ @"disabled"@
  deriving (P.Show, P.Eq, P.Typeable, P.Ord, P.Bounded, P.Enum)

instance A.ToJSON E'Mode3 where toJSON = A.toJSON . fromE'Mode3
instance A.FromJSON E'Mode3 where parseJSON o = P.either P.fail (pure . P.id) . toE'Mode3 =<< A.parseJSON o
instance WH.ToHttpApiData E'Mode3 where toQueryParam = WH.toQueryParam . fromE'Mode3
instance WH.FromHttpApiData E'Mode3 where parseQueryParam o = WH.parseQueryParam o >>= P.left T.pack . toE'Mode3
instance MimeRender MimeMultipartFormData E'Mode3 where mimeRender _ = mimeRenderDefaultMultipartFormData

-- | unwrap 'E'Mode3' enum
fromE'Mode3 :: E'Mode3 -> Text
fromE'Mode3 = \case
  E'Mode3'Default -> "default"
  E'Mode3'Disabled -> "disabled"

-- | parse 'E'Mode3' enum
toE'Mode3 :: Text -> P.Either String E'Mode3
toE'Mode3 = \case
  "default" -> P.Right E'Mode3'Default
  "disabled" -> P.Right E'Mode3'Disabled
  s -> P.Left $ "toE'Mode3: enum parse failure: " P.++ P.show s
...
data E'Scope3
  = E'Scope3'Single -- ^ @"single"@
  | E'Scope3'Multi -- ^ @"multi"@
  deriving (P.Show, P.Eq, P.Typeable, P.Ord, P.Bounded, P.Enum)

instance A.ToJSON E'Scope3 where toJSON = A.toJSON . fromE'Scope3
instance A.FromJSON E'Scope3 where parseJSON o = P.either P.fail (pure . P.id) . toE'Scope3 =<< A.parseJSON o
instance WH.ToHttpApiData E'Scope3 where toQueryParam = WH.toQueryParam . fromE'Scope3
instance WH.FromHttpApiData E'Scope3 where parseQueryParam o = WH.parseQueryParam o >>= P.left T.pack . toE'Scope3
instance MimeRender MimeMultipartFormData E'Scope3 where mimeRender _ = mimeRenderDefaultMultipartFormData

-- | unwrap 'E'Scope3' enum
fromE'Scope3 :: E'Scope3 -> Text
fromE'Scope3 = \case
  E'Scope3'Single -> "single"
  E'Scope3'Multi -> "multi"

-- | parse 'E'Scope3' enum
toE'Scope3 :: Text -> P.Either String E'Scope3
toE'Scope3 = \case
  "single" -> P.Right E'Scope3'Single
  "multi" -> P.Right E'Scope3'Multi
  s -> P.Left $ "toE'Scope3: enum parse failure: " P.++ P.show s
...
data E'Sharing
  = E'Sharing'None -- ^ @"none"@
  | E'Sharing'Readonly -- ^ @"readonly"@
  | E'Sharing'Onewriter -- ^ @"onewriter"@
  | E'Sharing'All -- ^ @"all"@
  deriving (P.Show, P.Eq, P.Typeable, P.Ord, P.Bounded, P.Enum)

instance A.ToJSON E'Sharing where toJSON = A.toJSON . fromE'Sharing
instance A.FromJSON E'Sharing where parseJSON o = P.either P.fail (pure . P.id) . toE'Sharing =<< A.parseJSON o
instance WH.ToHttpApiData E'Sharing where toQueryParam = WH.toQueryParam . fromE'Sharing
instance WH.FromHttpApiData E'Sharing where parseQueryParam o = WH.parseQueryParam o >>= P.left T.pack . toE'Sharing
instance MimeRender MimeMultipartFormData E'Sharing where mimeRender _ = mimeRenderDefaultMultipartFormData

-- | unwrap 'E'Sharing' enum
fromE'Sharing :: E'Sharing -> Text
fromE'Sharing = \case
  E'Sharing'None -> "none"
  E'Sharing'Readonly -> "readonly"
  E'Sharing'Onewriter -> "onewriter"
...
-- | parse 'E'Sharing' enum
toE'Sharing :: Text -> P.Either String E'Sharing
toE'Sharing = \case
  "none" -> P.Right E'Sharing'None
  "readonly" -> P.Right E'Sharing'Readonly
  "onewriter" -> P.Right E'Sharing'Onewriter
  "all" -> P.Right E'Sharing'All
  s -> P.Left $ "toE'Sharing: enum parse failure: " P.++ P.show s
...
data E'State
  ...
  | E'State'Running -- ^ @"running"@
  | E'State'Paused -- ^ @"paused"@
  | E'State'Restarting -- ^ @"restarting"@
  | E'State'Exited -- ^ @"exited"@
  | E'State'Removing -- ^ @"removing"@
  | E'State'Dead -- ^ @"dead"@
  deriving (P.Show, P.Eq, P.Typeable, P.Ord, P.Bounded, P.Enum)
...
toE'State = \case
  ...
  "running" -> P.Right E'State'Running
  "paused" -> P.Right E'State'Paused
  "restarting" -> P.Right E'State'Restarting
  "exited" -> P.Right E'State'Exited
  "removing" -> P.Right E'State'Removing
  "dead" -> P.Right E'State'Dead
...
-- | Enum of 'Text'
data E'State2
  = E'State2'Updating -- ^ @"updating"@
  | E'State2'Paused -- ^ @"paused"@
  | E'State2'Completed -- ^ @"completed"@
  deriving (P.Show, P.Eq, P.Typeable, P.Ord, P.Bounded, P.Enum)
...
toE'State2 = \case
  "updating" -> P.Right E'State2'Updating
  "paused" -> P.Right E'State2'Paused
  "completed" -> P.Right E'State2'Completed
...
data E'State3
  = E'State3'Pending_publish -- ^ @"pending-publish"@
  | E'State3'Published -- ^ @"published"@
  | E'State3'Pending_node_unpublish -- ^ @"pending-node-unpublish"@
  | E'State3'Pending_controller_unpublish -- ^ @"pending-controller-unpublish"@
  deriving (P.Show, P.Eq, P.Typeable, P.Ord, P.Bounded, P.Enum)
...
toE'State3 = \case
  "pending-publish" -> P.Right E'State3'Pending_publish
  "published" -> P.Right E'State3'Published
  "pending-node-unpublish" -> P.Right E'State3'Pending_node_unpublish
  "pending-controller-unpublish" -> P.Right E'State3'Pending_controller_unpublish
...
-- | Enum of 'Text'
data E'Swarm
  = E'Swarm'Inactive -- ^ @"inactive"@
  | E'Swarm'Pending -- ^ @"pending"@
  | E'Swarm'Error -- ^ @"error"@
  | E'Swarm'Locked -- ^ @"locked"@
  | E'Swarm'Active_worker -- ^ @"active/worker"@
  | E'Swarm'Active_manager -- ^ @"active/manager"@
  deriving (P.Show, P.Eq, P.Typeable, P.Ord, P.Bounded, P.Enum)

instance A.ToJSON E'Swarm where toJSON = A.toJSON . fromE'Swarm
instance A.FromJSON E'Swarm where parseJSON o = P.either P.fail (pure . P.id) . toE'Swarm =<< A.parseJSON o
instance WH.ToHttpApiData E'Swarm where toQueryParam = WH.toQueryParam . fromE'Swarm
instance WH.FromHttpApiData E'Swarm where parseQueryParam o = WH.parseQueryParam o >>= P.left T.pack . toE'Swarm
instance MimeRender MimeMultipartFormData E'Swarm where mimeRender _ = mimeRenderDefaultMultipartFormData

-- | unwrap 'E'Swarm' enum
fromE'Swarm :: E'Swarm -> Text
fromE'Swarm = \case
  E'Swarm'Inactive -> "inactive"
  E'Swarm'Pending -> "pending"
  E'Swarm'Error -> "error"
...
-- | parse 'E'Swarm' enum
toE'Swarm :: Text -> P.Either String E'Swarm
toE'Swarm = \case
  "inactive" -> P.Right E'Swarm'Inactive
  "pending" -> P.Right E'Swarm'Pending
  "error" -> P.Right E'Swarm'Error
  "locked" -> P.Right E'Swarm'Locked
  "active/worker" -> P.Right E'Swarm'Active_worker
  "active/manager" -> P.Right E'Swarm'Active_manager
  s -> P.Left $ "toE'Swarm: enum parse failure: " P.++ P.show s
...
toE'Type2 = \case
  ...
  "image" -> P.Right E'Type2'Image
  "tmpfs" -> P.Right E'Type2'Tmpfs
  "npipe" -> P.Right E'Type2'Npipe
  "cluster" -> P.Right E'Type2'Cluster
...
-- Cache record type. 
data E'Type3
  = E'Type3'Internal -- ^ @"internal"@
  | E'Type3'Frontend -- ^ @"frontend"@
  | E'Type3'Source_local -- ^ @"source.local"@
  | E'Type3'Source_git_checkout -- ^ @"source.git.checkout"@
  | E'Type3'Exec_cachemount -- ^ @"exec.cachemount"@
  | E'Type3'Regular -- ^ @"regular"@
  deriving (P.Show, P.Eq, P.Typeable, P.Ord, P.Bounded, P.Enum)
...
toE'Type3 = \case
  "internal" -> P.Right E'Type3'Internal
  "frontend" -> P.Right E'Type3'Frontend
  "source.local" -> P.Right E'Type3'Source_local
  "source.git.checkout" -> P.Right E'Type3'Source_git_checkout
  "exec.cachemount" -> P.Right E'Type3'Exec_cachemount
  "regular" -> P.Right E'Type3'Regular
...
data E'Type4
  = E'Type4'Builder -- ^ @"builder"@
  | E'Type4'Config -- ^ @"config"@
  | E'Type4'Container -- ^ @"container"@
  | E'Type4'Daemon -- ^ @"daemon"@
  | E'Type4'Image -- ^ @"image"@
  | E'Type4'Network -- ^ @"network"@
  | E'Type4'Node -- ^ @"node"@
  | E'Type4'Plugin -- ^ @"plugin"@
  | E'Type4'Secret -- ^ @"secret"@
  | E'Type4'Service -- ^ @"service"@
  | E'Type4'Volume -- ^ @"volume"@
  deriving (P.Show, P.Eq, P.Typeable, P.Ord, P.Bounded, P.Enum)
...
toE'Type4 = \case
  "builder" -> P.Right E'Type4'Builder
  "config" -> P.Right E'Type4'Config
  "container" -> P.Right E'Type4'Container
  "daemon" -> P.Right E'Type4'Daemon
  "image" -> P.Right E'Type4'Image
  "network" -> P.Right E'Type4'Network
  "node" -> P.Right E'Type4'Node
  "plugin" -> P.Right E'Type4'Plugin
  "secret" -> P.Right E'Type4'Secret
  "service" -> P.Right E'Type4'Service
  "volume" -> P.Right E'Type4'Volume
...
data E'Type5
  = E'Type5'Local -- ^ @"local"@
  | E'Type5'Json_file -- ^ @"json-file"@
  | E'Type5'Syslog -- ^ @"syslog"@
  | E'Type5'Journald -- ^ @"journald"@
  | E'Type5'Gelf -- ^ @"gelf"@
  | E'Type5'Fluentd -- ^ @"fluentd"@
  | E'Type5'Awslogs -- ^ @"awslogs"@
  | E'Type5'Splunk -- ^ @"splunk"@
  | E'Type5'Etwlogs -- ^ @"etwlogs"@
  | E'Type5'None -- ^ @"none"@
  deriving (P.Show, P.Eq, P.Typeable, P.Ord, P.Bounded, P.Enum)
...
toE'Type5 = \case
  "local" -> P.Right E'Type5'Local
  "json-file" -> P.Right E'Type5'Json_file
  "syslog" -> P.Right E'Type5'Syslog
  "journald" -> P.Right E'Type5'Journald
  "gelf" -> P.Right E'Type5'Gelf
  "fluentd" -> P.Right E'Type5'Fluentd
  "awslogs" -> P.Right E'Type5'Awslogs
  "splunk" -> P.Right E'Type5'Splunk
  "etwlogs" -> P.Right E'Type5'Etwlogs
  "none" -> P.Right E'Type5'None
...
-- | Enum of 'Text'
data E'Type6
  = E'Type6'Container -- ^ @"container"@
  | E'Type6'Image -- ^ @"image"@
  | E'Type6'Volume -- ^ @"volume"@
  | E'Type6'Build_cache -- ^ @"build-cache"@
  deriving (P.Show, P.Eq, P.Typeable, P.Ord, P.Bounded, P.Enum)
...
toE'Type6 = \case
  "container" -> P.Right E'Type6'Container
  "image" -> P.Right E'Type6'Image
  "volume" -> P.Right E'Type6'Volume
  "build-cache" -> P.Right E'Type6'Build_cache
