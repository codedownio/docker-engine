...
main =
  hspec $ modifyMaxSize (const 10) $ do
    describe "JSON instances" $ do
      ...
      propMimeEq MimeJSON (Proxy :: Proxy BuildCacheDiskUsage)
      propMimeEq MimeJSON (Proxy :: Proxy BuildInfo)
      propMimeEq MimeJSON (Proxy :: Proxy BuildPruneResponse)
      propMimeEq MimeJSON (Proxy :: Proxy ChangeType)
      propMimeEq MimeJSON (Proxy :: Proxy ClusterInfo)
      propMimeEq MimeJSON (Proxy :: Proxy ClusterVolume)
      propMimeEq MimeJSON (Proxy :: Proxy ClusterVolumeInfo)
      propMimeEq MimeJSON (Proxy :: Proxy ClusterVolumePublishStatusInner)
      propMimeEq MimeJSON (Proxy :: Proxy ClusterVolumeSpec)
      propMimeEq MimeJSON (Proxy :: Proxy ClusterVolumeSpecAccessMode)
      propMimeEq MimeJSON (Proxy :: Proxy ClusterVolumeSpecAccessModeAccessibilityRequirements)
      propMimeEq MimeJSON (Proxy :: Proxy ClusterVolumeSpecAccessModeCapacityRange)
      propMimeEq MimeJSON (Proxy :: Proxy ClusterVolumeSpecAccessModeSecretsInner)
      propMimeEq MimeJSON (Proxy :: Proxy Commit)
      propMimeEq MimeJSON (Proxy :: Proxy Config)
      propMimeEq MimeJSON (Proxy :: Proxy ConfigCreateRequest)
      propMimeEq MimeJSON (Proxy :: Proxy ConfigReference)
      propMimeEq MimeJSON (Proxy :: Proxy ConfigSpec)
      propMimeEq MimeJSON (Proxy :: Proxy ContainerBlkioStatEntry)
      propMimeEq MimeJSON (Proxy :: Proxy ContainerBlkioStats)
      propMimeEq MimeJSON (Proxy :: Proxy ContainerCPUStats)
      propMimeEq MimeJSON (Proxy :: Proxy ContainerCPUUsage)
      propMimeEq MimeJSON (Proxy :: Proxy ContainerConfig)
      propMimeEq MimeJSON (Proxy :: Proxy ContainerCreateRequest)
      propMimeEq MimeJSON (Proxy :: Proxy ContainerCreateResponse)
      propMimeEq MimeJSON (Proxy :: Proxy ContainerInspectResponse)
      propMimeEq MimeJSON (Proxy :: Proxy ContainerMemoryStats)
      propMimeEq MimeJSON (Proxy :: Proxy ContainerNetworkStats)
      propMimeEq MimeJSON (Proxy :: Proxy ContainerPidsStats)
      ...
      propMimeEq MimeJSON (Proxy :: Proxy ContainerStatus)
      propMimeEq MimeJSON (Proxy :: Proxy ContainerStorageStats)
      propMimeEq MimeJSON (Proxy :: Proxy ContainerSummary)
      propMimeEq MimeJSON (Proxy :: Proxy ContainerSummaryHealth)
      ...
      propMimeEq MimeJSON (Proxy :: Proxy ContainerThrottlingData)
      ...
      propMimeEq MimeJSON (Proxy :: Proxy ContainerdInfo)
      propMimeEq MimeJSON (Proxy :: Proxy ContainerdInfoNamespaces)
      propMimeEq MimeJSON (Proxy :: Proxy ContainersDiskUsage)
      propMimeEq MimeJSON (Proxy :: Proxy CreateImageInfo)
      propMimeEq MimeJSON (Proxy :: Proxy DeviceInfo)
      ...
      propMimeEq MimeJSON (Proxy :: Proxy EngineDescriptionPluginsInner)
      ...
      propMimeEq MimeJSON (Proxy :: Proxy FilesystemChange)
      propMimeEq MimeJSON (Proxy :: Proxy FirewallInfo)
      ...
      propMimeEq MimeJSON (Proxy :: Proxy IPAMStatus)
      propMimeEq MimeJSON (Proxy :: Proxy ImageConfig)
      ...
      propMimeEq MimeJSON (Proxy :: Proxy ImageManifestSummary)
      propMimeEq MimeJSON (Proxy :: Proxy ImageManifestSummaryAttestationData)
      propMimeEq MimeJSON (Proxy :: Proxy ImageManifestSummaryImageData)
      propMimeEq MimeJSON (Proxy :: Proxy ImageManifestSummaryImageDataSize)
      propMimeEq MimeJSON (Proxy :: Proxy ImageManifestSummarySize)
      ...
      propMimeEq MimeJSON (Proxy :: Proxy ImagesDiskUsage)
      ...
      propMimeEq MimeJSON (Proxy :: Proxy MountImageOptions)
      ...
      propMimeEq MimeJSON (Proxy :: Proxy NetworkInspect)
      propMimeEq MimeJSON (Proxy :: Proxy NetworkPruneResponse)
      propMimeEq MimeJSON (Proxy :: Proxy NetworkSettings)
      propMimeEq MimeJSON (Proxy :: Proxy NetworkStatus)
      propMimeEq MimeJSON (Proxy :: Proxy NetworkSummary)
      propMimeEq MimeJSON (Proxy :: Proxy NetworkTaskInfo)
      ...
      propMimeEq MimeJSON (Proxy :: Proxy PeerInfo)
      ...
      propMimeEq MimeJSON (Proxy :: Proxy PortStatus)
      propMimeEq MimeJSON (Proxy :: Proxy PortSummary)
      ...
      propMimeEq MimeJSON (Proxy :: Proxy ResourcesBlkioWeightDeviceInner)
      propMimeEq MimeJSON (Proxy :: Proxy ResourcesUlimitsInner)
      propMimeEq MimeJSON (Proxy :: Proxy RestartPolicy)
      propMimeEq MimeJSON (Proxy :: Proxy RootFSStorage)
      propMimeEq MimeJSON (Proxy :: Proxy RootFSStorageSnapshot)
      propMimeEq MimeJSON (Proxy :: Proxy Runtime)
      propMimeEq MimeJSON (Proxy :: Proxy Secret)
      propMimeEq MimeJSON (Proxy :: Proxy SecretCreateRequest)
      propMimeEq MimeJSON (Proxy :: Proxy SecretSpec)
      propMimeEq MimeJSON (Proxy :: Proxy Service)
      propMimeEq MimeJSON (Proxy :: Proxy ServiceCreateRequest)
      propMimeEq MimeJSON (Proxy :: Proxy ServiceCreateResponse)
      propMimeEq MimeJSON (Proxy :: Proxy ServiceEndpoint)
      propMimeEq MimeJSON (Proxy :: Proxy ServiceEndpointVirtualIPsInner)
      propMimeEq MimeJSON (Proxy :: Proxy ServiceInfo)
      ...
      propMimeEq MimeJSON (Proxy :: Proxy ServiceUpdateRequest)
      propMimeEq MimeJSON (Proxy :: Proxy ServiceUpdateResponse)
      propMimeEq MimeJSON (Proxy :: Proxy ServiceUpdateStatus)
      propMimeEq MimeJSON (Proxy :: Proxy Storage)
      propMimeEq MimeJSON (Proxy :: Proxy SubnetStatus)
      ...
      propMimeEq MimeJSON (Proxy :: Proxy SwarmSpecCAConfigExternalCAsInner)
      ...
      propMimeEq MimeJSON (Proxy :: Proxy SystemInfoDefaultAddressPoolsInner)
      propMimeEq MimeJSON (Proxy :: Proxy SystemVersion)
      propMimeEq MimeJSON (Proxy :: Proxy SystemVersionComponentsInner)
      ...
      propMimeEq MimeJSON (Proxy :: Proxy TaskSpecContainerSpecConfigsInner)
      propMimeEq MimeJSON (Proxy :: Proxy TaskSpecContainerSpecConfigsInnerFile)
      ...
      propMimeEq MimeJSON (Proxy :: Proxy TaskSpecContainerSpecPrivilegesAppArmor)
      ...
      propMimeEq MimeJSON (Proxy :: Proxy TaskSpecContainerSpecPrivilegesSeccomp)
      propMimeEq MimeJSON (Proxy :: Proxy TaskSpecContainerSpecSecretsInner)
      propMimeEq MimeJSON (Proxy :: Proxy TaskSpecContainerSpecSecretsInnerFile)
      ...
      propMimeEq MimeJSON (Proxy :: Proxy TaskSpecPlacementPreferencesInner)
      propMimeEq MimeJSON (Proxy :: Proxy TaskSpecPlacementPreferencesInnerSpread)
      ...
      propMimeEq MimeJSON (Proxy :: Proxy VolumeCreateRequest)
      propMimeEq MimeJSON (Proxy :: Proxy VolumeListResponse)
      propMimeEq MimeJSON (Proxy :: Proxy VolumePruneResponse)
      propMimeEq MimeJSON (Proxy :: Proxy VolumeUpdateRequest)
      propMimeEq MimeJSON (Proxy :: Proxy VolumeUsageData)
      propMimeEq MimeJSON (Proxy :: Proxy VolumesDiskUsage)
