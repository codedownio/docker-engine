...
genAuthResponse n =
  AuthResponse
    <$> arbitrary -- authResponseStatus :: Text
    <*> arbitraryReducedMaybe n -- authResponseIdentityToken :: Maybe Text
...
instance Arbitrary BuildCacheDiskUsage where
  arbitrary = sized genBuildCacheDiskUsage

genBuildCacheDiskUsage :: Int -> Gen BuildCacheDiskUsage
genBuildCacheDiskUsage n =
  BuildCacheDiskUsage
    <$> arbitraryReducedMaybe n -- buildCacheDiskUsageActiveCount :: Maybe Integer
    <*> arbitraryReducedMaybe n -- buildCacheDiskUsageTotalCount :: Maybe Integer
    <*> arbitraryReducedMaybe n -- buildCacheDiskUsageReclaimable :: Maybe Integer
    <*> arbitraryReducedMaybe n -- buildCacheDiskUsageTotalSize :: Maybe Integer
    <*> arbitraryReducedMaybe n -- buildCacheDiskUsageItems :: Maybe [A.Value]
...
instance Arbitrary ClusterVolume where
  arbitrary = sized genClusterVolume

genClusterVolume :: Int -> Gen ClusterVolume
genClusterVolume n =
  ClusterVolume
    <$> arbitraryReducedMaybe n -- clusterVolumeId :: Maybe Text
    <*> arbitraryReducedMaybe n -- clusterVolumeVersion :: Maybe ObjectVersion
    <*> arbitraryReducedMaybe n -- clusterVolumeCreatedAt :: Maybe Text
    <*> arbitraryReducedMaybe n -- clusterVolumeUpdatedAt :: Maybe Text
    <*> arbitraryReducedMaybe n -- clusterVolumeSpec :: Maybe ClusterVolumeSpec
    <*> arbitraryReducedMaybe n -- clusterVolumeInfo :: Maybe ClusterVolumeInfo
    <*> arbitraryReducedMaybe n -- clusterVolumePublishStatus :: Maybe [ClusterVolumePublishStatusInner]
  
instance Arbitrary ClusterVolumeInfo where
  arbitrary = sized genClusterVolumeInfo

genClusterVolumeInfo :: Int -> Gen ClusterVolumeInfo
genClusterVolumeInfo n =
  ClusterVolumeInfo
    <$> arbitraryReducedMaybe n -- clusterVolumeInfoCapacityBytes :: Maybe Integer
    <*> arbitraryReducedMaybe n -- clusterVolumeInfoVolumeContext :: Maybe (Map.Map String Text)
    <*> arbitraryReducedMaybe n -- clusterVolumeInfoVolumeId :: Maybe Text
    <*> arbitraryReducedMaybe n -- clusterVolumeInfoAccessibleTopology :: Maybe [Map]
  
instance Arbitrary ClusterVolumePublishStatusInner where
  arbitrary = sized genClusterVolumePublishStatusInner

genClusterVolumePublishStatusInner :: Int -> Gen ClusterVolumePublishStatusInner
genClusterVolumePublishStatusInner n =
  ClusterVolumePublishStatusInner
    <$> arbitraryReducedMaybe n -- clusterVolumePublishStatusInnerNodeId :: Maybe Text
    <*> arbitraryReducedMaybe n -- clusterVolumePublishStatusInnerState :: Maybe E'State3
    <*> arbitraryReducedMaybe n -- clusterVolumePublishStatusInnerPublishContext :: Maybe (Map.Map String Text)
  
instance Arbitrary ClusterVolumeSpec where
  arbitrary = sized genClusterVolumeSpec

genClusterVolumeSpec :: Int -> Gen ClusterVolumeSpec
genClusterVolumeSpec n =
  ClusterVolumeSpec
    <$> arbitraryReducedMaybe n -- clusterVolumeSpecGroup :: Maybe Text
    <*> arbitraryReducedMaybe n -- clusterVolumeSpecAccessMode :: Maybe ClusterVolumeSpecAccessMode
  
instance Arbitrary ClusterVolumeSpecAccessMode where
  arbitrary = sized genClusterVolumeSpecAccessMode

genClusterVolumeSpecAccessMode :: Int -> Gen ClusterVolumeSpecAccessMode
genClusterVolumeSpecAccessMode n =
  ClusterVolumeSpecAccessMode
    <$> arbitraryReducedMaybe n -- clusterVolumeSpecAccessModeScope :: Maybe E'Scope3
    <*> arbitraryReducedMaybe n -- clusterVolumeSpecAccessModeSharing :: Maybe E'Sharing
    <*> arbitraryReducedMaybeValue n -- clusterVolumeSpecAccessModeMountVolume :: Maybe A.Value
    <*> arbitraryReducedMaybe n -- clusterVolumeSpecAccessModeSecrets :: Maybe [ClusterVolumeSpecAccessModeSecretsInner]
    <*> arbitraryReducedMaybe n -- clusterVolumeSpecAccessModeAccessibilityRequirements :: Maybe ClusterVolumeSpecAccessModeAccessibilityRequirements
    <*> arbitraryReducedMaybe n -- clusterVolumeSpecAccessModeCapacityRange :: Maybe ClusterVolumeSpecAccessModeCapacityRange
    <*> arbitraryReducedMaybe n -- clusterVolumeSpecAccessModeAvailability :: Maybe E'Availability
  
instance Arbitrary ClusterVolumeSpecAccessModeAccessibilityRequirements where
  arbitrary = sized genClusterVolumeSpecAccessModeAccessibilityRequirements

genClusterVolumeSpecAccessModeAccessibilityRequirements :: Int -> Gen ClusterVolumeSpecAccessModeAccessibilityRequirements
genClusterVolumeSpecAccessModeAccessibilityRequirements n =
  ClusterVolumeSpecAccessModeAccessibilityRequirements
    <$> arbitraryReducedMaybe n -- clusterVolumeSpecAccessModeAccessibilityRequirementsRequisite :: Maybe [Map]
    <*> arbitraryReducedMaybe n -- clusterVolumeSpecAccessModeAccessibilityRequirementsPreferred :: Maybe [Map]
  
instance Arbitrary ClusterVolumeSpecAccessModeCapacityRange where
  arbitrary = sized genClusterVolumeSpecAccessModeCapacityRange
...
genClusterVolumeSpecAccessModeCapacityRange n =
  ClusterVolumeSpecAccessModeCapacityRange
    <$> arbitraryReducedMaybe n -- clusterVolumeSpecAccessModeCapacityRangeRequiredBytes :: Maybe Integer
    <*> arbitraryReducedMaybe n -- clusterVolumeSpecAccessModeCapacityRangeLimitBytes :: Maybe Integer
  
instance Arbitrary ClusterVolumeSpecAccessModeSecretsInner where
  arbitrary = sized genClusterVolumeSpecAccessModeSecretsInner

genClusterVolumeSpecAccessModeSecretsInner :: Int -> Gen ClusterVolumeSpecAccessModeSecretsInner
genClusterVolumeSpecAccessModeSecretsInner n =
  ClusterVolumeSpecAccessModeSecretsInner
    <$> arbitraryReducedMaybe n -- clusterVolumeSpecAccessModeSecretsInnerKey :: Maybe Text
    <*> arbitraryReducedMaybe n -- clusterVolumeSpecAccessModeSecretsInnerSecret :: Maybe Text
...
genConfigCreateRequest n =
  ConfigCreateRequest
    ...
    <*> arbitraryReducedMaybe n -- configCreateRequestTemplating :: Maybe Driver
  
instance Arbitrary ConfigReference where
  arbitrary = sized genConfigReference

genConfigReference :: Int -> Gen ConfigReference
genConfigReference n =
  ConfigReference
    <$> arbitraryReducedMaybe n -- configReferenceNetwork :: Maybe Text
...
instance Arbitrary ContainerBlkioStatEntry where
  arbitrary = sized genContainerBlkioStatEntry

genContainerBlkioStatEntry :: Int -> Gen ContainerBlkioStatEntry
genContainerBlkioStatEntry n =
  ContainerBlkioStatEntry
    <$> arbitraryReducedMaybe n -- containerBlkioStatEntryMajor :: Maybe Int
    <*> arbitraryReducedMaybe n -- containerBlkioStatEntryMinor :: Maybe Int
    <*> arbitraryReducedMaybe n -- containerBlkioStatEntryOp :: Maybe Text
    <*> arbitraryReducedMaybe n -- containerBlkioStatEntryValue :: Maybe Int
  
instance Arbitrary ContainerBlkioStats where
  arbitrary = sized genContainerBlkioStats

genContainerBlkioStats :: Int -> Gen ContainerBlkioStats
genContainerBlkioStats n =
  ContainerBlkioStats
    <$> arbitraryReducedMaybe n -- containerBlkioStatsIoServiceBytesRecursive :: Maybe [ContainerBlkioStatEntry]
    <*> arbitraryReducedMaybe n -- containerBlkioStatsIoServicedRecursive :: Maybe [ContainerBlkioStatEntry]
    <*> arbitraryReducedMaybe n -- containerBlkioStatsIoQueueRecursive :: Maybe [ContainerBlkioStatEntry]
    <*> arbitraryReducedMaybe n -- containerBlkioStatsIoServiceTimeRecursive :: Maybe [ContainerBlkioStatEntry]
    <*> arbitraryReducedMaybe n -- containerBlkioStatsIoWaitTimeRecursive :: Maybe [ContainerBlkioStatEntry]
    <*> arbitraryReducedMaybe n -- containerBlkioStatsIoMergedRecursive :: Maybe [ContainerBlkioStatEntry]
    <*> arbitraryReducedMaybe n -- containerBlkioStatsIoTimeRecursive :: Maybe [ContainerBlkioStatEntry]
    <*> arbitraryReducedMaybe n -- containerBlkioStatsSectorsRecursive :: Maybe [ContainerBlkioStatEntry]
  
instance Arbitrary ContainerCPUStats where
  arbitrary = sized genContainerCPUStats

genContainerCPUStats :: Int -> Gen ContainerCPUStats
genContainerCPUStats n =
  ContainerCPUStats
    <$> arbitraryReducedMaybe n -- containerCPUStatsCpuUsage :: Maybe ContainerCPUUsage
    <*> arbitraryReducedMaybe n -- containerCPUStatsSystemCpuUsage :: Maybe Int
    <*> arbitraryReducedMaybe n -- containerCPUStatsOnlineCpus :: Maybe Int
    <*> arbitraryReducedMaybe n -- containerCPUStatsThrottlingData :: Maybe ContainerThrottlingData
  
instance Arbitrary ContainerCPUUsage where
  arbitrary = sized genContainerCPUUsage

genContainerCPUUsage :: Int -> Gen ContainerCPUUsage
genContainerCPUUsage n =
  ContainerCPUUsage
    <$> arbitraryReducedMaybe n -- containerCPUUsageTotalUsage :: Maybe Int
    <*> arbitraryReducedMaybe n -- containerCPUUsagePercpuUsage :: Maybe [Int]
    <*> arbitraryReducedMaybe n -- containerCPUUsageUsageInKernelmode :: Maybe Int
    <*> arbitraryReducedMaybe n -- containerCPUUsageUsageInUsermode :: Maybe Int
...
genContainerCreateRequest n =
  ContainerCreateRequest
    ...
    <*> arbitraryReducedMaybe n -- containerCreateRequestVolumes :: Maybe (Map.Map String A.Value)
    ...
    <*> arbitraryReducedMaybe n -- containerCreateRequestNetworkingConfig :: Maybe NetworkingConfig
...
genContainerInspectResponse n =
  ContainerInspectResponse
    ...
    <*> arbitraryReducedMaybe n -- containerInspectResponseImageManifestDescriptor :: Maybe OCIDescriptor
    ...
    <*> arbitraryReducedMaybe n -- containerInspectResponseGraphDriver :: Maybe DriverData
    <*> arbitraryReducedMaybe n -- containerInspectResponseStorage :: Maybe Storage
...
instance Arbitrary ContainerMemoryStats where
  arbitrary = sized genContainerMemoryStats

genContainerMemoryStats :: Int -> Gen ContainerMemoryStats
genContainerMemoryStats n =
  ContainerMemoryStats
    <$> arbitraryReducedMaybe n -- containerMemoryStatsUsage :: Maybe Int
    <*> arbitraryReducedMaybe n -- containerMemoryStatsMaxUsage :: Maybe Int
    <*> arbitraryReducedMaybe n -- containerMemoryStatsStats :: Maybe (Map.Map String Int)
    <*> arbitraryReducedMaybe n -- containerMemoryStatsFailcnt :: Maybe Int
    <*> arbitraryReducedMaybe n -- containerMemoryStatsLimit :: Maybe Int
    <*> arbitraryReducedMaybe n -- containerMemoryStatsCommitbytes :: Maybe Int
    <*> arbitraryReducedMaybe n -- containerMemoryStatsCommitpeakbytes :: Maybe Int
    <*> arbitraryReducedMaybe n -- containerMemoryStatsPrivateworkingset :: Maybe Int
  
instance Arbitrary ContainerNetworkStats where
  arbitrary = sized genContainerNetworkStats

genContainerNetworkStats :: Int -> Gen ContainerNetworkStats
genContainerNetworkStats n =
  ContainerNetworkStats
    <$> arbitraryReducedMaybe n -- containerNetworkStatsRxBytes :: Maybe Int
    <*> arbitraryReducedMaybe n -- containerNetworkStatsRxPackets :: Maybe Int
    <*> arbitraryReducedMaybe n -- containerNetworkStatsRxErrors :: Maybe Int
    <*> arbitraryReducedMaybe n -- containerNetworkStatsRxDropped :: Maybe Int
    <*> arbitraryReducedMaybe n -- containerNetworkStatsTxBytes :: Maybe Int
    <*> arbitraryReducedMaybe n -- containerNetworkStatsTxPackets :: Maybe Int
    <*> arbitraryReducedMaybe n -- containerNetworkStatsTxErrors :: Maybe Int
    <*> arbitraryReducedMaybe n -- containerNetworkStatsTxDropped :: Maybe Int
    <*> arbitraryReducedMaybe n -- containerNetworkStatsEndpointId :: Maybe Text
    <*> arbitraryReducedMaybe n -- containerNetworkStatsInstanceId :: Maybe Text
  
instance Arbitrary ContainerPidsStats where
  arbitrary = sized genContainerPidsStats

genContainerPidsStats :: Int -> Gen ContainerPidsStats
genContainerPidsStats n =
  ContainerPidsStats
    <$> arbitraryReducedMaybe n -- containerPidsStatsCurrent :: Maybe Int
    <*> arbitraryReducedMaybe n -- containerPidsStatsLimit :: Maybe Int
...
genContainerStatsResponse n =
  ContainerStatsResponse
    <$> arbitraryReducedMaybe n -- containerStatsResponseId :: Maybe Text
    <*> arbitraryReducedMaybe n -- containerStatsResponseName :: Maybe Text
    <*> arbitraryReducedMaybe n -- containerStatsResponseOsType :: Maybe Text
    <*> arbitraryReducedMaybe n -- containerStatsResponseRead :: Maybe DateTime
    <*> arbitraryReducedMaybe n -- containerStatsResponseCpuStats :: Maybe ContainerCPUStats
    <*> arbitraryReducedMaybe n -- containerStatsResponseMemoryStats :: Maybe ContainerMemoryStats
    <*> arbitraryReducedMaybeValue n -- containerStatsResponseNetworks :: Maybe A.Value
    <*> arbitraryReducedMaybe n -- containerStatsResponsePidsStats :: Maybe ContainerPidsStats
    <*> arbitraryReducedMaybe n -- containerStatsResponseBlkioStats :: Maybe ContainerBlkioStats
    <*> arbitraryReducedMaybe n -- containerStatsResponseNumProcs :: Maybe Int
    <*> arbitraryReducedMaybe n -- containerStatsResponseStorageStats :: Maybe ContainerStorageStats
    <*> arbitraryReducedMaybe n -- containerStatsResponsePreread :: Maybe DateTime
    <*> arbitraryReducedMaybe n -- containerStatsResponsePrecpuStats :: Maybe ContainerCPUStats
  
instance Arbitrary ContainerStatus where
  arbitrary = sized genContainerStatus

genContainerStatus :: Int -> Gen ContainerStatus
genContainerStatus n =
  ContainerStatus
    <$> arbitraryReducedMaybe n -- containerStatusContainerId :: Maybe Text
    <*> arbitraryReducedMaybe n -- containerStatusPid :: Maybe Int
    <*> arbitraryReducedMaybe n -- containerStatusExitCode :: Maybe Int
  
instance Arbitrary ContainerStorageStats where
  arbitrary = sized genContainerStorageStats

genContainerStorageStats :: Int -> Gen ContainerStorageStats
genContainerStorageStats n =
  ContainerStorageStats
    <$> arbitraryReducedMaybe n -- containerStorageStatsReadCountNormalized :: Maybe Int
    <*> arbitraryReducedMaybe n -- containerStorageStatsReadSizeBytes :: Maybe Int
    <*> arbitraryReducedMaybe n -- containerStorageStatsWriteCountNormalized :: Maybe Int
    <*> arbitraryReducedMaybe n -- containerStorageStatsWriteSizeBytes :: Maybe Int
...
genContainerSummary n =
  ContainerSummary
    ...
    <*> arbitraryReducedMaybe n -- containerSummaryImageManifestDescriptor :: Maybe OCIDescriptor
    <*> arbitraryReducedMaybe n -- containerSummaryCommand :: Maybe Text
    <*> arbitraryReducedMaybe n -- containerSummaryCreated :: Maybe Integer
    <*> arbitraryReducedMaybe n -- containerSummaryPorts :: Maybe [PortSummary]
    ...
    <*> arbitraryReducedMaybe n -- containerSummaryState :: Maybe E'State
    ...
    <*> arbitraryReducedMaybe n -- containerSummaryHealth :: Maybe ContainerSummaryHealth
  
instance Arbitrary ContainerSummaryHealth where
  arbitrary = sized genContainerSummaryHealth

genContainerSummaryHealth :: Int -> Gen ContainerSummaryHealth
genContainerSummaryHealth n =
  ContainerSummaryHealth
    <$> arbitraryReducedMaybe n -- containerSummaryHealthStatus :: Maybe E'Status
    <*> arbitraryReducedMaybe n -- containerSummaryHealthFailingStreak :: Maybe Int
...
genContainerSummaryHostConfig n =
  ContainerSummaryHostConfig
    ...
    <*> arbitraryReducedMaybe n -- containerSummaryHostConfigAnnotations :: Maybe (Map.Map String Text)
...
instance Arbitrary ContainerThrottlingData where
  arbitrary = sized genContainerThrottlingData

genContainerThrottlingData :: Int -> Gen ContainerThrottlingData
genContainerThrottlingData n =
  ContainerThrottlingData
    <$> arbitraryReducedMaybe n -- containerThrottlingDataPeriods :: Maybe Int
    <*> arbitraryReducedMaybe n -- containerThrottlingDataThrottledPeriods :: Maybe Int
    <*> arbitraryReducedMaybe n -- containerThrottlingDataThrottledTime :: Maybe Int
...
genContainerUpdateRequest n =
  ContainerUpdateRequest
    ...
    <*> arbitraryReducedMaybe n -- containerUpdateRequestDeviceRequests :: Maybe [DeviceRequest]
    ...
    <*> arbitraryReducedMaybe n -- containerUpdateRequestInit :: Maybe Bool
...
genContainerWaitResponse n =
  ContainerWaitResponse
    <$> arbitrary -- containerWaitResponseStatusCode :: Integer
    <*> arbitraryReducedMaybe n -- containerWaitResponseError :: Maybe ContainerWaitExitError
  
instance Arbitrary ContainerdInfo where
  arbitrary = sized genContainerdInfo

genContainerdInfo :: Int -> Gen ContainerdInfo
genContainerdInfo n =
  ContainerdInfo
    <$> arbitraryReducedMaybe n -- containerdInfoAddress :: Maybe Text
    <*> arbitraryReducedMaybe n -- containerdInfoNamespaces :: Maybe ContainerdInfoNamespaces
  
instance Arbitrary ContainerdInfoNamespaces where
  arbitrary = sized genContainerdInfoNamespaces

genContainerdInfoNamespaces :: Int -> Gen ContainerdInfoNamespaces
genContainerdInfoNamespaces n =
  ContainerdInfoNamespaces
    <$> arbitraryReducedMaybe n -- containerdInfoNamespacesContainers :: Maybe Text
    <*> arbitraryReducedMaybe n -- containerdInfoNamespacesPlugins :: Maybe Text
  
instance Arbitrary ContainersDiskUsage where
  arbitrary = sized genContainersDiskUsage

genContainersDiskUsage :: Int -> Gen ContainersDiskUsage
genContainersDiskUsage n =
  ContainersDiskUsage
    <$> arbitraryReducedMaybe n -- containersDiskUsageActiveCount :: Maybe Integer
    <*> arbitraryReducedMaybe n -- containersDiskUsageTotalCount :: Maybe Integer
    <*> arbitraryReducedMaybe n -- containersDiskUsageReclaimable :: Maybe Integer
    <*> arbitraryReducedMaybe n -- containersDiskUsageTotalSize :: Maybe Integer
    <*> arbitraryReducedMaybe n -- containersDiskUsageItems :: Maybe [A.Value]
...
genCreateImageInfo n =
  CreateImageInfo
    ...
    <*> arbitraryReducedMaybe n -- createImageInfoErrorDetail :: Maybe ErrorDetail
...
instance Arbitrary DeviceInfo where
  arbitrary = sized genDeviceInfo

genDeviceInfo :: Int -> Gen DeviceInfo
genDeviceInfo n =
  DeviceInfo
    <$> arbitraryReducedMaybe n -- deviceInfoSource :: Maybe Text
    <*> arbitraryReducedMaybe n -- deviceInfoId :: Maybe Text
...
instance Arbitrary DriverData where
  arbitrary = sized genDriverData

genDriverData :: Int -> Gen DriverData
genDriverData n =
  DriverData
    <$> arbitrary -- driverDataName :: Text
    <*> arbitrary -- driverDataData :: (Map.Map String Text)
...
instance Arbitrary EndpointResource where
  arbitrary = sized genEndpointResource

genEndpointResource :: Int -> Gen EndpointResource
genEndpointResource n =
  EndpointResource
    <$> arbitraryReducedMaybe n -- endpointResourceName :: Maybe Text
    <*> arbitraryReducedMaybe n -- endpointResourceEndpointId :: Maybe Text
    <*> arbitraryReducedMaybe n -- endpointResourceMacAddress :: Maybe Text
    <*> arbitraryReducedMaybe n -- endpointResourceIpv4Address :: Maybe Text
    <*> arbitraryReducedMaybe n -- endpointResourceIpv6Address :: Maybe Text
...
genEndpointSettings n =
  EndpointSettings
    ...
    <*> arbitraryReducedMaybe n -- endpointSettingsGwPriority :: Maybe Integer
    ...
    <*> arbitraryReducedMaybe n -- endpointSettingsDnsNames :: Maybe [Text]
...
genEventMessage n =
  EventMessage
    <$> arbitraryReducedMaybe n -- eventMessageType :: Maybe E'Type4
...
genExecConfig n =
  ExecConfig
    ...
    <*> arbitraryReducedMaybe n -- execConfigConsoleSize :: Maybe [Int]
...
genExecStartConfig n =
  ExecStartConfig
    ...
    <*> arbitraryReducedMaybe n -- execStartConfigConsoleSize :: Maybe [Int]
  
instance Arbitrary FilesystemChange where
  arbitrary = sized genFilesystemChange

genFilesystemChange :: Int -> Gen FilesystemChange
genFilesystemChange n =
  FilesystemChange
    <$> arbitrary -- filesystemChangePath :: Text
    <*> arbitraryReduced n -- filesystemChangeKind :: ChangeType
  
instance Arbitrary FirewallInfo where
  arbitrary = sized genFirewallInfo

genFirewallInfo :: Int -> Gen FirewallInfo
genFirewallInfo n =
  FirewallInfo
    <$> arbitraryReducedMaybe n -- firewallInfoDriver :: Maybe Text
    <*> arbitraryReducedMaybe n -- firewallInfoInfo :: Maybe [[Text]]
...
genHealthConfig n =
  HealthConfig
    ...
    <*> arbitraryReducedMaybe n -- healthConfigInterval :: Maybe Integer
    <*> arbitraryReducedMaybe n -- healthConfigTimeout :: Maybe Integer
    <*> arbitraryReducedMaybe n -- healthConfigRetries :: Maybe Int
    <*> arbitraryReducedMaybe n -- healthConfigStartPeriod :: Maybe Integer
    <*> arbitraryReducedMaybe n -- healthConfigStartInterval :: Maybe Integer
...
genHostConfig n =
  HostConfig
    ...
    <*> arbitraryReducedMaybe n -- hostConfigAnnotations :: Maybe (Map.Map String Text)
    ...
    <*> arbitraryReducedMaybe n -- hostConfigShmSize :: Maybe Integer
...
genHostConfigAllOfLogConfig n =
  HostConfigAllOfLogConfig
    <$> arbitraryReducedMaybe n -- hostConfigAllOfLogConfigType :: Maybe E'Type5
...
instance Arbitrary IPAMStatus where
  arbitrary = sized genIPAMStatus

genIPAMStatus :: Int -> Gen IPAMStatus
genIPAMStatus n =
  IPAMStatus
    <$> arbitraryReducedMaybe n -- iPAMStatusSubnets :: Maybe (Map.Map String SubnetStatus)
  
instance Arbitrary ImageConfig where
  arbitrary = sized genImageConfig

genImageConfig :: Int -> Gen ImageConfig
genImageConfig n =
  ImageConfig
    <$> arbitraryReducedMaybe n -- imageConfigUser :: Maybe Text
    <*> arbitraryReducedMaybe n -- imageConfigExposedPorts :: Maybe (Map.Map String A.Value)
    <*> arbitraryReducedMaybe n -- imageConfigEnv :: Maybe [Text]
    <*> arbitraryReducedMaybe n -- imageConfigCmd :: Maybe [Text]
    <*> arbitraryReducedMaybe n -- imageConfigHealthcheck :: Maybe HealthConfig
    <*> arbitraryReducedMaybe n -- imageConfigArgsEscaped :: Maybe Bool
    <*> arbitraryReducedMaybe n -- imageConfigVolumes :: Maybe (Map.Map String A.Value)
    <*> arbitraryReducedMaybe n -- imageConfigWorkingDir :: Maybe Text
    <*> arbitraryReducedMaybe n -- imageConfigEntrypoint :: Maybe [Text]
    <*> arbitraryReducedMaybe n -- imageConfigOnBuild :: Maybe [Text]
    <*> arbitraryReducedMaybe n -- imageConfigLabels :: Maybe (Map.Map String Text)
    <*> arbitraryReducedMaybe n -- imageConfigStopSignal :: Maybe Text
    <*> arbitraryReducedMaybe n -- imageConfigShell :: Maybe [Text]
...
genImageInspect n =
  ImageInspect
    ...
    <*> arbitraryReducedMaybe n -- imageInspectDescriptor :: Maybe OCIDescriptor
    <*> arbitraryReducedMaybe n -- imageInspectManifests :: Maybe [ImageManifestSummary]
    ...
    <*> arbitraryReducedMaybe n -- imageInspectConfig :: Maybe ImageConfig
...
instance Arbitrary ImageManifestSummary where
  arbitrary = sized genImageManifestSummary

genImageManifestSummary :: Int -> Gen ImageManifestSummary
genImageManifestSummary n =
  ImageManifestSummary
    <$> arbitrary -- imageManifestSummaryId :: Text
    <*> arbitraryReduced n -- imageManifestSummaryDescriptor :: OCIDescriptor
    <*> arbitrary -- imageManifestSummaryAvailable :: Bool
    <*> arbitraryReduced n -- imageManifestSummarySize :: ImageManifestSummarySize
    <*> arbitrary -- imageManifestSummaryKind :: E'Kind
    <*> arbitraryReducedMaybe n -- imageManifestSummaryImageData :: Maybe ImageManifestSummaryImageData
    <*> arbitraryReducedMaybe n -- imageManifestSummaryAttestationData :: Maybe ImageManifestSummaryAttestationData
  
instance Arbitrary ImageManifestSummaryAttestationData where
  arbitrary = sized genImageManifestSummaryAttestationData

genImageManifestSummaryAttestationData :: Int -> Gen ImageManifestSummaryAttestationData
genImageManifestSummaryAttestationData n =
  ImageManifestSummaryAttestationData
    <$> arbitrary -- imageManifestSummaryAttestationDataFor :: Text
  
instance Arbitrary ImageManifestSummaryImageData where
  arbitrary = sized genImageManifestSummaryImageData

genImageManifestSummaryImageData :: Int -> Gen ImageManifestSummaryImageData
genImageManifestSummaryImageData n =
  ImageManifestSummaryImageData
    <$> arbitraryReduced n -- imageManifestSummaryImageDataPlatform :: OCIPlatform
    <*> arbitrary -- imageManifestSummaryImageDataContainers :: [Text]
    <*> arbitraryReduced n -- imageManifestSummaryImageDataSize :: ImageManifestSummaryImageDataSize
  
instance Arbitrary ImageManifestSummaryImageDataSize where
  arbitrary = sized genImageManifestSummaryImageDataSize

genImageManifestSummaryImageDataSize :: Int -> Gen ImageManifestSummaryImageDataSize
genImageManifestSummaryImageDataSize n =
  ImageManifestSummaryImageDataSize
    <$> arbitrary -- imageManifestSummaryImageDataSizeUnpacked :: Integer
  
instance Arbitrary ImageManifestSummarySize where
  arbitrary = sized genImageManifestSummarySize

genImageManifestSummarySize :: Int -> Gen ImageManifestSummarySize
genImageManifestSummarySize n =
  ImageManifestSummarySize
    <$> arbitrary -- imageManifestSummarySizeTotal :: Integer
    <*> arbitrary -- imageManifestSummarySizeContent :: Integer
...
genImageSummary n =
  ImageSummary
    ...
    <*> arbitraryReducedMaybe n -- imageSummaryDescriptor :: Maybe OCIDescriptor
  
instance Arbitrary ImagesDiskUsage where
  arbitrary = sized genImagesDiskUsage

genImagesDiskUsage :: Int -> Gen ImagesDiskUsage
genImagesDiskUsage n =
  ImagesDiskUsage
    <$> arbitraryReducedMaybe n -- imagesDiskUsageActiveCount :: Maybe Integer
    <*> arbitraryReducedMaybe n -- imagesDiskUsageTotalCount :: Maybe Integer
    <*> arbitraryReducedMaybe n -- imagesDiskUsageReclaimable :: Maybe Integer
    <*> arbitraryReducedMaybe n -- imagesDiskUsageTotalSize :: Maybe Integer
    <*> arbitraryReducedMaybe n -- imagesDiskUsageItems :: Maybe [A.Value]
...
genMount n =
  Mount
    ...
    <*> arbitraryReducedMaybe n -- mountImageOptions :: Maybe MountImageOptions
...
genMountBindOptions n =
  MountBindOptions
    ...
    <*> arbitraryReducedMaybe n -- mountBindOptionsCreateMountpoint :: Maybe Bool
    <*> arbitraryReducedMaybe n -- mountBindOptionsReadOnlyNonRecursive :: Maybe Bool
    <*> arbitraryReducedMaybe n -- mountBindOptionsReadOnlyForceRecursive :: Maybe Bool
  
instance Arbitrary MountImageOptions where
  arbitrary = sized genMountImageOptions

genMountImageOptions :: Int -> Gen MountImageOptions
genMountImageOptions n =
  MountImageOptions
    <$> arbitraryReducedMaybe n -- mountImageOptionsSubpath :: Maybe Text
...
genMountTmpfsOptions n =
  MountTmpfsOptions
    ...
    <*> arbitraryReducedMaybe n -- mountTmpfsOptionsOptions :: Maybe [[Text]]
...
genMountVolumeOptions n =
  MountVolumeOptions
    ...
    <*> arbitraryReducedMaybe n -- mountVolumeOptionsSubpath :: Maybe Text
...
genNetwork n =
  Network
    ...
    <*> arbitraryReducedMaybe n -- networkEnableIpv4 :: Maybe Bool
    ...
    <*> arbitraryReducedMaybe n -- networkConfigFrom :: Maybe ConfigReference
    <*> arbitraryReducedMaybe n -- networkConfigOnly :: Maybe Bool
    ...
    <*> arbitraryReducedMaybe n -- networkPeers :: Maybe [PeerInfo]
...
genNetworkConnectRequest n =
  NetworkConnectRequest
    <$> arbitrary -- networkConnectRequestContainer :: Text
...
genNetworkCreateRequest n =
  NetworkCreateRequest
    ...
    <*> arbitraryReducedMaybe n -- networkCreateRequestScope :: Maybe Text
    ...
    <*> arbitraryReducedMaybe n -- networkCreateRequestConfigOnly :: Maybe Bool
    <*> arbitraryReducedMaybe n -- networkCreateRequestConfigFrom :: Maybe ConfigReference
    <*> arbitraryReducedMaybe n -- networkCreateRequestIpam :: Maybe IPAM
    <*> arbitraryReducedMaybe n -- networkCreateRequestEnableIpv4 :: Maybe Bool
...
genNetworkCreateResponse n =
  NetworkCreateResponse
    <$> arbitrary -- networkCreateResponseId :: Text
    <*> arbitrary -- networkCreateResponseWarning :: Text
...
genNetworkDisconnectRequest n =
  NetworkDisconnectRequest
    <$> arbitrary -- networkDisconnectRequestContainer :: Text
    <*> arbitraryReducedMaybe n -- networkDisconnectRequestForce :: Maybe Bool
  
instance Arbitrary NetworkInspect where
  arbitrary = sized genNetworkInspect

genNetworkInspect :: Int -> Gen NetworkInspect
genNetworkInspect n =
  NetworkInspect
    <$> arbitraryReducedMaybe n -- networkInspectContainers :: Maybe (Map.Map String EndpointResource)
    <*> arbitraryReducedMaybe n -- networkInspectServices :: Maybe (Map.Map String A.Value)
    <*> arbitraryReducedMaybe n -- networkInspectStatus :: Maybe NetworkStatus
    <*> arbitraryReducedMaybe n -- networkInspectName :: Maybe Text
    <*> arbitraryReducedMaybe n -- networkInspectId :: Maybe Text
    <*> arbitraryReducedMaybe n -- networkInspectCreated :: Maybe Text
    <*> arbitraryReducedMaybe n -- networkInspectScope :: Maybe Text
    <*> arbitraryReducedMaybe n -- networkInspectDriver :: Maybe Text
    <*> arbitraryReducedMaybe n -- networkInspectEnableIpv4 :: Maybe Bool
    <*> arbitraryReducedMaybe n -- networkInspectEnableIpv6 :: Maybe Bool
    <*> arbitraryReducedMaybe n -- networkInspectIpam :: Maybe IPAM
    <*> arbitraryReducedMaybe n -- networkInspectInternal :: Maybe Bool
    <*> arbitraryReducedMaybe n -- networkInspectAttachable :: Maybe Bool
    <*> arbitraryReducedMaybe n -- networkInspectIngress :: Maybe Bool
    <*> arbitraryReducedMaybe n -- networkInspectConfigFrom :: Maybe ConfigReference
    <*> arbitraryReducedMaybe n -- networkInspectConfigOnly :: Maybe Bool
    <*> arbitraryReducedMaybe n -- networkInspectOptions :: Maybe (Map.Map String Text)
    <*> arbitraryReducedMaybe n -- networkInspectLabels :: Maybe (Map.Map String Text)
    <*> arbitraryReducedMaybe n -- networkInspectPeers :: Maybe [PeerInfo]
...
instance Arbitrary NetworkStatus where
  arbitrary = sized genNetworkStatus

genNetworkStatus :: Int -> Gen NetworkStatus
genNetworkStatus n =
  NetworkStatus
    <$> arbitraryReducedMaybe n -- networkStatusIpam :: Maybe IPAMStatus
  
instance Arbitrary NetworkSummary where
  arbitrary = sized genNetworkSummary

genNetworkSummary :: Int -> Gen NetworkSummary
genNetworkSummary n =
  NetworkSummary
    <$> arbitraryReducedMaybe n -- networkSummaryName :: Maybe Text
    <*> arbitraryReducedMaybe n -- networkSummaryId :: Maybe Text
    <*> arbitraryReducedMaybe n -- networkSummaryCreated :: Maybe Text
    <*> arbitraryReducedMaybe n -- networkSummaryScope :: Maybe Text
    <*> arbitraryReducedMaybe n -- networkSummaryDriver :: Maybe Text
    <*> arbitraryReducedMaybe n -- networkSummaryEnableIpv4 :: Maybe Bool
    <*> arbitraryReducedMaybe n -- networkSummaryEnableIpv6 :: Maybe Bool
    <*> arbitraryReducedMaybe n -- networkSummaryIpam :: Maybe IPAM
    <*> arbitraryReducedMaybe n -- networkSummaryInternal :: Maybe Bool
    <*> arbitraryReducedMaybe n -- networkSummaryAttachable :: Maybe Bool
    <*> arbitraryReducedMaybe n -- networkSummaryIngress :: Maybe Bool
    <*> arbitraryReducedMaybe n -- networkSummaryConfigFrom :: Maybe ConfigReference
    <*> arbitraryReducedMaybe n -- networkSummaryConfigOnly :: Maybe Bool
    <*> arbitraryReducedMaybe n -- networkSummaryOptions :: Maybe (Map.Map String Text)
    <*> arbitraryReducedMaybe n -- networkSummaryLabels :: Maybe (Map.Map String Text)
    <*> arbitraryReducedMaybe n -- networkSummaryPeers :: Maybe [PeerInfo]
  
instance Arbitrary NetworkTaskInfo where
  arbitrary = sized genNetworkTaskInfo

genNetworkTaskInfo :: Int -> Gen NetworkTaskInfo
genNetworkTaskInfo n =
  NetworkTaskInfo
    <$> arbitraryReducedMaybe n -- networkTaskInfoName :: Maybe Text
    <*> arbitraryReducedMaybe n -- networkTaskInfoEndpointId :: Maybe Text
    <*> arbitraryReducedMaybe n -- networkTaskInfoEndpointIp :: Maybe Text
    <*> arbitraryReducedMaybe n -- networkTaskInfoInfo :: Maybe (Map.Map String Text)
...
genOCIDescriptor n =
  OCIDescriptor
    ...
    <*> arbitraryReducedMaybe n -- oCIDescriptorUrls :: Maybe [Text]
    <*> arbitraryReducedMaybe n -- oCIDescriptorAnnotations :: Maybe (Map.Map String Text)
    <*> arbitraryReducedMaybe n -- oCIDescriptorData :: Maybe Text
    <*> arbitraryReducedMaybe n -- oCIDescriptorPlatform :: Maybe OCIPlatform
    <*> arbitraryReducedMaybe n -- oCIDescriptorArtifactType :: Maybe Text
...
instance Arbitrary PeerInfo where
  arbitrary = sized genPeerInfo

genPeerInfo :: Int -> Gen PeerInfo
genPeerInfo n =
  PeerInfo
    <$> arbitraryReducedMaybe n -- peerInfoName :: Maybe Text
    <*> arbitraryReducedMaybe n -- peerInfoIp :: Maybe Text
...
genPluginConfigInterface n =
  PluginConfigInterface
    <$> arbitrary -- pluginConfigInterfaceTypes :: [Text]
...
instance Arbitrary PortStatus where
  arbitrary = sized genPortStatus

genPortStatus :: Int -> Gen PortStatus
genPortStatus n =
  PortStatus
    <$> arbitraryReducedMaybe n -- portStatusPorts :: Maybe [EndpointPortConfig]
  
instance Arbitrary PortSummary where
  arbitrary = sized genPortSummary

genPortSummary :: Int -> Gen PortSummary
genPortSummary n =
  PortSummary
    <$> arbitraryReducedMaybe n -- portSummaryIp :: Maybe Text
    <*> arbitrary -- portSummaryPrivatePort :: Int
    <*> arbitraryReducedMaybe n -- portSummaryPublicPort :: Maybe Int
    <*> arbitrary -- portSummaryType :: E'Type
...
genPushImageInfo n =
  PushImageInfo
    <$> arbitraryReducedMaybe n -- pushImageInfoErrorDetail :: Maybe ErrorDetail
...
instance Arbitrary RootFSStorage where
  arbitrary = sized genRootFSStorage

genRootFSStorage :: Int -> Gen RootFSStorage
genRootFSStorage n =
  RootFSStorage
    <$> arbitraryReducedMaybe n -- rootFSStorageSnapshot :: Maybe RootFSStorageSnapshot
  
instance Arbitrary RootFSStorageSnapshot where
  arbitrary = sized genRootFSStorageSnapshot

genRootFSStorageSnapshot :: Int -> Gen RootFSStorageSnapshot
genRootFSStorageSnapshot n =
  RootFSStorageSnapshot
    <$> arbitraryReducedMaybe n -- rootFSStorageSnapshotName :: Maybe Text
...
genRuntime n =
  Runtime
    ...
    <*> arbitraryReducedMaybe n -- runtimeStatus :: Maybe (Map.Map String Text)
...
genSecretCreateRequest n =
  SecretCreateRequest
    ...
    <*> arbitraryReducedMaybe n -- secretCreateRequestTemplating :: Maybe Driver
...
genServiceCreateRequest n =
  ServiceCreateRequest
    ...
    <*> arbitraryReducedMaybe n -- serviceCreateRequestNetworks :: Maybe [NetworkAttachmentConfig]
...
genServiceCreateResponse n =
  ServiceCreateResponse
    ...
    <*> arbitraryReducedMaybe n -- serviceCreateResponseWarnings :: Maybe [Text]
...
instance Arbitrary ServiceInfo where
  arbitrary = sized genServiceInfo

genServiceInfo :: Int -> Gen ServiceInfo
genServiceInfo n =
  ServiceInfo
    <$> arbitraryReducedMaybe n -- serviceInfoVip :: Maybe Text
    <*> arbitraryReducedMaybe n -- serviceInfoPorts :: Maybe [Text]
    <*> arbitraryReducedMaybe n -- serviceInfoLocalLbIndex :: Maybe Int
    <*> arbitraryReducedMaybe n -- serviceInfoTasks :: Maybe [NetworkTaskInfo]
...
genServiceUpdateRequest n =
  ServiceUpdateRequest
    ...
    <*> arbitraryReducedMaybe n -- serviceUpdateRequestNetworks :: Maybe [NetworkAttachmentConfig]
...
genServiceUpdateStatus n =
  ServiceUpdateStatus
    <$> arbitraryReducedMaybe n -- serviceUpdateStatusState :: Maybe E'State2
...
genStorage :: Int -> Gen Storage
genStorage n =
  Storage
    <$> arbitraryReducedMaybe n -- storageRootFs :: Maybe RootFSStorage
  
instance Arbitrary SubnetStatus where
  arbitrary = sized genSubnetStatus

genSubnetStatus :: Int -> Gen SubnetStatus
genSubnetStatus n =
  SubnetStatus
    <$> arbitraryReducedMaybe n -- subnetStatusIpsInUse :: Maybe Int
    <*> arbitraryReducedMaybe n -- subnetStatusDynamicIpsAvailable :: Maybe Int
...
genSystemDataUsageResponse n =
  SystemDataUsageResponse
    <$> arbitraryReducedMaybe n -- systemDataUsageResponseImagesDiskUsage :: Maybe ImagesDiskUsage
    <*> arbitraryReducedMaybe n -- systemDataUsageResponseContainersDiskUsage :: Maybe ContainersDiskUsage
    <*> arbitraryReducedMaybe n -- systemDataUsageResponseVolumesDiskUsage :: Maybe VolumesDiskUsage
    <*> arbitraryReducedMaybe n -- systemDataUsageResponseBuildCacheDiskUsage :: Maybe BuildCacheDiskUsage
...
genSystemInfo n =
  SystemInfo
    ...
    <*> arbitraryReducedMaybe n -- systemInfoDefaultAddressPools :: Maybe [SystemInfoDefaultAddressPoolsInner]
    <*> arbitraryReducedMaybe n -- systemInfoFirewallBackend :: Maybe FirewallInfo
    <*> arbitraryReducedMaybe n -- systemInfoDiscoveredDevices :: Maybe [DeviceInfo]
    <*> arbitraryReducedMaybe n -- systemInfoWarnings :: Maybe [Text]
    <*> arbitraryReducedMaybe n -- systemInfoCdiSpecDirs :: Maybe [Text]
    <*> arbitraryReducedMaybe n -- systemInfoContainerd :: Maybe ContainerdInfo
  
instance Arbitrary SystemInfoDefaultAddressPoolsInner where
  arbitrary = sized genSystemInfoDefaultAddressPoolsInner

genSystemInfoDefaultAddressPoolsInner :: Int -> Gen SystemInfoDefaultAddressPoolsInner
genSystemInfoDefaultAddressPoolsInner n =
  SystemInfoDefaultAddressPoolsInner
    <$> arbitraryReducedMaybe n -- systemInfoDefaultAddressPoolsInnerBase :: Maybe Text
    <*> arbitraryReducedMaybe n -- systemInfoDefaultAddressPoolsInnerSize :: Maybe Int
...
genSystemVersion n =
  SystemVersion
    ...
    <*> arbitraryReducedMaybe n -- systemVersionComponents :: Maybe [SystemVersionComponentsInner]
...
instance Arbitrary SystemVersionComponentsInner where
  arbitrary = sized genSystemVersionComponentsInner

genSystemVersionComponentsInner :: Int -> Gen SystemVersionComponentsInner
genSystemVersionComponentsInner n =
  SystemVersionComponentsInner
    <$> arbitrary -- systemVersionComponentsInnerName :: Text
    <*> arbitrary -- systemVersionComponentsInnerVersion :: Text
    <*> arbitraryReducedMaybeValue n -- systemVersionComponentsInnerDetails :: Maybe A.Value
...
genTaskSpecContainerSpec n =
  TaskSpecContainerSpec
    ...
    <*> arbitraryReducedMaybe n -- taskSpecContainerSpecOomScoreAdj :: Maybe Integer
    ...
    <*> arbitraryReducedMaybe n -- taskSpecContainerSpecUlimits :: Maybe [ResourcesUlimitsInner]
...
genTaskSpecContainerSpecConfigsInner n =
  TaskSpecContainerSpecConfigsInner
    <$> arbitraryReducedMaybe n -- taskSpecContainerSpecConfigsInnerFile :: Maybe TaskSpecContainerSpecConfigsInnerFile
    <*> arbitraryReducedMaybeValue n -- taskSpecContainerSpecConfigsInnerRuntime :: Maybe A.Value
...
instance Arbitrary TaskSpecContainerSpecConfigsInnerFile where
  arbitrary = sized genTaskSpecContainerSpecConfigsInnerFile

genTaskSpecContainerSpecConfigsInnerFile :: Int -> Gen TaskSpecContainerSpecConfigsInnerFile
genTaskSpecContainerSpecConfigsInnerFile n =
  TaskSpecContainerSpecConfigsInnerFile
    <$> arbitraryReducedMaybe n -- taskSpecContainerSpecConfigsInnerFileName :: Maybe Text
    <*> arbitraryReducedMaybe n -- taskSpecContainerSpecConfigsInnerFileUid :: Maybe Text
    <*> arbitraryReducedMaybe n -- taskSpecContainerSpecConfigsInnerFileGid :: Maybe Text
    <*> arbitraryReducedMaybe n -- taskSpecContainerSpecConfigsInnerFileMode :: Maybe Int
...
genTaskSpecContainerSpecPrivileges n =
  TaskSpecContainerSpecPrivileges
    ...
    <*> arbitraryReducedMaybe n -- taskSpecContainerSpecPrivilegesSeccomp :: Maybe TaskSpecContainerSpecPrivilegesSeccomp
    <*> arbitraryReducedMaybe n -- taskSpecContainerSpecPrivilegesAppArmor :: Maybe TaskSpecContainerSpecPrivilegesAppArmor
    <*> arbitraryReducedMaybe n -- taskSpecContainerSpecPrivilegesNoNewPrivileges :: Maybe Bool
  
instance Arbitrary TaskSpecContainerSpecPrivilegesAppArmor where
  arbitrary = sized genTaskSpecContainerSpecPrivilegesAppArmor

genTaskSpecContainerSpecPrivilegesAppArmor :: Int -> Gen TaskSpecContainerSpecPrivilegesAppArmor
genTaskSpecContainerSpecPrivilegesAppArmor n =
  TaskSpecContainerSpecPrivilegesAppArmor
    <$> arbitraryReducedMaybe n -- taskSpecContainerSpecPrivilegesAppArmorMode :: Maybe E'Mode3
...
instance Arbitrary TaskSpecContainerSpecPrivilegesSeccomp where
  arbitrary = sized genTaskSpecContainerSpecPrivilegesSeccomp

genTaskSpecContainerSpecPrivilegesSeccomp :: Int -> Gen TaskSpecContainerSpecPrivilegesSeccomp
genTaskSpecContainerSpecPrivilegesSeccomp n =
  TaskSpecContainerSpecPrivilegesSeccomp
    <$> arbitraryReducedMaybe n -- taskSpecContainerSpecPrivilegesSeccompMode :: Maybe E'Mode2
    <*> arbitraryReducedMaybe n -- taskSpecContainerSpecPrivilegesSeccompProfile :: Maybe Text
...
genTaskSpecResources n =
  TaskSpecResources
    ...
    <*> arbitraryReducedMaybe n -- taskSpecResourcesSwapBytes :: Maybe Integer
    <*> arbitraryReducedMaybe n -- taskSpecResourcesMemorySwappiness :: Maybe Integer
...
genTaskStatus n =
  TaskStatus
    ...
    <*> arbitraryReducedMaybe n -- taskStatusContainerStatus :: Maybe ContainerStatus
    <*> arbitraryReducedMaybe n -- taskStatusPortStatus :: Maybe PortStatus
...
genVolume n =
  Volume
    ...
    <*> arbitraryReducedMaybe n -- volumeClusterVolume :: Maybe ClusterVolume
...
genVolumeCreateRequest n =
  VolumeCreateRequest
    ...
    <*> arbitraryReducedMaybe n -- volumeCreateRequestClusterVolumeSpec :: Maybe ClusterVolumeSpec
...
genVolumeListResponse n =
  VolumeListResponse
    <$> arbitraryReducedMaybe n -- volumeListResponseVolumes :: Maybe [Volume]
    <*> arbitraryReducedMaybe n -- volumeListResponseWarnings :: Maybe [Text]
...
instance Arbitrary VolumeUpdateRequest where
  arbitrary = sized genVolumeUpdateRequest

genVolumeUpdateRequest :: Int -> Gen VolumeUpdateRequest
genVolumeUpdateRequest n =
  VolumeUpdateRequest
    <$> arbitraryReducedMaybe n -- volumeUpdateRequestSpec :: Maybe ClusterVolumeSpec
...
instance Arbitrary VolumesDiskUsage where
  arbitrary = sized genVolumesDiskUsage

genVolumesDiskUsage :: Int -> Gen VolumesDiskUsage
genVolumesDiskUsage n =
  VolumesDiskUsage
    <$> arbitraryReducedMaybe n -- volumesDiskUsageActiveCount :: Maybe Integer
    <*> arbitraryReducedMaybe n -- volumesDiskUsageTotalCount :: Maybe Integer
    <*> arbitraryReducedMaybe n -- volumesDiskUsageReclaimable :: Maybe Integer
    <*> arbitraryReducedMaybe n -- volumesDiskUsageTotalSize :: Maybe Integer
    <*> arbitraryReducedMaybe n -- volumesDiskUsageItems :: Maybe [A.Value]
...
instance Arbitrary E'Mode3 where
  arbitrary = arbitraryBoundedEnum
...
instance Arbitrary E'Scope3 where
  arbitrary = arbitraryBoundedEnum

instance Arbitrary E'Sharing where
  arbitrary = arbitraryBoundedEnum
