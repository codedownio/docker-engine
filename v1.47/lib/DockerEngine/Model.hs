{-
   ...
   Docker Engine API API version: 1.47
...
data ClusterVolumePublishStatusInner = ClusterVolumePublishStatusInner
  ...
  , clusterVolumePublishStatusInnerState :: !(Maybe E'State2) -- ^ "State" - The published state of the volume. * &#x60;pending-publish&#x60; The volume should be published to this node, but the call to the controller plugin to do so has not yet been successfully completed. * &#x60;published&#x60; The volume is published successfully to the node. * &#x60;pending-node-unpublish&#x60; The volume should be unpublished from the node, and the manager is awaiting confirmation from the worker that it has done so. * &#x60;pending-controller-unpublish&#x60; The volume is successfully unpublished from the node, but has not yet been successfully unpublished on the controller. 
...
data ContainerSummaryHostConfig = ContainerSummaryHostConfig
  ...
  , containerSummaryHostConfigAnnotations :: !(Maybe (Map.Map String Text)) -- ^ "Annotations" - Arbitrary key-value metadata attached to container
  } deriving (P.Show, P.Eq, P.Typeable)
...
data HostConfigAllOfLogConfig = HostConfigAllOfLogConfig
  { hostConfigAllOfLogConfigType :: !(Maybe E'Type5) -- ^ "Type"
...
data MountPoint = MountPoint
  { mountPointType :: !(Maybe E'Type2) -- ^ "Type" - The mount type:  - &#x60;bind&#x60; a mount of a file or directory from the host into the container. - &#x60;volume&#x60; a docker volume with the given &#x60;Name&#x60;. - &#x60;tmpfs&#x60; a &#x60;tmpfs&#x60;. - &#x60;npipe&#x60; a named pipe from the host into the container. - &#x60;cluster&#x60; a Swarm cluster volume 
...
data NetworkCreateRequest = NetworkCreateRequest
  ...
  , networkCreateRequestEnableIpv4 :: !(Maybe Bool) -- ^ "EnableIPv4" - Enable IPv4 on the network. To disable IPv4, the daemon must be started with experimental features enabled. 
...
data SystemInfo = SystemInfo
  ...
  , systemInfoBridgeNfIptables :: !(Maybe Bool) -- ^ "BridgeNfIptables" - Indicates if &#x60;bridge-nf-call-iptables&#x60; is available on the host when the daemon was started.  The &#x60;br_netfilter&#x60; 
...
data E'State2
  = E'State2'Pending_publish -- ^ @"pending-publish"@
  | E'State2'Published -- ^ @"published"@
  | E'State2'Pending_node_unpublish -- ^ @"pending-node-unpublish"@
  | E'State2'Pending_controller_unpublish -- ^ @"pending-controller-unpublish"@
  deriving (P.Show, P.Eq, P.Typeable, P.Ord, P.Bounded, P.Enum)
...
toE'State2 = \case
  "pending-publish" -> P.Right E'State2'Pending_publish
  "published" -> P.Right E'State2'Published
  "pending-node-unpublish" -> P.Right E'State2'Pending_node_unpublish
  "pending-controller-unpublish" -> P.Right E'State2'Pending_controller_unpublish
