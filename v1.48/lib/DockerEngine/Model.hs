{-
   ...
   Docker Engine API API version: 1.48
...
data Commit = Commit
  ...
  , commitExpected :: !(Maybe Text) -- ^ "Expected" - Commit ID of external tool expected by dockerd as set at build time.  **Deprecated**: This field is deprecated and will be omitted in a API v1.49. 
  } deriving (P.Show, P.Eq, P.Typeable)
