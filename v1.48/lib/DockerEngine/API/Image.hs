...
-- | /Optional Param/ "keep-storage" - Amount of disk space in bytes to keep for cache  > **Deprecated**: This parameter is deprecated and has been renamed to \"reserved-space\". > It is kept for backward compatibility and will be removed in API v1.49. 
