...
main =
  hspec $ modifyMaxSize (const 10) $ do
    describe "JSON instances" $ do
      ...
      propMimeEq MimeJSON (Proxy :: Proxy ContainerCreateRequestAllOfNetworkingConfig)
      propMimeEq MimeJSON (Proxy :: Proxy ContainerCreateResponse)
      propMimeEq MimeJSON (Proxy :: Proxy ContainerExecRequest)
      ...
      propMimeEq MimeJSON (Proxy :: Proxy DistributionInspectResponsePlatformsInner)
      ...
      propMimeEq MimeJSON (Proxy :: Proxy ExecStartRequest)
      ...
      propMimeEq MimeJSON (Proxy :: Proxy PluginPullRequestInner)
      ...
      propMimeEq MimeJSON (Proxy :: Proxy SystemVersionResponseComponentsInner)
      ...
      propMimeEq MimeJSON (Proxy :: Proxy TaskSpecNetworksInner)
