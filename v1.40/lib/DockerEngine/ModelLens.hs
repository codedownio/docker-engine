{-
   ...
   Docker Engine API API version: 1.40
...
-- | 'hostConfigCapabilities' Lens
hostConfigCapabilitiesL :: Lens_' HostConfig (Maybe [Text])
hostConfigCapabilitiesL f HostConfig{..} = (\hostConfigCapabilities -> HostConfig { hostConfigCapabilities, ..} ) <$> f hostConfigCapabilities
{-# INLINE hostConfigCapabilitiesL #-}
