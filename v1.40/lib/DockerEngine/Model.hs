...
-- ** Version
newtype Version = Version { unVersion :: E'Version } deriving (P.Eq, P.Show)
...
data HostConfig = HostConfig
  ...
  , hostConfigCapabilities :: !(Maybe [Text]) -- ^ "Capabilities" - A list of kernel capabilities to be available for container (this overrides the default set).  Conflicts with options &#39;CapAdd&#39; and &#39;CapDrop&#39;\&quot; 
...
instance A.ToJSON HostConfig where
  toJSON HostConfig {..} =
   _omitNulls
      ...
      , "Capabilities" .= hostConfigCapabilities
...
mkHostConfig =
  ...
  , hostConfigCapabilities = Nothing
...
instance A.ToJSON E'Version where toJSON = A.toJSON . fromE'Version
instance A.FromJSON E'Version where parseJSON o = P.either P.fail (pure . P.id) . toE'Version =<< A.parseJSON o
instance WH.ToHttpApiData E'Version where toQueryParam = WH.toQueryParam . fromE'Version
instance WH.FromHttpApiData E'Version where parseQueryParam o = WH.parseQueryParam o >>= P.left T.pack . toE'Version
instance MimeRender MimeMultipartFormData E'Version where mimeRender _ = mimeRenderDefaultMultipartFormData

-- | unwrap 'E'Version' enum
fromE'Version :: E'Version -> Text
fromE'Version = \case
  E'Version'1 -> "1"
  E'Version'2 -> "2"

-- | parse 'E'Version' enum
toE'Version :: Text -> P.Either String E'Version
toE'Version = \case
  "1" -> P.Right E'Version'1
  "2" -> P.Right E'Version'2
  s -> P.Left $ "toE'Version: enum parse failure: " P.++ P.show s
