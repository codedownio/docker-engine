...
data ImageConfig = ImageConfig
  ...
  , imageConfigMacAddress :: !(Maybe Text) -- ^ "MacAddress" - MAC address of the container.  &lt;p&gt;&lt;br /&gt;&lt;/p&gt;  &gt; **Note**: this field is always omitted and must not be used. 
...
data ImageInspect = ImageInspect
  ...
  , imageInspectVirtualSize :: !(Maybe Integer) -- ^ "VirtualSize" - Total size of the image including all layers it is composed of.  In versions of Docker before v1.10, this field was calculated from the image itself and all of its parent images. Images are now stored self-contained, and no longer use a parent-chain, making this field an equivalent of the Size field.  &gt; **Deprecated**: this field is kept for backward compatibility, but &gt; will be removed in API v1.44. 
...
data ImageSummary = ImageSummary
  ...
  , imageSummaryVirtualSize :: !(Maybe Integer) -- ^ "VirtualSize" - Total size of the image including all layers it is composed of.  In versions of Docker before v1.10, this field was calculated from the image itself and all of its parent images. Images are now stored self-contained, and no longer use a parent-chain, making this field an equivalent of the Size field.  Deprecated: this field is kept for backward compatibility, and will be removed in API v1.44.
...
data ServiceCreateRequest = ServiceCreateRequest
  ...
  , serviceCreateRequestNetworks :: !(Maybe [NetworkAttachmentConfig]) -- ^ "Networks" - Specifies which networks the service should attach to.
...
data ServiceUpdateRequest = ServiceUpdateRequest
  ...
  , serviceUpdateRequestNetworks :: !(Maybe [NetworkAttachmentConfig]) -- ^ "Networks" - Specifies which networks the service should attach to.
