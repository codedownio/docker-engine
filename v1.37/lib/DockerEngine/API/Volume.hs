...
-- 
volumeCreate
  :: (Consumes VolumeCreate MimeJSON, MimeRender MimeJSON VolumeCreateRequest)
  => VolumeCreateRequest -- ^ "volumeConfig" -  Volume configuration
...
instance HasBodyParam VolumeCreate VolumeCreateRequest 
